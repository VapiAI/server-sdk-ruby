  ...
  class Tools
    class ToolsCreateRequest
      ...
      def self.from_json(json_object:)
        ...
        begin
          Vapi::CreateOutputToolDto.validate_raw(obj: struct)
          return Vapi::CreateOutputToolDto.from_json(json_object: struct) unless struct.nil?
      ...
      def self.validate_raw(obj:)
        ...
        begin
          return Vapi::CreateOutputToolDto.validate_raw(obj: obj)
        rescue StandardError
          # noop
        end
