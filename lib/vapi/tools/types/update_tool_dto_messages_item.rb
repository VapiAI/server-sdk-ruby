...
require "json"
require_relative "../../types/tool_message_start"
require_relative "../../types/tool_message_complete"
require_relative "../../types/tool_message_failed"
require_relative "../../types/tool_message_delayed"

module Vapi
  class Tools
    class UpdateToolDtoMessagesItem
      # @return [Object]
      attr_reader :member
      # @return [String]
      ...
      # @return [Vapi::Tools::UpdateToolDtoMessagesItem]
      def initialize(member:, discriminant:)
        @member = member
        @discriminant = discriminant
      end

      # Deserialize a JSON object to an instance of UpdateToolDtoMessagesItem
      #
