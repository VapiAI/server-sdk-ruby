...
module Vapi
  module Tools
    class Client
      ...
      #
      # @return [Array[Vapi::Tools::Types::ListToolsResponseItem]]
      ...
      # @option request_options [Integer] :timeout_in_seconds
      #
      # @return [Vapi::Tools::Types::CreateToolsResponse]
      def create(request_options: {}, **params)
        ...
        request = Vapi::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "tool",
          body: Vapi::Tools::Types::CreateToolsRequest.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        if code.between?(200, 299)
          Vapi::Tools::Types::CreateToolsResponse.load(response.body)
        else
          error_class = Vapi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [Vapi::Tools::Types::GetToolsResponse]
      def get(request_options: {}, **params)
        params = Vapi::Internal::Types::Utils.normalize_keys(params)
        request = Vapi::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "GET",
          path: "tool/#{URI.encode_uri_component(params[:id].to_s)}",
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Vapi::Tools::Types::GetToolsResponse.load(response.body)
        else
          error_class = Vapi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String] :id
      #
      # @return [Vapi::Tools::Types::DeleteToolsResponse]
      def delete(request_options: {}, **params)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Vapi::Tools::Types::DeleteToolsResponse.load(response.body)
        else
          error_class = Vapi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      # @option params [String] :id
      #
      # @return [Vapi::Tools::Types::UpdateToolsResponse]
      def update(request_options: {}, **params)
        ...
        request = Vapi::Internal::JSON::Request.new(
          ...
          method: "PATCH",
          path: "tool/#{URI.encode_uri_component(params[:id].to_s)}",
          body: Vapi::Tools::Types::UpdateToolsRequestBody.new(body_params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Vapi::Tools::Types::UpdateToolsResponse.load(response.body)
        else
          error_class = Vapi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
