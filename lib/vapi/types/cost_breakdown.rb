...
module Vapi
  class CostBreakdown
    ...
    def initialize(transport: OMIT, stt: OMIT, llm: OMIT, tts: OMIT, vapi: OMIT, total: OMIT, llm_prompt_tokens: OMIT,
                   llm_completion_tokens: OMIT, tts_characters: OMIT, analysis_cost_breakdown: OMIT, additional_properties: nil)
