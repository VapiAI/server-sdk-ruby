...
module Vapi
  class AssignmentMutationConditionsItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::AssignmentMutationConditionsItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of AssignmentMutationConditionsItem
    #
