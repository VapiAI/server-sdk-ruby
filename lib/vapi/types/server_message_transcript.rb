...
module Vapi
  class ServerMessageTranscript
    # @return [Vapi::ServerMessageTranscriptPhoneNumber] This is the phone number associated with the call.
    ...
    # @param phone_number [Vapi::ServerMessageTranscriptPhoneNumber] This is the phone number associated with the call.
    #  This matches one of the following:
    #  - `call.phoneNumber`,
    #  - `call.phoneNumberId`.
