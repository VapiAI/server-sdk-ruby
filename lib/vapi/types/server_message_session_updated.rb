...
module Vapi
  module Types
    class ServerMessageSessionUpdated < Internal::Types::Model
      field :phone_number, -> { Vapi::Types::ServerMessageSessionUpdatedPhoneNumber }, optional: true, nullable: false, api_name: "phoneNumber"
      field :type, -> { Vapi::Types::ServerMessageSessionUpdatedType }, optional: false, nullable: false
