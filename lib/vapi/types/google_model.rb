...
module Vapi
  module Types
    # Configuration for generating assistant responses with Google, including model, prompts, tools, knowledge-base
    # access, realtime settings, and generation settings.
    class GoogleModel < Internal::Types::Model
      field :messages, -> { Internal::Types::Array[Vapi::Types::OpenAiMessage] }, optional: true, nullable: false
      field :tools, -> { Internal::Types::Array[Vapi::Types::GoogleModelToolsItem] }, optional: true, nullable: false
      ...
      field :model, -> { Vapi::Types::GoogleModelModel }, optional: false, nullable: false
      field :realtime_config, -> { Vapi::Types::GoogleRealtimeConfig }, optional: true, nullable: false, api_name: "realtimeConfig"
