...
require_relative "azure_voice_voice_id"
...
module Vapi
  class AzureVoice
    ...
    # @return [Vapi::AzureVoiceVoiceId] This is the provider-specific ID that will be used.
    ...
    #  inputting it into the voice provider.
    #  Default `false` because you can achieve better results with prompting the model.
    # @param voice_id [Vapi::AzureVoiceVoiceId] This is the provider-specific ID that will be used.
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["voiceId"].nil?
        ...
        voice_id = Vapi::AzureVoiceVoiceId.from_json(json_object: voice_id)
      end
    ...
    def self.validate_raw(obj:)
      ...
      Vapi::AzureVoiceVoiceId.validate_raw(obj: obj.voice_id)
