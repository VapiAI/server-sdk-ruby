...
module Vapi
  module Types
    class UpdateBarInsightFromCallTableDto < Internal::Types::Model
      ...
      field :group_by, -> { Vapi::Types::UpdateBarInsightFromCallTableDtoGroupBy }, optional: true, nullable: false, api_name: "groupBy"
      field :queries, -> { Internal::Types::Array[Vapi::Types::UpdateBarInsightFromCallTableDtoQueriesItem] }, optional: true, nullable: false
    end
  end
end
