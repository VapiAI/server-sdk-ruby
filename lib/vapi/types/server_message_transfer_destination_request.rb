...
module Vapi
  class ServerMessageTransferDestinationRequest
    # @return [Vapi::ServerMessageTransferDestinationRequestPhoneNumber] This is the phone number associated with the call.
    ...
    # @param phone_number [Vapi::ServerMessageTransferDestinationRequestPhoneNumber] This is the phone number associated with the call.
    #  This matches one of the following:
    #  - `call.phoneNumber`,
    #  - `call.phoneNumberId`.
