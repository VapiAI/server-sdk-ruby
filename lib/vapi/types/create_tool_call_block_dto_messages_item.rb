...
module Vapi
  class CreateToolCallBlockDtoMessagesItem
    # Deserialize a JSON object to an instance of CreateToolCallBlockDtoMessagesItem
    #
    # @param json_object [String]
    # @return [Vapi::CreateToolCallBlockDtoMessagesItem]
