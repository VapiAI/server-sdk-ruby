...
module Vapi
  module Types
    # Configuration for synthesizing assistant speech with WellSaid, including voice and model selection, Speech
    # Synthesis Markup Language support, voice libraries, chunking, caching, and fallback settings.
