...
module Vapi
  module Types
    class ServerMessageLanguageChangeDetected < Internal::Types::Model
      field :phone_number, -> { Vapi::Types::ServerMessageLanguageChangeDetectedPhoneNumber }, optional: true, nullable: false, api_name: "phoneNumber"
      field :type, -> { Vapi::Types::ServerMessageLanguageChangeDetectedType }, optional: false, nullable: false
