...
module Vapi
  module Types
    # Fallback configuration for synthesizing assistant speech with Rime AI, including voice and model selection,
    # language, speed, pauses, phonemization, latency, chunking, and caching.
