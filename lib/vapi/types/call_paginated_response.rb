...
module Vapi
  class CallPaginatedResponse
    ...
    # Deserialize a JSON object to an instance of CallPaginatedResponse
    #
    ...
    # Serialize an instance of CallPaginatedResponse to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
