...
require_relative "twilio_voicemail_detection_voicemail_detection_types_item"
require "ostruct"
require "json"

module Vapi
  class TwilioVoicemailDetection
    # @return [String] This is the provider to use for voicemail detection.
    attr_reader :provider
    # @return [Array<Vapi::TwilioVoicemailDetectionVoicemailDetectionTypesItem>] These are the AMD messages from Twilio that are considered as voicemail. Default
    ...
    # @param provider [String] This is the provider to use for voicemail detection.
    # @param voicemail_detection_types [Array<Vapi::TwilioVoicemailDetectionVoicemailDetectionTypesItem>] These are the AMD messages from Twilio that are considered as voicemail. Default
    #  is ['machine_end_beep', 'machine_end_silence'].
    #  @default {Array} ['machine_end_beep', 'machine_end_silence']
    ...
    # @return [Vapi::TwilioVoicemailDetection]
    ...
    # Deserialize a JSON object to an instance of TwilioVoicemailDetection
    #
    ...
    # Serialize an instance of TwilioVoicemailDetection to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
