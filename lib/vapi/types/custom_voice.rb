...
module Vapi
  module Types
    # Configuration for synthesizing assistant speech through a custom server, including voice selection, server
    # connection, chunking, caching, and fallback settings.
