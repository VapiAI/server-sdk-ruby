...
module Vapi
  module Types
    # Configuration for generating assistant responses with Groq, including model, prompts, tools, knowledge-base
    # access, and generation settings.
    class GroqModel < Internal::Types::Model
      field :messages, -> { Internal::Types::Array[Vapi::Types::OpenAiMessage] }, optional: true, nullable: false
      field :tools, -> { Internal::Types::Array[Vapi::Types::GroqModelToolsItem] }, optional: true, nullable: false
      ...
      field :model, -> { Vapi::Types::GroqModelModel }, optional: false, nullable: false
