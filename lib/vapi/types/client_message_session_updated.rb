...
module Vapi
  module Types
    class ClientMessageSessionUpdated < Internal::Types::Model
      field :phone_number, -> { Vapi::Types::ClientMessageSessionUpdatedPhoneNumber }, optional: true, nullable: false, api_name: "phoneNumber"
      field :type, -> { Vapi::Types::ClientMessageSessionUpdatedType }, optional: false, nullable: false
