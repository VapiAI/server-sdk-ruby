...
module Vapi
  module Types
    class CreateAssistantDraftDto < Internal::Types::Model
      field :transcriber, -> { Vapi::Types::CreateAssistantDraftDtoTranscriber }, optional: true, nullable: false
      field :model, -> { Vapi::Types::CreateAssistantDraftDtoModel }, optional: true, nullable: false
      field :voice, -> { Vapi::Types::CreateAssistantDraftDtoVoice }, optional: true, nullable: false
      ...
      field :first_message_mode, -> { Vapi::Types::CreateAssistantDraftDtoFirstMessageMode }, optional: true, nullable: false, api_name: "firstMessageMode"
      field :voicemail_detection, -> { Vapi::Types::CreateAssistantDraftDtoVoicemailDetection }, optional: true, nullable: false, api_name: "voicemailDetection"
      field :client_messages, -> { Internal::Types::Array[Vapi::Types::CreateAssistantDraftDtoClientMessagesItem] }, optional: true, nullable: false, api_name: "clientMessages"
      field :server_messages, -> { Internal::Types::Array[Vapi::Types::CreateAssistantDraftDtoServerMessagesItem] }, optional: true, nullable: false, api_name: "serverMessages"
      field :max_duration_seconds, -> { Integer }, optional: true, nullable: false, api_name: "maxDurationSeconds"
      field :background_sound, -> { Vapi::Types::CreateAssistantDraftDtoBackgroundSound }, optional: true, nullable: false, api_name: "backgroundSound"
      ...
      field :credentials, -> { Internal::Types::Array[Vapi::Types::CreateAssistantDraftDtoCredentialsItem] }, optional: true, nullable: false
      field :hooks, -> { Internal::Types::Array[Vapi::Types::CreateAssistantDraftDtoHooksItem] }, optional: true, nullable: false
      ...
      field :base_version, -> { String }, optional: true, nullable: false, api_name: "baseVersion"
    end
  end
end
