...
module Vapi
  module Types
    # Configuration used to create a reusable tool that sends HTTP requests to a configured API and can authenticate,
    # retry failures, and extract variables from responses.
