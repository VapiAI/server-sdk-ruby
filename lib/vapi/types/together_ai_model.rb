...
module Vapi
  class TogetherAiModel
    ...
    # @return [Array<Vapi::TogetherAiModelToolsItem>] These are the tools that the assistant can use during the call. To use existing
    #  tools, use `toolIds`.
    ...
    # @param tools [Array<Vapi::TogetherAiModelToolsItem>] These are the tools that the assistant can use during the call. To use existing
    #  tools, use `toolIds`.
    #  Both `tools` and `toolIds` can be used together.
    ...
    # Deserialize a JSON object to an instance of TogetherAiModel
    #
    ...
    # Serialize an instance of TogetherAiModel to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
