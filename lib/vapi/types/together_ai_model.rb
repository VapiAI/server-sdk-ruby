...
module Vapi
  module Types
    # Configuration for generating assistant responses with Together AI, including model, prompts, tools, knowledge-base
    # access, and generation settings.
    class TogetherAiModel < Internal::Types::Model
      field :messages, -> { Internal::Types::Array[Vapi::Types::OpenAiMessage] }, optional: true, nullable: false
      field :tools, -> { Internal::Types::Array[Vapi::Types::TogetherAiModelToolsItem] }, optional: true, nullable: false
