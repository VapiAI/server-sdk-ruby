...
module Vapi
  module Types
    # Configuration for generating assistant responses with Inflection AI, including model, prompts, tools,
    # knowledge-base access, and generation settings.
    class InflectionAiModel < Internal::Types::Model
      field :messages, -> { Internal::Types::Array[Vapi::Types::OpenAiMessage] }, optional: true, nullable: false
      field :tools, -> { Internal::Types::Array[Vapi::Types::InflectionAiModelToolsItem] }, optional: true, nullable: false
      ...
      field :model, -> { Vapi::Types::InflectionAiModelModel }, optional: false, nullable: false
