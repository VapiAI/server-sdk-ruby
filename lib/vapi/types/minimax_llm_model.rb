...
module Vapi
  module Types
    # Configuration for generating assistant responses with MiniMax, including model, prompts, tools, knowledge-base
    # access, and generation settings.
    class MinimaxLlmModel < Internal::Types::Model
      field :messages, -> { Internal::Types::Array[Vapi::Types::OpenAiMessage] }, optional: true, nullable: false
      field :tools, -> { Internal::Types::Array[Vapi::Types::MinimaxLlmModelToolsItem] }, optional: true, nullable: false
      ...
      field :model, -> { Vapi::Types::MinimaxLlmModelModel }, optional: false, nullable: false
