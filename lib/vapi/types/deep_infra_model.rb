...
module Vapi
  module Types
    # Configuration for generating assistant responses with DeepInfra, including model, prompts, tools, knowledge-base
    # access, and generation settings.
    class DeepInfraModel < Internal::Types::Model
      field :messages, -> { Internal::Types::Array[Vapi::Types::OpenAiMessage] }, optional: true, nullable: false
      field :tools, -> { Internal::Types::Array[Vapi::Types::DeepInfraModelToolsItem] }, optional: true, nullable: false
