...
module Vapi
  module Types
    class AssistantOverrides < Internal::Types::Model
      ...
      field :voice, -> { Vapi::Types::AssistantOverridesVoice }, optional: true, nullable: false
      ...
      field :first_message_mode, -> { Vapi::Types::AssistantOverridesFirstMessageMode }, optional: true, nullable: false, api_name: "firstMessageMode"
      field :voicemail_detection, -> { Vapi::Types::AssistantOverridesVoicemailDetection }, optional: true, nullable: false, api_name: "voicemailDetection"
      field :client_messages, -> { Internal::Types::Array[Vapi::Types::AssistantOverridesClientMessagesItem] }, optional: true, nullable: false, api_name: "clientMessages"
      field :server_messages, -> { Internal::Types::Array[Vapi::Types::AssistantOverridesServerMessagesItem] }, optional: true, nullable: false, api_name: "serverMessages"
      field :max_duration_seconds, -> { Integer }, optional: true, nullable: false, api_name: "maxDurationSeconds"
      field :background_sound, -> { Vapi::Types::AssistantOverridesBackgroundSound }, optional: true, nullable: false, api_name: "backgroundSound"
      ...
      field :credentials, -> { Internal::Types::Array[Vapi::Types::AssistantOverridesCredentialsItem] }, optional: true, nullable: false
      field :hooks, -> { Internal::Types::Array[Vapi::Types::AssistantOverridesHooksItem] }, optional: true, nullable: false
      field :tools_append, -> { Internal::Types::Array[Vapi::Types::AssistantOverridesToolsAppendItem] }, optional: true, nullable: false, api_name: "tools:append"
