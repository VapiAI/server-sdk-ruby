...
module Vapi
  module Types
    # Configuration for generating assistant responses with OpenAI, including model selection, fallback models, prompts,
    # tools, prompt caching, and generation settings.
    class OpenAiModel < Internal::Types::Model
      ...
      field :speaker, -> { Vapi::Types::OpenAiSpeaker }, optional: true, nullable: false
      field :reasoner, -> { Vapi::Types::OpenAiReasoner }, optional: true, nullable: false
      ...
      field :service_tier, -> { Vapi::Types::OpenAiModelServiceTier }, optional: true, nullable: false, api_name: "serviceTier"
      field :reasoning_effort, -> { Vapi::Types::OpenAiModelReasoningEffort }, optional: true, nullable: false, api_name: "reasoningEffort"
