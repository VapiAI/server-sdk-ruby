...
module Vapi
  module Types
    class ServerMessageCallDeleteFailed < Internal::Types::Model
      field :phone_number, -> { Vapi::Types::ServerMessageCallDeleteFailedPhoneNumber }, optional: true, nullable: false, api_name: "phoneNumber"
      field :type, -> { Vapi::Types::ServerMessageCallDeleteFailedType }, optional: false, nullable: false
