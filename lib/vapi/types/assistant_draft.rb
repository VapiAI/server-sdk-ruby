...
module Vapi
  module Types
    class AssistantDraft < Internal::Types::Model
      field :transcriber, -> { Vapi::Types::AssistantDraftTranscriber }, optional: true, nullable: false
      field :model, -> { Vapi::Types::AssistantDraftModel }, optional: true, nullable: false
      field :voice, -> { Vapi::Types::AssistantDraftVoice }, optional: true, nullable: false
      ...
      field :first_message_mode, -> { Vapi::Types::AssistantDraftFirstMessageMode }, optional: true, nullable: false, api_name: "firstMessageMode"
      field :voicemail_detection, -> { Vapi::Types::AssistantDraftVoicemailDetection }, optional: true, nullable: false, api_name: "voicemailDetection"
      field :client_messages, -> { Internal::Types::Array[Vapi::Types::AssistantDraftClientMessagesItem] }, optional: true, nullable: false, api_name: "clientMessages"
      field :server_messages, -> { Internal::Types::Array[Vapi::Types::AssistantDraftServerMessagesItem] }, optional: true, nullable: false, api_name: "serverMessages"
      field :max_duration_seconds, -> { Integer }, optional: true, nullable: false, api_name: "maxDurationSeconds"
      field :background_sound, -> { Vapi::Types::AssistantDraftBackgroundSound }, optional: true, nullable: false, api_name: "backgroundSound"
      ...
      field :credentials, -> { Internal::Types::Array[Vapi::Types::AssistantDraftCredentialsItem] }, optional: true, nullable: false
      field :hooks, -> { Internal::Types::Array[Vapi::Types::AssistantDraftHooksItem] }, optional: true, nullable: false
      field :model_deprecations, -> { Internal::Types::Array[Vapi::Types::ModelDeprecationNotice] }, optional: true, nullable: false, api_name: "modelDeprecations"
      ...
      field :base_version, -> { String }, optional: false, nullable: false, api_name: "baseVersion"
