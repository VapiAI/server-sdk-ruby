...
module Vapi
  module Types
    # Configuration for synthesizing assistant speech with Sesame, including voice and model selection, chunking,
    # caching, and fallback settings.
    class SesameVoice < Internal::Types::Model
      ...
      field :model, -> { Vapi::Types::SesameVoiceModel }, optional: false, nullable: false
