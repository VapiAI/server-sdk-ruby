...
module Vapi
  module Types
    # Configuration for synthesizing assistant speech with Cartesia, including voice and model selection, language,
    # generation controls, pronunciation dictionaries, chunking, caching, and fallback settings.
