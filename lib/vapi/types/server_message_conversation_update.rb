...
module Vapi
  class ServerMessageConversationUpdate
    # @return [Vapi::ServerMessageConversationUpdatePhoneNumber] This is the phone number associated with the call.
    ...
    # @param phone_number [Vapi::ServerMessageConversationUpdatePhoneNumber] This is the phone number associated with the call.
    #  This matches one of the following:
    #  - `call.phoneNumber`,
    #  - `call.phoneNumberId`.
