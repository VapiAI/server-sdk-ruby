...
module Vapi
  ...
  class VapiPhoneNumberFallbackDestination
    # Deserialize a JSON object to an instance of VapiPhoneNumberFallbackDestination
    #
    # @param json_object [String]
    # @return [Vapi::VapiPhoneNumberFallbackDestination]
