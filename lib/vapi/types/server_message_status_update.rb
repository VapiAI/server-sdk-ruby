...
module Vapi
  class ServerMessageStatusUpdate
    # @return [Vapi::ServerMessageStatusUpdatePhoneNumber] This is the phone number associated with the call.
    ...
    # @param phone_number [Vapi::ServerMessageStatusUpdatePhoneNumber] This is the phone number associated with the call.
    #  This matches one of the following:
    #  - `call.phoneNumber`,
    #  - `call.phoneNumberId`.
