...
module Vapi
  class ServerMessageVoiceInput
    # @return [Vapi::ServerMessageVoiceInputPhoneNumber] This is the phone number associated with the call.
    ...
    # @param phone_number [Vapi::ServerMessageVoiceInputPhoneNumber] This is the phone number associated with the call.
    #  This matches one of the following:
    #  - `call.phoneNumber`,
    #  - `call.phoneNumberId`.
    ...
    # Deserialize a JSON object to an instance of ServerMessageVoiceInput
    #
    ...
    # Serialize an instance of ServerMessageVoiceInput to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
