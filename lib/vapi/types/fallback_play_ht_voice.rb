...
module Vapi
  module Types
    # Fallback configuration for synthesizing assistant speech with PlayHT, including voice and model selection,
    # language, emotion and style guidance, chunking, and caching.
