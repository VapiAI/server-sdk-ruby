...
module Vapi
  module Types
    # Configuration for transcribing speech during assistant conversations with Deepgram, including model, language,
    # formatting, endpointing, vocabulary, and fallback settings.
    class DeepgramTranscriber < Internal::Types::Model
      ...
      field :redaction, -> { Internal::Types::Array[Vapi::Types::DeepgramTranscriberRedactionItem] }, optional: true, nullable: false
