...
module Vapi
  module Types
    class XaiVoice < Internal::Types::Model
      field :caching_enabled, -> { Internal::Types::Boolean }, optional: true, nullable: false, api_name: "cachingEnabled"
      field :voice_id, -> { Vapi::Types::XaiVoiceVoiceId }, optional: false, nullable: false, api_name: "voiceId"
      field :language, -> { Vapi::Types::XaiVoiceLanguage }, optional: true, nullable: false
