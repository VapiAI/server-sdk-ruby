...
module Vapi
  module Types
    class CreateWorkflowDto < Internal::Types::Model
      ...
      field :transcriber, -> { Vapi::Types::CreateWorkflowDtoTranscriber }, optional: true, nullable: false
      field :voice, -> { Vapi::Types::CreateWorkflowDtoVoice }, optional: true, nullable: false
      field :observability_plan, -> { Vapi::Types::LangfuseObservabilityPlan }, optional: true, nullable: false, api_name: "observabilityPlan"
      field :background_sound, -> { Vapi::Types::CreateWorkflowDtoBackgroundSound }, optional: true, nullable: false, api_name: "backgroundSound"
      field :hooks, -> { Internal::Types::Array[Vapi::Types::CreateWorkflowDtoHooksItem] }, optional: true, nullable: false
      field :credentials, -> { Internal::Types::Array[Vapi::Types::CreateWorkflowDtoCredentialsItem] }, optional: true, nullable: false
      field :voicemail_detection, -> { Vapi::Types::CreateWorkflowDtoVoicemailDetection }, optional: true, nullable: false, api_name: "voicemailDetection"
