...
module Vapi
  class GhlToolWithToolCallMessagesItem
    # Deserialize a JSON object to an instance of GhlToolWithToolCallMessagesItem
    #
    # @param json_object [String]
    # @return [Vapi::GhlToolWithToolCallMessagesItem]
