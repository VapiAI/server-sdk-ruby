...
module Vapi
  module Types
    # Configuration for generating assistant responses with xAI, including model, prompts, tools, knowledge-base access,
    # and generation settings.
    class XaiModel < Internal::Types::Model
      field :messages, -> { Internal::Types::Array[Vapi::Types::OpenAiMessage] }, optional: true, nullable: false
      field :tools, -> { Internal::Types::Array[Vapi::Types::XaiModelToolsItem] }, optional: true, nullable: false
      ...
      field :model, -> { Vapi::Types::XaiModelModel }, optional: false, nullable: false
