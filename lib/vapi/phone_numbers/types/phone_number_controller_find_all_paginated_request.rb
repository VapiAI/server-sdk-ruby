...
module Vapi
  module PhoneNumbers
    module Types
      class PhoneNumberControllerFindAllPaginatedRequest < Internal::Types::Model
        field :search, -> { String }, optional: true, nullable: false
        field :page, -> { Integer }, optional: true, nullable: false
        field :sort_order, -> { Vapi::PhoneNumbers::Types::PhoneNumberControllerFindAllPaginatedRequestSortOrder }, optional: true, nullable: false, api_name: "sortOrder"
        field :sort_by, -> { Vapi::PhoneNumbers::Types::PhoneNumberControllerFindAllPaginatedRequestSortBy }, optional: true, nullable: false, api_name: "sortBy"
