...
module Vapi
  module Assistants
    module Types
      class UpdateAssistantDto < Internal::Types::Model
        field :id, -> { String }, optional: false, nullable: false
        field :transcriber, -> { Vapi::Assistants::Types::UpdateAssistantDtoTranscriber }, optional: true, nullable: false
        field :model, -> { Vapi::Assistants::Types::UpdateAssistantDtoModel }, optional: true, nullable: false
        field :voice, -> { Vapi::Assistants::Types::UpdateAssistantDtoVoice }, optional: true, nullable: false
        ...
        field :first_message_mode, -> { Vapi::Assistants::Types::UpdateAssistantDtoFirstMessageMode }, optional: true, nullable: false, api_name: "firstMessageMode"
        field :voicemail_detection, -> { Vapi::Assistants::Types::UpdateAssistantDtoVoicemailDetection }, optional: true, nullable: false, api_name: "voicemailDetection"
        field :client_messages, -> { Internal::Types::Array[Vapi::Assistants::Types::UpdateAssistantDtoClientMessagesItem] }, optional: true, nullable: false, api_name: "clientMessages"
        field :server_messages, -> { Internal::Types::Array[Vapi::Assistants::Types::UpdateAssistantDtoServerMessagesItem] }, optional: true, nullable: false, api_name: "serverMessages"
        field :max_duration_seconds, -> { Integer }, optional: true, nullable: false, api_name: "maxDurationSeconds"
        field :background_sound, -> { Vapi::Assistants::Types::UpdateAssistantDtoBackgroundSound }, optional: true, nullable: false, api_name: "backgroundSound"
        ...
        field :credentials, -> { Internal::Types::Array[Vapi::Assistants::Types::UpdateAssistantDtoCredentialsItem] }, optional: true, nullable: false
        field :hooks, -> { Internal::Types::Array[Vapi::Assistants::Types::UpdateAssistantDtoHooksItem] }, optional: true, nullable: false
