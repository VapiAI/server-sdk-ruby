...
module Vapi
  module Board
    class Client
      ...
      # @option params [Vapi::Board::Types::BoardControllerFindAllRequestSortOrder, nil] :sort_order
      # @option params [Vapi::Board::Types::BoardControllerFindAllRequestSortBy, nil] :sort_by
      ...
      #
      # @return [Vapi::Types::BoardPaginatedResponse]
      def board_controller_find_all(request_options: {}, **params)
        ...
        if code.between?(200, 299)
          Vapi::Types::BoardPaginatedResponse.load(response.body)
        else
      ...
      # @param request_options [Hash]
      # @param params [Vapi::Board::Types::CreateBoardDto]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      # @option request_options [Integer] :timeout_in_seconds
      #
      # @return [Vapi::Types::Board]
      def board_controller_create(request_options: {}, **params)
        params = Vapi::Internal::Types::Utils.normalize_keys(params)
        request = Vapi::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "POST",
          path: "reporting/board",
          body: Vapi::Board::Types::CreateBoardDto.new(params).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
        ...
        code = response.code.to_i
        if code.between?(200, 299)
          Vapi::Types::Board.load(response.body)
        else
          error_class = Vapi::Errors::ResponseError.subclass_for_code(code)
          raise error_class.new(response.body, code: code)
        end
      ...
      #
      # @return [Vapi::Types::Board]
      def board_controller_metrics_overview_ensure(request_options: {}, **params)
      ...
      #
      # @return [Vapi::Types::Board]
      def board_controller_find_one(request_options: {}, **params)
        params = Vapi::Internal::Types::Utils.normalize_keys(params)
        request = Vapi::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "GET",
          path: "reporting/board/#{URI.encode_uri_component(params[:id].to_s)}",
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      #
      # @return [Vapi::Types::Board]
      def board_controller_remove(request_options: {}, **params)
        params = Vapi::Internal::Types::Utils.normalize_keys(params)
        request = Vapi::Internal::JSON::Request.new(
          base_url: request_options[:base_url],
          method: "DELETE",
      ...
      # @param request_options [Hash]
      # @param params [Vapi::Board::Types::UpdateBoardDto]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      #
      # @return [Vapi::Types::Board]
      def board_controller_update(request_options: {}, **params)
        params = Vapi::Internal::Types::Utils.normalize_keys(params)
        request_data = Vapi::Board::Types::UpdateBoardDto.new(params).to_h
