...
require "json"
require_relative "../../types/create_conversation_block_dto"
require_relative "../../types/create_tool_call_block_dto"
require_relative "../../types/create_workflow_block_dto"
...
module Vapi
  class Blocks
    class BlocksCreateRequest
      ...
      # @return [Vapi::Blocks::BlocksCreateRequest]
      def initialize(member:, discriminant:)
        @member = member
        @discriminant = discriminant
      end

      # Deserialize a JSON object to an instance of BlocksCreateRequest
      #
