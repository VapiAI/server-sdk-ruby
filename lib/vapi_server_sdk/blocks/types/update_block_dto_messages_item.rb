...
require "json"
require_relative "../../types/block_start_message"
require_relative "../../types/block_complete_message"

module Vapi
  class Blocks
    class UpdateBlockDtoMessagesItem
      # @return [Object]
      attr_reader :member
      # @return [String]
      ...
      # @return [Vapi::Blocks::UpdateBlockDtoMessagesItem]
      def initialize(member:, discriminant:)
        @member = member
        @discriminant = discriminant
      end

      # Deserialize a JSON object to an instance of UpdateBlockDtoMessagesItem
      #
