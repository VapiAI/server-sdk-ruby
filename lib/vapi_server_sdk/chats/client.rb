...
#  Mutually exclusive with sessionId.
    ...
    def create(assistant_id: nil, assistant: nil, name: nil, session_id: nil, input:, stream: nil, previous_chat_id: nil, request_options: nil)
  ...
  req.body = { **(request_options&.additional_body_parameters || {}), assistantId: assistant_id, assistant: assistant, name: name, sessionId: session_id, input: input, stream: stream, previousChatId: previous_chat_id }.compact
  req.url "#{@request_client.get_url(request_options: request_options)}/chat"
end
...
#  Mutually exclusive with sessionId.
    ...
    def create_response(assistant_id: nil, assistant: nil, name: nil, session_id: nil, input:, stream: nil, previous_chat_id: nil, request_options: nil)
      response = @request_client.conn.post do | req |
  unless request_options&.timeout_in_seconds.nil?
    req.options.timeout = request_options.timeout_in_seconds
  end
