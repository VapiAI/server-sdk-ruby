...
#  specified value.
    ...
    def list(assistant_id: nil, workflow_id: nil, session_id: nil, page: nil, sort_order: nil, limit: nil, created_at_gt: nil, created_at_lt: nil, created_at_ge: nil, created_at_le: nil, updated_at_gt: nil, updated_at_lt: nil, updated_at_ge: nil, updated_at_le: nil, request_options: nil)
  ...
  req.params = { **(request_options&.additional_query_parameters || {}), "assistantId": assistant_id, "workflowId": workflow_id, "sessionId": session_id, "page": page, "sortOrder": sort_order, "limit": limit, "createdAtGt": created_at_gt, "createdAtLt": created_at_lt, "createdAtGe": created_at_ge, "createdAtLe": created_at_le, "updatedAtGt": updated_at_gt, "updatedAtLt": updated_at_lt, "updatedAtGe": updated_at_ge, "updatedAtLe": updated_at_le }.compact
...
#  Mutually exclusive with sessionId.
    ...
    def create(assistant_id: nil, assistant: nil, assistant_overrides: nil, name: nil, session_id: nil, input:, stream: nil, previous_chat_id: nil, request_options: nil)
  ...
  req.body = { **(request_options&.additional_body_parameters || {}), assistantId: assistant_id, assistant: assistant, assistantOverrides: assistant_overrides, name: name, sessionId: session_id, input: input, stream: stream, previousChatId: previous_chat_id }.compact
  req.url "#{@request_client.get_url(request_options: request_options)}/chat"
end
...
#  Mutually exclusive with sessionId.
    ...
    def create_response(assistant_id: nil, assistant: nil, assistant_overrides: nil, name: nil, session_id: nil, input:, stream: nil, previous_chat_id: nil, request_options: nil)
      response = @request_client.conn.post do | req |
  unless request_options&.timeout_in_seconds.nil?
    req.options.timeout = request_options.timeout_in_seconds
  end
