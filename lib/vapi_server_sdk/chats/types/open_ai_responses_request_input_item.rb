...
module Vapi
  module Chats
    class OpenAiResponsesRequestInputItem


# Deserialize a JSON object to an instance of OpenAiResponsesRequestInputItem
      #
      # @param json_object [String] 
      # @return [Vapi::Chats::OpenAiResponsesRequestInputItem]
