...
module Vapi
  class Chats
    class OpenAiResponsesRequestInputOneItem
      # Deserialize a JSON object to an instance of OpenAiResponsesRequestInputOneItem
      #
      # @param json_object [String]
      # @return [Vapi::Chats::OpenAiResponsesRequestInputOneItem]
