...
module Vapi
  class Chats
    ...
    class CreateChatDtoInput
      # Deserialize a JSON object to an instance of CreateChatDtoInput
      #
      # @param json_object [String]
      # @return [Vapi::Chats::CreateChatDtoInput]
      def self.from_json(json_object:)
        ...
        begin
          ...
          return struct&.map do |item|
            item = item.to_json
            Vapi::Chats::CreateChatDtoInputOneItem.from_json(json_object: item)
          end
        rescue StandardError
          # noop
        end
