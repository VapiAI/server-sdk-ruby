...
module Vapi
  class CreateHandoffToolDtoMessagesItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::CreateHandoffToolDtoMessagesItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of CreateHandoffToolDtoMessagesItem
    #
