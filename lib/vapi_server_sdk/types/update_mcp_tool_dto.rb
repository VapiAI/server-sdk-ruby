...
module Vapi
  class UpdateMcpToolDto
    # @return [Array<Vapi::UpdateMcpToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    ...
    # @param messages [Array<Vapi::UpdateMcpToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    ...
    def initialize(messages: OMIT, server: OMIT, rejection_plan: OMIT, metadata: OMIT, additional_properties: nil)
    ...
    # Deserialize a JSON object to an instance of UpdateMcpToolDto
    #
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::UpdateMcpToolDtoMessagesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of UpdateMcpToolDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
