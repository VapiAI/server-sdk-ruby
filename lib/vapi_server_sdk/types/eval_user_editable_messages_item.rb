...
require_relative "chat_eval_tool_response_message_evaluation"
require_relative "chat_eval_user_message_mock"
require_relative "chat_eval_assistant_message_evaluation"

module Vapi
  class EvalUserEditableMessagesItem
    # Deserialize a JSON object to an instance of EvalUserEditableMessagesItem
    #
    # @param json_object [String]
    # @return [Vapi::EvalUserEditableMessagesItem]
