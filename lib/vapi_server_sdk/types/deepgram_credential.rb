...
require_relative "deepgram_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class DeepgramCredential
    # @return [Vapi::DeepgramCredentialProvider]
    ...
    # @param provider [Vapi::DeepgramCredentialProvider]
    ...
    # Deserialize a JSON object to an instance of DeepgramCredential
    #
    ...
    # Serialize an instance of DeepgramCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::DeepgramCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
