...
#  api.deepgram.com.
    ...
    def initialize(provider:, api_key:, id:, org_id:, created_at:, updated_at:, name: OMIT, api_url: OMIT, additional_properties: nil)
      @provider = provider
      @api_key = api_key
      @id = id
      @org_id = org_id
      ...
      @_field_set = { "provider": provider, "apiKey": api_key, "id": id, "orgId": org_id, "createdAt": created_at, "updatedAt": updated_at, "name": name, "apiUrl": api_url }.reject do | _k, v |
  v == OMIT
end
    end
