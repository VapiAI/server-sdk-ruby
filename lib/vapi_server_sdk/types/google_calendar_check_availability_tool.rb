...
require_relative "google_calendar_check_availability_tool_messages_item"
require "date"
require "date"
...
module Vapi
  class GoogleCalendarCheckAvailabilityTool
  # @return [Array<Vapi::GoogleCalendarCheckAvailabilityToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
...
#  `messages[].conditions` matches the "reason" argument.
  ...
  # @return [Object] 
    ...
    # @param messages [Array<Vapi::GoogleCalendarCheckAvailabilityToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
#  For some tools, this is auto-filled based on special fields like
#  `tool.destinations`. For others like the function tool, these can be custom
#  configured.
...
#  `messages[].conditions` matches the "reason" argument.
    ...
    # @return [Vapi::GoogleCalendarCheckAvailabilityTool]
    def initialize(messages: OMIT, id:, org_id:, created_at:, updated_at:, function: OMIT, additional_properties: nil)
      ...
      @_field_set = { "messages": messages, "id": id, "orgId": org_id, "createdAt": created_at, "updatedAt": updated_at, "function": function }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of GoogleCalendarCheckAvailabilityTool
    #
  ...
  item = item.to_json
  Vapi::GoogleCalendarCheckAvailabilityToolMessagesItem.from_json(json_object: item)
end
      id = parsed_json["id"]
...
# Serialize an instance of GoogleCalendarCheckAvailabilityTool to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
