...
#  @default 5000
    ...
    def initialize(voicemail_detection_types: OMIT, enabled: OMIT, machine_detection_timeout: OMIT, machine_detection_speech_threshold: OMIT, machine_detection_speech_end_threshold: OMIT, machine_detection_silence_timeout: OMIT, additional_properties: nil)
      ...
      @machine_detection_speech_threshold = machine_detection_speech_threshold if machine_detection_speech_threshold != OMIT
      @machine_detection_speech_end_threshold = machine_detection_speech_end_threshold if machine_detection_speech_end_threshold != OMIT
      @machine_detection_silence_timeout = machine_detection_silence_timeout if machine_detection_silence_timeout != OMIT
      @additional_properties = additional_properties
      @_field_set = { "voicemailDetectionTypes": voicemail_detection_types, "enabled": enabled, "machineDetectionTimeout": machine_detection_timeout, "machineDetectionSpeechThreshold": machine_detection_speech_threshold, "machineDetectionSpeechEndThreshold": machine_detection_speech_end_threshold, "machineDetectionSilenceTimeout": machine_detection_silence_timeout }.reject do | _k, v |
  v == OMIT
end
    end
