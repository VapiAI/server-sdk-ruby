...
module Vapi
  class CreateOpenAiCredentialDto
    ...
    # @return [Vapi::CreateOpenAiCredentialDto]
    ...
    # Deserialize a JSON object to an instance of CreateOpenAiCredentialDto
    #
    ...
    # Serialize an instance of CreateOpenAiCredentialDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
