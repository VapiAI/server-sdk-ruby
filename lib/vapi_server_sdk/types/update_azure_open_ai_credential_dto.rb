...
module Vapi
  ...
  # @return [Object] 
    ...
    def initialize(region: OMIT, models: OMIT, open_ai_key: OMIT, ocp_apim_subscription_key: OMIT, name: OMIT, open_ai_endpoint: OMIT, additional_properties: nil)
      ...
      @_field_set = { "region": region, "models": models, "openAIKey": open_ai_key, "ocpApimSubscriptionKey": ocp_apim_subscription_key, "name": name, "openAIEndpoint": open_ai_endpoint }.reject do | _k, v |
  v == OMIT
end
    end
