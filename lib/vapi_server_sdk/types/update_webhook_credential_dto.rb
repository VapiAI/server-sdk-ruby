...
require_relative "update_webhook_credential_dto_authentication_plan"
require "ostruct"
require "json"
  ...
  class UpdateWebhookCredentialDto
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["authenticationPlan"].nil?
        ...
        authentication_plan = Vapi::UpdateWebhookCredentialDtoAuthenticationPlan.from_json(json_object: authentication_plan)
      end
    ...
    def self.validate_raw(obj:)
      obj.authentication_plan.nil? || Vapi::UpdateWebhookCredentialDtoAuthenticationPlan.validate_raw(obj: obj.authentication_plan)
