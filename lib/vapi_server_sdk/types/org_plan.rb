...
module Vapi
  ...
  # @return [Object] 
    ...
    # @return [Vapi::OrgPlan]
    def initialize(included_providers: OMIT, included_minutes: OMIT, cost_per_overage_minute: OMIT, additional_properties: nil)
      ...
      @_field_set = { "includedProviders": included_providers, "includedMinutes": included_minutes, "costPerOverageMinute": cost_per_overage_minute }.reject do | _k, v |
  v == OMIT
end
    end
