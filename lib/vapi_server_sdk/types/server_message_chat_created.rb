...
require_relative "server_message_chat_created_phone_number"
require_relative "server_message_chat_created_type"
...
module Vapi
  class ServerMessageChatCreated
    # @return [Vapi::ServerMessageChatCreatedPhoneNumber] This is the phone number that the message is associated with.
    attr_reader :phone_number
    # @return [Vapi::ServerMessageChatCreatedType] This is the type of the message. "chat.created" is sent when a new chat is
    #  created.
    attr_reader :type
    ...
    attr_reader :call
    # @return [Vapi::Chat] This is the chat that was created.
    attr_reader :chat
    ...
    # @param phone_number [Vapi::ServerMessageChatCreatedPhoneNumber] This is the phone number that the message is associated with.
    # @param type [Vapi::ServerMessageChatCreatedType] This is the type of the message. "chat.created" is sent when a new chat is
    #  created.
    ...
    # @param chat [Vapi::Chat] This is the chat that was created.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vapi::ServerMessageChatCreated]
    ...
    # Deserialize a JSON object to an instance of ServerMessageChatCreated
    #
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["phoneNumber"].nil?
        ...
        phone_number = Vapi::ServerMessageChatCreatedPhoneNumber.from_json(json_object: phone_number)
      end
    ...
    # Serialize an instance of ServerMessageChatCreated to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.phone_number.nil? || Vapi::ServerMessageChatCreatedPhoneNumber.validate_raw(obj: obj.phone_number)
      obj.type.is_a?(Vapi::ServerMessageChatCreatedType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
