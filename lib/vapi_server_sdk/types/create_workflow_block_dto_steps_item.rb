...
module Vapi
  class CreateWorkflowBlockDtoStepsItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::CreateWorkflowBlockDtoStepsItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of CreateWorkflowBlockDtoStepsItem
    #
