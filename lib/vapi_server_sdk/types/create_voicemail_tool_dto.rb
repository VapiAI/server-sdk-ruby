...
#  configured.
  ...
  # @return [String] The type of tool. "voicemail". This uses the model itself to determine if a
#  voicemil was reached. Can be used alternatively/alongside with
...
#  `tool.destinations`. For others like the function tool, these can be custom
#  configured.
    # @param type [String] The type of tool. "voicemail". This uses the model itself to determine if a
#  voicemil was reached. Can be used alternatively/alongside with
#  TwilioVoicemailDetection
...
#  `messages[].conditions` matches the "reason" argument.
    ...
    def initialize(messages: OMIT, type:, function: OMIT, additional_properties: nil)
