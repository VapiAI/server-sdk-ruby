...
module Vapi
  ...
  class CustomCredentialAuthenticationPlan
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::CustomCredentialAuthenticationPlan]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of CustomCredentialAuthenticationPlan
    #
