...
module Vapi
  class CallHookCustomerSpeechTimeoutDoItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::CallHookCustomerSpeechTimeoutDoItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of CallHookCustomerSpeechTimeoutDoItem
    #
