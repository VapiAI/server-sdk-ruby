...
module Vapi
  class CreateWorkflowDtoCredentialsItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::CreateWorkflowDtoCredentialsItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of CreateWorkflowDtoCredentialsItem
    #
