...
require_relative "update_go_high_level_calendar_event_create_tool_dto_messages_item"
...
module Vapi
  class UpdateGoHighLevelCalendarEventCreateToolDto
    # @return [Array<Vapi::UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    ...
    # @param messages [Array<Vapi::UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    ...
    # @return [Vapi::UpdateGoHighLevelCalendarEventCreateToolDto]
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of UpdateGoHighLevelCalendarEventCreateToolDto to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
