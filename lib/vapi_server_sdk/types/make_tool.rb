...
require_relative "make_tool_messages_item"
require_relative "make_tool_type"
require "date"
...
module Vapi
  class MakeTool
    # @return [Array<Vapi::MakeToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    attr_reader :messages
    # @return [Vapi::MakeToolType] The type of tool. "make" for Make tool.
    attr_reader :type
    ...
    # @param messages [Array<Vapi::MakeToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param type [Vapi::MakeToolType] The type of tool. "make" for Make tool.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::MakeToolType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
