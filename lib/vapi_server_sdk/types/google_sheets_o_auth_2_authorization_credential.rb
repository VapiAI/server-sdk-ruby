...
require_relative "google_sheets_o_auth_2_authorization_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class GoogleSheetsOAuth2AuthorizationCredential
    # @return [Vapi::GoogleSheetsOAuth2AuthorizationCredentialProvider]
    ...
    # @param provider [Vapi::GoogleSheetsOAuth2AuthorizationCredentialProvider]
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::GoogleSheetsOAuth2AuthorizationCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
