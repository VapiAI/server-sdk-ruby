...
module Vapi
  class GoHighLevelCalendarAvailabilityToolWithToolCall
    ...
    # @return [String] The type of tool. "gohighlevel.calendar.availability.check" for GoHighLevel
    ...
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param type [String] The type of tool. "gohighlevel.calendar.availability.check" for GoHighLevel
    #  Calendar availability check tool.
    ...
    def initialize(type:, tool_call:, messages: OMIT, function: OMIT, additional_properties: nil)
