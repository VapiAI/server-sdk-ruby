...
module Vapi
  ...
  class ClientMessageChatDeletedPhoneNumber
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::ClientMessageChatDeletedPhoneNumber]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of ClientMessageChatDeletedPhoneNumber
    #
