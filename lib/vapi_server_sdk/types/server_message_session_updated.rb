...
require_relative "server_message_session_updated_phone_number"
require_relative "server_message_session_updated_type"
...
module Vapi
  class ServerMessageSessionUpdated
    # @return [Vapi::ServerMessageSessionUpdatedPhoneNumber] This is the phone number that the message is associated with.
    attr_reader :phone_number
    # @return [Vapi::ServerMessageSessionUpdatedType] This is the type of the message. "session.updated" is sent when a session is
    #  updated.
    attr_reader :type
    ...
    # @param phone_number [Vapi::ServerMessageSessionUpdatedPhoneNumber] This is the phone number that the message is associated with.
    # @param type [Vapi::ServerMessageSessionUpdatedType] This is the type of the message. "session.updated" is sent when a session is
    #  updated.
    ...
    # @return [Vapi::ServerMessageSessionUpdated]
    ...
    # Deserialize a JSON object to an instance of ServerMessageSessionUpdated
    #
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["phoneNumber"].nil?
        ...
        phone_number = Vapi::ServerMessageSessionUpdatedPhoneNumber.from_json(json_object: phone_number)
      end
    ...
    # Serialize an instance of ServerMessageSessionUpdated to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.phone_number.nil? || Vapi::ServerMessageSessionUpdatedPhoneNumber.validate_raw(obj: obj.phone_number)
      obj.type.is_a?(Vapi::ServerMessageSessionUpdatedType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
