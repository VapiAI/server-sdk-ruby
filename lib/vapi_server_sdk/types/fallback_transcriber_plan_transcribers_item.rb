  ...
  class FallbackTranscriberPlanTranscribersItem
    ...
    def self.from_json(json_object:)
      ...
      member = case struct.provider
               when "assembly-ai"
                 Vapi::FallbackAssemblyAiTranscriber.from_json(json_object: json_object)
               when "azure"
                 Vapi::FallbackAzureSpeechTranscriber.from_json(json_object: json_object)
               when "custom-transcriber"
                 Vapi::FallbackCustomTranscriber.from_json(json_object: json_object)
               when "deepgram"
                 Vapi::FallbackDeepgramTranscriber.from_json(json_object: json_object)
               when "11labs"
                 Vapi::FallbackElevenLabsTranscriber.from_json(json_object: json_object)
               when "gladia"
                 Vapi::FallbackGladiaTranscriber.from_json(json_object: json_object)
               when "google"
                 Vapi::FallbackGoogleTranscriber.from_json(json_object: json_object)
               when "talkscriber"
                 Vapi::FallbackTalkscriberTranscriber.from_json(json_object: json_object)
               when "speechmatics"
                 Vapi::FallbackSpeechmaticsTranscriber.from_json(json_object: json_object)
               when "openai"
                 Vapi::FallbackOpenAiTranscriber.from_json(json_object: json_object)
               when "cartesia"
                 Vapi::FallbackCartesiaTranscriber.from_json(json_object: json_object)
               else
                 Vapi::FallbackAssemblyAiTranscriber.from_json(json_object: json_object)
               end
