...
require_relative "create_text_editor_tool_dto_sub_type"
require_relative "server"
require_relative "create_text_editor_tool_dto_name"
...
module Vapi
  class CreateTextEditorToolDto
    ...
    # @return [Vapi::CreateTextEditorToolDtoSubType] The sub type of tool.
    ...
    attr_reader :server
    # @return [Vapi::CreateTextEditorToolDtoName] The name of the tool, fixed to 'str_replace_editor'
    attr_reader :name
    ...
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param sub_type [Vapi::CreateTextEditorToolDtoSubType] The sub type of tool.
    ...
    #  {{org.server.url}}.
    #  - Webhook expects a response with tool call result.
    # @param name [Vapi::CreateTextEditorToolDtoName] The name of the tool, fixed to 'str_replace_editor'
    ...
    def self.validate_raw(obj:)
      ...
      obj.sub_type.is_a?(Vapi::CreateTextEditorToolDtoSubType) != false || raise("Passed value for field obj.sub_type is not the expected type, validation failed.")
      obj.server.nil? || Vapi::Server.validate_raw(obj: obj.server)
      obj.name.is_a?(Vapi::CreateTextEditorToolDtoName) != false || raise("Passed value for field obj.name is not the expected type, validation failed.")
