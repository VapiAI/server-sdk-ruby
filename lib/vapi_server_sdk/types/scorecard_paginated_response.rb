...
module Vapi
  class ScorecardPaginatedResponse
    # @return [Array<Vapi::Scorecard>]
    attr_reader :results
    ...
    # @param results [Array<Vapi::Scorecard>]
    ...
    # Deserialize a JSON object to an instance of ScorecardPaginatedResponse
    #
    ...
    def self.from_json(json_object:)
      ...
      results = parsed_json["results"]&.map do |item|
        item = item.to_json
        Vapi::Scorecard.from_json(json_object: item)
      end
    ...
    # Serialize an instance of ScorecardPaginatedResponse to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
