...
require_relative "update_query_tool_dto_messages_item"
...
module Vapi
  ...
  # @return [Array<Vapi::UpdateQueryToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
...
#  `messages[].conditions` matches the "reason" argument.
  ...
  # @return [Object] 
    ...
    # @param messages [Array<Vapi::UpdateQueryToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
#  For some tools, this is auto-filled based on special fields like
#  `tool.destinations`. For others like the function tool, these can be custom
#  configured.
...
#  `messages[].conditions` matches the "reason" argument.
    ...
    # @return [Vapi::UpdateQueryToolDto]
    def initialize(messages: OMIT, knowledge_bases: OMIT, function: OMIT, additional_properties: nil)
      @messages = messages if messages != OMIT
      @knowledge_bases = knowledge_bases if knowledge_bases != OMIT
      @function = function if function != OMIT
      @additional_properties = additional_properties
      @_field_set = { "messages": messages, "knowledgeBases": knowledge_bases, "function": function }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of UpdateQueryToolDto
    #
  ...
  item = item.to_json
  Vapi::UpdateQueryToolDtoMessagesItem.from_json(json_object: item)
end
...
# Serialize an instance of UpdateQueryToolDto to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
