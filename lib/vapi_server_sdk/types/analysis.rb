...
#  `assistant.analysisPlan.successEvaluationRubric`.
    ...
    def initialize(summary: OMIT, structured_data: OMIT, structured_data_multi: OMIT, success_evaluation: OMIT, additional_properties: nil)
      ...
      @_field_set = { "summary": summary, "structuredData": structured_data, "structuredDataMulti": structured_data_multi, "successEvaluation": success_evaluation }.reject do | _k, v |
  v == OMIT
end
    end
