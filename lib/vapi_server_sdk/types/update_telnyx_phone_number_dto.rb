...
require_relative "update_telnyx_phone_number_dto_hooks_item"
...
module Vapi
  class UpdateTelnyxPhoneNumberDto
    ...
    # @return [Array<Vapi::UpdateTelnyxPhoneNumberDtoHooksItem>] This is the hooks that will be used for incoming calls to this phone number.
    attr_reader :hooks
    ...
    #  If this is not set and above conditions are met, the inbound call is hung up
    #  with an error message.
    # @param hooks [Array<Vapi::UpdateTelnyxPhoneNumberDtoHooksItem>] This is the hooks that will be used for incoming calls to this phone number.
    ...
    def self.from_json(json_object:)
      ...
      hooks = parsed_json["hooks"]&.map do |item|
        item = item.to_json
        Vapi::UpdateTelnyxPhoneNumberDtoHooksItem.from_json(json_object: item)
      end
