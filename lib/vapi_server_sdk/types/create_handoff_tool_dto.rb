...
require_relative "create_handoff_tool_dto_messages_item"
require_relative "create_handoff_tool_dto_destinations_item"
...
module Vapi
  class CreateHandoffToolDto
    # @return [Array<Vapi::CreateHandoffToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    attr_reader :messages
    # @return [Array<Vapi::CreateHandoffToolDtoDestinationsItem>] These are the destinations that the call can be handed off to.
    #  Usage:
    ...
    # @param messages [Array<Vapi::CreateHandoffToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param destinations [Array<Vapi::CreateHandoffToolDtoDestinationsItem>] These are the destinations that the call can be handed off to.
    #  Usage:
    #  1. Single destination
    #  Use `assistantId` to handoff the call to a saved assistant, or `assistantName`
    #  to handoff the call to an assistant in the same squad.
    ...
    # @return [Vapi::CreateHandoffToolDto]
    def initialize(messages: OMIT, destinations: OMIT, function: OMIT, rejection_plan: OMIT, additional_properties: nil)
    ...
    # Deserialize a JSON object to an instance of CreateHandoffToolDto
    #
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::CreateHandoffToolDtoMessagesItem.from_json(json_object: item)
      end
      destinations = parsed_json["destinations"]&.map do |item|
        item = item.to_json
        Vapi::CreateHandoffToolDtoDestinationsItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of CreateHandoffToolDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
