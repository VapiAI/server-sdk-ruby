...
module Vapi
  class CreateComputerToolDtoMessagesItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::CreateComputerToolDtoMessagesItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of CreateComputerToolDtoMessagesItem
    #
