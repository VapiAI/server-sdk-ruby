...
module Vapi
  class GoHighLevelCalendarAvailabilityToolProviderDetails
  ...
  # @return [Object] 
    ...
    # @return [Vapi::GoHighLevelCalendarAvailabilityToolProviderDetails]
...
# Serialize an instance of GoHighLevelCalendarAvailabilityToolProviderDetails to a
#  JSON object
    #
    # @return [String]
    def to_json
