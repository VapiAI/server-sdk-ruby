...
#  requested from voice provider.
    ...
    def initialize(phone_number: OMIT, type:, timestamp: OMIT, call: OMIT, customer: OMIT, assistant: OMIT, input:, additional_properties: nil)
      ...
      @_field_set = { "phoneNumber": phone_number, "type": type, "timestamp": timestamp, "call": call, "customer": customer, "assistant": assistant, "input": input }.reject do | _k, v |
  v == OMIT
end
    end
