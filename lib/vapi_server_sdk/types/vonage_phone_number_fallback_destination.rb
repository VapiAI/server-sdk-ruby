...
#  with an error message.
  class VonagePhoneNumberFallbackDestination
  # @return [Object] 
    attr_reader :member
  # @return [String] 
    ...
    # @return [Vapi::VonagePhoneNumberFallbackDestination]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end
# Deserialize a JSON object to an instance of VonagePhoneNumberFallbackDestination
    #
