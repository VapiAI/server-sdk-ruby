...
require_relative "google_sheets_row_append_tool_with_tool_call_type"
...
module Vapi
  class GoogleSheetsRowAppendToolWithToolCall
    ...
    # @return [Vapi::GoogleSheetsRowAppendToolWithToolCallType] The type of tool. "google.sheets.row.append" for Google Sheets Row Append tool.
    attr_reader :type
    ...
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param type [Vapi::GoogleSheetsRowAppendToolWithToolCallType] The type of tool. "google.sheets.row.append" for Google Sheets Row Append tool.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::GoogleSheetsRowAppendToolWithToolCallType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
