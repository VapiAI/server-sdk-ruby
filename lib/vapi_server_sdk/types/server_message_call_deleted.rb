...
require_relative "server_message_call_deleted_phone_number"
require_relative "server_message_call_deleted_type"
...
module Vapi
  class ServerMessageCallDeleted
    # @return [Vapi::ServerMessageCallDeletedPhoneNumber] This is the phone number that the message is associated with.
    attr_reader :phone_number
    # @return [Vapi::ServerMessageCallDeletedType] This is the type of the message. "call.deleted" is sent when a call is deleted.
    attr_reader :type
    ...
    # @param phone_number [Vapi::ServerMessageCallDeletedPhoneNumber] This is the phone number that the message is associated with.
    # @param type [Vapi::ServerMessageCallDeletedType] This is the type of the message. "call.deleted" is sent when a call is deleted.
    ...
    # @return [Vapi::ServerMessageCallDeleted]
    ...
    # Deserialize a JSON object to an instance of ServerMessageCallDeleted
    #
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["phoneNumber"].nil?
        ...
        phone_number = Vapi::ServerMessageCallDeletedPhoneNumber.from_json(json_object: phone_number)
      end
    ...
    # Serialize an instance of ServerMessageCallDeleted to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.phone_number.nil? || Vapi::ServerMessageCallDeletedPhoneNumber.validate_raw(obj: obj.phone_number)
      obj.type.is_a?(Vapi::ServerMessageCallDeletedType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
