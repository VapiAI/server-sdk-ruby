...
module Vapi
  class UpdateComputerToolDto
    ...
    def initialize(messages: OMIT, sub_type: OMIT, server: OMIT, function: OMIT, name: OMIT, display_width_px: OMIT,
                   display_height_px: OMIT, display_number: OMIT, additional_properties: nil)
