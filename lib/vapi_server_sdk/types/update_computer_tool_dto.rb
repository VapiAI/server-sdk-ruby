...
#  `messages[].conditions` matches the "reason" argument.
    ...
    def initialize(messages: OMIT, sub_type: OMIT, server: OMIT, function: OMIT, name: OMIT, display_width_px: OMIT, display_height_px: OMIT, display_number: OMIT, additional_properties: nil)
      ...
      @_field_set = { "messages": messages, "subType": sub_type, "server": server, "function": function, "name": name, "displayWidthPx": display_width_px, "displayHeightPx": display_height_px, "displayNumber": display_number }.reject do | _k, v |
  v == OMIT
end
    end
