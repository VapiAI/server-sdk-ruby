...
require_relative "update_computer_tool_dto_sub_type"
require_relative "server"
require_relative "tool_rejection_plan"
require_relative "update_computer_tool_dto_name"
require "ostruct"
require "json"
...
module Vapi
  class UpdateComputerToolDto
    ...
    # @return [Vapi::UpdateComputerToolDtoSubType] The sub type of tool.
    ...
    # @return [Vapi::UpdateComputerToolDtoName] The name of the tool, fixed to 'computer'
    attr_reader :name
    ...
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param sub_type [Vapi::UpdateComputerToolDtoSubType] The sub type of tool.
    ...
    #  }
    #  ```
    # @param name [Vapi::UpdateComputerToolDtoName] The name of the tool, fixed to 'computer'
    ...
    def self.validate_raw(obj:)
      ...
      obj.sub_type&.is_a?(Vapi::UpdateComputerToolDtoSubType) != false || raise("Passed value for field obj.sub_type is not the expected type, validation failed.")
      obj.server.nil? || Vapi::Server.validate_raw(obj: obj.server)
      obj.rejection_plan.nil? || Vapi::ToolRejectionPlan.validate_raw(obj: obj.rejection_plan)
      obj.name&.is_a?(Vapi::UpdateComputerToolDtoName) != false || raise("Passed value for field obj.name is not the expected type, validation failed.")
