...
require_relative "output_tool_messages_item"
require_relative "output_tool_type"
require "date"
...
module Vapi
  class OutputTool
    # @return [Array<Vapi::OutputToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    attr_reader :messages
    # @return [Vapi::OutputToolType] The type of tool. "output" for Output tool.
    attr_reader :type
    ...
    # @param messages [Array<Vapi::OutputToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param type [Vapi::OutputToolType] The type of tool. "output" for Output tool.
    ...
    # @return [Vapi::OutputTool]
    def initialize(type:, id:, org_id:, created_at:, updated_at:, messages: OMIT, rejection_plan: OMIT,
    ...
    # Deserialize a JSON object to an instance of OutputTool
    #
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::OutputToolMessagesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of OutputTool to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::OutputToolType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
