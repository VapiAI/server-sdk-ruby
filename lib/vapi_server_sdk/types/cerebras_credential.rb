...
require_relative "cerebras_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class CerebrasCredential
    # @return [Vapi::CerebrasCredentialProvider]
    ...
    # @param provider [Vapi::CerebrasCredentialProvider]
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::CerebrasCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
