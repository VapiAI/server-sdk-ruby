...
module Vapi
  class OpenAiWebChatRequestInputOneItem
    # Deserialize a JSON object to an instance of OpenAiWebChatRequestInputOneItem
    #
    # @param json_object [String]
    # @return [Vapi::OpenAiWebChatRequestInputOneItem]
