...
require_relative "server_message_call_delete_failed_phone_number"
require_relative "server_message_call_delete_failed_type"
...
module Vapi
  class ServerMessageCallDeleteFailed
    # @return [Vapi::ServerMessageCallDeleteFailedPhoneNumber] This is the phone number that the message is associated with.
    attr_reader :phone_number
    # @return [Vapi::ServerMessageCallDeleteFailedType] This is the type of the message. "call.deleted" is sent when a call is deleted.
    attr_reader :type
    ...
    # @param phone_number [Vapi::ServerMessageCallDeleteFailedPhoneNumber] This is the phone number that the message is associated with.
    # @param type [Vapi::ServerMessageCallDeleteFailedType] This is the type of the message. "call.deleted" is sent when a call is deleted.
    ...
    # @return [Vapi::ServerMessageCallDeleteFailed]
    ...
    # Deserialize a JSON object to an instance of ServerMessageCallDeleteFailed
    #
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["phoneNumber"].nil?
        ...
        phone_number = Vapi::ServerMessageCallDeleteFailedPhoneNumber.from_json(json_object: phone_number)
      end
    ...
    # Serialize an instance of ServerMessageCallDeleteFailed to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.phone_number.nil? || Vapi::ServerMessageCallDeleteFailedPhoneNumber.validate_raw(obj: obj.phone_number)
      obj.type.is_a?(Vapi::ServerMessageCallDeleteFailedType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
