...
require_relative "server_message_assistant_request_type"
...
module Vapi
  class ServerMessageAssistantRequest
    ...
    # @return [Vapi::ServerMessageAssistantRequestType] This is the type of the message. "assistant-request" is sent to fetch assistant
    ...
    # @param type [Vapi::ServerMessageAssistantRequestType] This is the type of the message. "assistant-request" is sent to fetch assistant
    #  configuration for an incoming call.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::ServerMessageAssistantRequestType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
