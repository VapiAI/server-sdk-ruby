...
module Vapi
  class ServerMessageAssistantRequest
    # @return [Vapi::ServerMessageAssistantRequestPhoneNumber] This is the phone number associated with the call.
    ...
    # @param phone_number [Vapi::ServerMessageAssistantRequestPhoneNumber] This is the phone number associated with the call.
    #  This matches one of the following:
    #  - `call.phoneNumber`,
    #  - `call.phoneNumberId`.
