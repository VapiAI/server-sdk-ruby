...
module Vapi
  ...
  # @return [Object] 
    ...
    def initialize(template_url: OMIT, setup_instructions: OMIT, scenario_id: OMIT, scenario_name: OMIT, trigger_hook_id: OMIT, trigger_hook_name: OMIT, additional_properties: nil)
      ...
      @_field_set = { "templateUrl": template_url, "setupInstructions": setup_instructions, "scenarioId": scenario_id, "scenarioName": scenario_name, "triggerHookId": trigger_hook_id, "triggerHookName": trigger_hook_name }.reject do | _k, v |
  v == OMIT
end
    end
