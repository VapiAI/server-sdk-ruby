  ...
  class FallbackPlanVoicesItem
    ...
    def self.from_json(json_object:)
      ...
      member = case struct.provider
               ...
               when "neuphonic"
                 Vapi::FallbackNeuphonicVoice.from_json(json_object: json_object)
               when "sesame"
                 Vapi::FallbackSesameVoice.from_json(json_object: json_object)
               when "inworld"
                 Vapi::FallbackInworldVoice.from_json(json_object: json_object)
               else
                 Vapi::FallbackAzureVoice.from_json(json_object: json_object)
               end
