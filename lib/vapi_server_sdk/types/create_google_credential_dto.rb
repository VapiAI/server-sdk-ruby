...
module Vapi
  class CreateGoogleCredentialDto
    ...
    # @return [Vapi::CreateGoogleCredentialDto]
    ...
    # Deserialize a JSON object to an instance of CreateGoogleCredentialDto
    #
    ...
    # Serialize an instance of CreateGoogleCredentialDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
