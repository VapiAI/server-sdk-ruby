...
require_relative "inflection_ai_model_tools_item"
require_relative "create_custom_knowledge_base_dto"
require_relative "inflection_ai_model_model"
require "ostruct"
require "json"
...
module Vapi
  class InflectionAiModel
    ...
    # @return [Array<Vapi::InflectionAiModelToolsItem>] These are the tools that the assistant can use during the call. To use existing
    #  tools, use `toolIds`.
    ...
    # @return [Vapi::InflectionAiModelModel] This is the name of the model. Ex. cognitivecomputations/dolphin-mixtral-8x7b
    attr_reader :model
    ...
    # @param tools [Array<Vapi::InflectionAiModelToolsItem>] These are the tools that the assistant can use during the call. To use existing
    #  tools, use `toolIds`.
    #  Both `tools` and `toolIds` can be used together.
    ...
    # @param model [Vapi::InflectionAiModelModel] This is the name of the model. Ex. cognitivecomputations/dolphin-mixtral-8x7b
    ...
    # Deserialize a JSON object to an instance of InflectionAiModel
    #
    ...
    def self.from_json(json_object:)
      ...
      tools = parsed_json["tools"]&.map do |item|
        item = item.to_json
        Vapi::InflectionAiModelToolsItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of InflectionAiModel to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.model.is_a?(Vapi::InflectionAiModelModel) != false || raise("Passed value for field obj.model is not the expected type, validation failed.")
