...
module Vapi
  class FallbackRimeAiVoice
    ...
    # @return [Vapi::FallbackRimeAiVoiceModel] This is the model that will be used. Defaults to 'arcana' when not specified.
    attr_reader :model
    ...
    # @param model [Vapi::FallbackRimeAiVoiceModel] This is the model that will be used. Defaults to 'arcana' when not specified.
