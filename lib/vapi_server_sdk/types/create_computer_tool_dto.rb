...
require_relative "create_computer_tool_dto_messages_item"
require_relative "create_computer_tool_dto_sub_type"
require_relative "server"
require_relative "create_computer_tool_dto_name"
...
module Vapi
  class CreateComputerToolDto
    # @return [Array<Vapi::CreateComputerToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    attr_reader :messages
    # @return [Vapi::CreateComputerToolDtoSubType] The sub type of tool.
    ...
    attr_reader :server
    # @return [Vapi::CreateComputerToolDtoName] The name of the tool, fixed to 'computer'
    attr_reader :name
    ...
    # @param messages [Array<Vapi::CreateComputerToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param sub_type [Vapi::CreateComputerToolDtoSubType] The sub type of tool.
    ...
    #  {{org.server.url}}.
    #  - Webhook expects a response with tool call result.
    # @param name [Vapi::CreateComputerToolDtoName] The name of the tool, fixed to 'computer'
    ...
    # @return [Vapi::CreateComputerToolDto]
    def initialize(sub_type:, name:, display_width_px:, display_height_px:, messages: OMIT, server: OMIT,
                   display_number: OMIT, rejection_plan: OMIT, additional_properties: nil)
    ...
    def self.validate_raw(obj:)
      ...
      obj.sub_type.is_a?(Vapi::CreateComputerToolDtoSubType) != false || raise("Passed value for field obj.sub_type is not the expected type, validation failed.")
      obj.server.nil? || Vapi::Server.validate_raw(obj: obj.server)
      obj.name.is_a?(Vapi::CreateComputerToolDtoName) != false || raise("Passed value for field obj.name is not the expected type, validation failed.")
