...
#  `messages[].conditions` matches the "reason" argument.
    ...
    def initialize(messages: OMIT, sub_type:, server: OMIT, name:, display_width_px:, display_height_px:, display_number: OMIT, function: OMIT, additional_properties: nil)
      ...
      @_field_set = { "messages": messages, "subType": sub_type, "server": server, "name": name, "displayWidthPx": display_width_px, "displayHeightPx": display_height_px, "displayNumber": display_number, "function": function }.reject do | _k, v |
  v == OMIT
end
    end
