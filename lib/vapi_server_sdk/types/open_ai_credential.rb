...
require_relative "open_ai_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class OpenAiCredential
    # @return [Vapi::OpenAiCredentialProvider]
    ...
    # @param provider [Vapi::OpenAiCredentialProvider]
    ...
    # Serialize an instance of OpenAiCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::OpenAiCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
