...
require_relative "lmnt_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class LmntCredential
    # @return [Vapi::LmntCredentialProvider]
    ...
    # @param provider [Vapi::LmntCredentialProvider]
    ...
    # Deserialize a JSON object to an instance of LmntCredential
    #
    ...
    # Serialize an instance of LmntCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::LmntCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
