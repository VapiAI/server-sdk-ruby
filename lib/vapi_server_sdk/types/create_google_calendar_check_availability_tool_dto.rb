...
require_relative "create_google_calendar_check_availability_tool_dto_messages_item"
...
module Vapi
  class CreateGoogleCalendarCheckAvailabilityToolDto
    # @return [Array<Vapi::CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    ...
    # @param messages [Array<Vapi::CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    ...
    # @return [Vapi::CreateGoogleCalendarCheckAvailabilityToolDto]
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of CreateGoogleCalendarCheckAvailabilityToolDto to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
