...
# This is the phone number that the message is associated with.
  class ClientMessageModelOutputPhoneNumber
  # @return [Object] 
    attr_reader :member
  # @return [String] 
    ...
    # @return [Vapi::ClientMessageModelOutputPhoneNumber]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end
# Deserialize a JSON object to an instance of ClientMessageModelOutputPhoneNumber
    #
