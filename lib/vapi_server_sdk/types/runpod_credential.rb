...
require_relative "runpod_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class RunpodCredential
    # @return [Vapi::RunpodCredentialProvider]
    ...
    # @param provider [Vapi::RunpodCredentialProvider]
    ...
    # Serialize an instance of RunpodCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::RunpodCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
