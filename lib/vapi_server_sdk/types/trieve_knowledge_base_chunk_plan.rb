...
#  with 22 splits each.
    ...
    def initialize(file_ids: OMIT, websites: OMIT, target_splits_per_chunk: OMIT, split_delimiters: OMIT, rebalance_chunks: OMIT, additional_properties: nil)
      ...
      @_field_set = { "fileIds": file_ids, "websites": websites, "targetSplitsPerChunk": target_splits_per_chunk, "splitDelimiters": split_delimiters, "rebalanceChunks": rebalance_chunks }.reject do | _k, v |
  v == OMIT
end
    end
