...
require_relative "handoff_tool_messages_item"
require_relative "handoff_tool_destinations_item"
require "date"
...
module Vapi
  class HandoffTool
    # @return [Array<Vapi::HandoffToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    attr_reader :messages
    # @return [Array<Vapi::HandoffToolDestinationsItem>] These are the destinations that the call can be handed off to.
    #  Usage:
    ...
    # @param messages [Array<Vapi::HandoffToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param destinations [Array<Vapi::HandoffToolDestinationsItem>] These are the destinations that the call can be handed off to.
    #  Usage:
    #  1. Single destination
    #  Use `assistantId` to handoff the call to a saved assistant, or `assistantName`
    #  to handoff the call to an assistant in the same squad.
    ...
    # @return [Vapi::HandoffTool]
    def initialize(id:, org_id:, created_at:, updated_at:, messages: OMIT, destinations: OMIT, rejection_plan: OMIT,
                   function: OMIT, additional_properties: nil)
    ...
    # Deserialize a JSON object to an instance of HandoffTool
    #
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::HandoffToolMessagesItem.from_json(json_object: item)
      end
      destinations = parsed_json["destinations"]&.map do |item|
        item = item.to_json
        Vapi::HandoffToolDestinationsItem.from_json(json_object: item)
      end
      id = parsed_json["id"]
    ...
    # Serialize an instance of HandoffTool to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
