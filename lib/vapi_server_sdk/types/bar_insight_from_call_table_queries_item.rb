...
module Vapi
  class BarInsightFromCallTableQueriesItem
    # Deserialize a JSON object to an instance of BarInsightFromCallTableQueriesItem
    #
    # @param json_object [String]
    # @return [Vapi::BarInsightFromCallTableQueriesItem]
