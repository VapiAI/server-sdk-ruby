...
#  To test the assistant over phone number, send phoneNumberId instead.
    ...
    def initialize(phone_number_id: OMIT, phone_number: OMIT, assistant_id: OMIT, assistant_overrides: OMIT, additional_properties: nil)
      ...
      @_field_set = { "phoneNumberId": phone_number_id, "phoneNumber": phone_number, "assistantId": assistant_id, "assistantOverrides": assistant_overrides }.reject do | _k, v |
  v == OMIT
end
    end
