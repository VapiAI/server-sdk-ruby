...
module Vapi
  class UpdateSlackOAuth2AuthorizationCredentialDto
    ...
    # @return [Vapi::UpdateSlackOAuth2AuthorizationCredentialDto]
    ...
    # Serialize an instance of UpdateSlackOAuth2AuthorizationCredentialDto to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
