...
#  template variables.
    ...
    def initialize(assistant_id: OMIT, assistant: OMIT, assistant_overrides: OMIT, squad_id: OMIT, squad: OMIT, workflow_id: OMIT, workflow: OMIT, workflow_overrides: OMIT, additional_properties: nil)
      ...
      @_field_set = { "assistantId": assistant_id, "assistant": assistant, "assistantOverrides": assistant_overrides, "squadId": squad_id, "squad": squad, "workflowId": workflow_id, "workflow": workflow, "workflowOverrides": workflow_overrides }.reject do | _k, v |
  v == OMIT
end
    end
