...
#  Omitting parameters defines a function with an empty parameter list.
    ...
    def initialize(strict: OMIT, name:, description: OMIT, parameters: OMIT, additional_properties: nil)
      @strict = strict if strict != OMIT
      @name = name
      @description = description if description != OMIT
      @parameters = parameters if parameters != OMIT
      @additional_properties = additional_properties
      @_field_set = { "strict": strict, "name": name, "description": description, "parameters": parameters }.reject do | _k, v |
  v == OMIT
end
    end
