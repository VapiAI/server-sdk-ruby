...
#  that have an authentication plan.
    ...
    def initialize(provider:, authentication_plan:, id:, org_id:, created_at:, updated_at:, authentication_session:, name: OMIT, additional_properties: nil)
      @provider = provider
      ...
      @_field_set = { "provider": provider, "authenticationPlan": authentication_plan, "id": id, "orgId": org_id, "createdAt": created_at, "updatedAt": updated_at, "authenticationSession": authentication_session, "name": name }.reject do | _k, v |
  v == OMIT
end
    end
