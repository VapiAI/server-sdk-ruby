...
require_relative "update_test_suite_test_voice_dto_type"
require "ostruct"
require "json"
...
module Vapi
  class UpdateTestSuiteTestVoiceDto
    ...
    attr_reader :scorers
    # @return [Vapi::UpdateTestSuiteTestVoiceDtoType] This is the type of the test, which must be voice.
    attr_reader :type
    ...
    # @param type [Vapi::UpdateTestSuiteTestVoiceDtoType] This is the type of the test, which must be voice.
    ...
    def initialize(scorers: OMIT, type: OMIT, name: OMIT, script: OMIT, num_attempts: OMIT, additional_properties: nil)
    ...
    def self.validate_raw(obj:)
      ...
      obj.type&.is_a?(Vapi::UpdateTestSuiteTestVoiceDtoType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
