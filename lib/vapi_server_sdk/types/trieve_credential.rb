...
require_relative "trieve_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class TrieveCredential
    # @return [Vapi::TrieveCredentialProvider]
    ...
    # @param provider [Vapi::TrieveCredentialProvider]
    ...
    # Deserialize a JSON object to an instance of TrieveCredential
    #
    ...
    # Serialize an instance of TrieveCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::TrieveCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
