...
#  50) include quieter speech.
    ...
    def initialize(enabled: OMIT, media_detection_enabled: OMIT, static_threshold: OMIT, baseline_offset_db: OMIT, window_size_ms: OMIT, baseline_percentile: OMIT, additional_properties: nil)
      ...
      @_field_set = { "enabled": enabled, "mediaDetectionEnabled": media_detection_enabled, "staticThreshold": static_threshold, "baselineOffsetDb": baseline_offset_db, "windowSizeMs": window_size_ms, "baselinePercentile": baseline_percentile }.reject do | _k, v |
  v == OMIT
end
    end
