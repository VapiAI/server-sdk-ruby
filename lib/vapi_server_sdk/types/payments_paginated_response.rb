...
module Vapi
  class PaymentsPaginatedResponse
    ...
    # @param results [Array<Vapi::Payment>]
    # @param metadata [Vapi::PaginationMeta]
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vapi::PaymentsPaginatedResponse]
    ...
    # Deserialize a JSON object to an instance of PaymentsPaginatedResponse
    #
    ...
    def self.from_json(json_object:)
      ...
      results = parsed_json["results"]&.map do |item|
        item = item.to_json
        Vapi::Payment.from_json(json_object: item)
      end
    ...
    # Serialize an instance of PaymentsPaginatedResponse to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
