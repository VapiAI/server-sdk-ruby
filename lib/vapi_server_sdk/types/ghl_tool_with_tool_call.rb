...
#  `messages[].conditions` matches the "reason" argument.
    ...
    def initialize(messages: OMIT, tool_call:, metadata:, function: OMIT, additional_properties: nil)
      @messages = messages if messages != OMIT
      @tool_call = tool_call
      @metadata = metadata
      @function = function if function != OMIT
      @additional_properties = additional_properties
      @_field_set = { "messages": messages, "toolCall": tool_call, "metadata": metadata, "function": function }.reject do | _k, v |
  v == OMIT
end
    end
