...
#  3. a response generated by the model, if neither exist
    ...
    def initialize(message: OMIT, name:, tool_call_id:, result: OMIT, error: OMIT, metadata: OMIT, additional_properties: nil)
      ...
      @_field_set = { "message": message, "name": name, "toolCallId": tool_call_id, "result": result, "error": error, "metadata": metadata }.reject do | _k, v |
  v == OMIT
end
    end
