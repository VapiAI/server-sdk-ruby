...
# This is the phone number that the message is associated with.
  class ServerMessageVoiceRequestPhoneNumber
  # @return [Object] 
    attr_reader :member
  # @return [String] 
    ...
    # @return [Vapi::ServerMessageVoiceRequestPhoneNumber]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end
# Deserialize a JSON object to an instance of ServerMessageVoiceRequestPhoneNumber
    #
