...
module Vapi
  class UpdateWorkflowBlockDtoStepsItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::UpdateWorkflowBlockDtoStepsItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of UpdateWorkflowBlockDtoStepsItem
    #
