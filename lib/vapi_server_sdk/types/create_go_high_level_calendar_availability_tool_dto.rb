...
require_relative "create_go_high_level_calendar_availability_tool_dto_messages_item"
require_relative "tool_rejection_plan"
require "ostruct"
require "json"

module Vapi
  class CreateGoHighLevelCalendarAvailabilityToolDto
    # @return [Array<Vapi::CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    ...
    # @param messages [Array<Vapi::CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    ...
    # @return [Vapi::CreateGoHighLevelCalendarAvailabilityToolDto]
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of CreateGoHighLevelCalendarAvailabilityToolDto to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
