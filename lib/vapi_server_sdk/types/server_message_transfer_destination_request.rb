...
require_relative "server_message_transfer_destination_request_phone_number"
require_relative "server_message_transfer_destination_request_type"
...
module Vapi
  class ServerMessageTransferDestinationRequest
    # @return [Vapi::ServerMessageTransferDestinationRequestPhoneNumber] This is the phone number that the message is associated with.
    attr_reader :phone_number
    # @return [Vapi::ServerMessageTransferDestinationRequestType] This is the type of the message. "transfer-destination-request" is sent when the
    ...
    # @param phone_number [Vapi::ServerMessageTransferDestinationRequestPhoneNumber] This is the phone number that the message is associated with.
    # @param type [Vapi::ServerMessageTransferDestinationRequestType] This is the type of the message. "transfer-destination-request" is sent when the
    #  model is requesting transfer but destination is unknown.
    ...
    # Serialize an instance of ServerMessageTransferDestinationRequest to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::ServerMessageTransferDestinationRequestType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
