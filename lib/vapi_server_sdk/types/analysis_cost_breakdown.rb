...
#  successful.
    ...
    def initialize(summary: OMIT, summary_prompt_tokens: OMIT, summary_completion_tokens: OMIT, structured_data: OMIT, structured_data_prompt_tokens: OMIT, structured_data_completion_tokens: OMIT, success_evaluation: OMIT, success_evaluation_prompt_tokens: OMIT, success_evaluation_completion_tokens: OMIT, additional_properties: nil)
      ...
      @structured_data_completion_tokens = structured_data_completion_tokens if structured_data_completion_tokens != OMIT
      ...
      @success_evaluation_completion_tokens = success_evaluation_completion_tokens if success_evaluation_completion_tokens != OMIT
      @additional_properties = additional_properties
      @_field_set = { "summary": summary, "summaryPromptTokens": summary_prompt_tokens, "summaryCompletionTokens": summary_completion_tokens, "structuredData": structured_data, "structuredDataPromptTokens": structured_data_prompt_tokens, "structuredDataCompletionTokens": structured_data_completion_tokens, "successEvaluation": success_evaluation, "successEvaluationPromptTokens": success_evaluation_prompt_tokens, "successEvaluationCompletionTokens": success_evaluation_completion_tokens }.reject do | _k, v |
  v == OMIT
end
    end
