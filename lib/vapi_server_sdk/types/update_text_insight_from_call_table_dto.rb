...
require_relative "update_text_insight_from_call_table_dto_queries_item"
require "ostruct"
require "json"

module Vapi
  class UpdateTextInsightFromCallTableDto
    ...
    # @return [Array<Vapi::UpdateTextInsightFromCallTableDtoQueriesItem>] These are the queries to run to generate the insight.
    ...
    # @param queries [Array<Vapi::UpdateTextInsightFromCallTableDtoQueriesItem>] These are the queries to run to generate the insight.
    #  For Text Insights, we only allow a single query, or require a formula if
    #  multiple queries are provided
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vapi::UpdateTextInsightFromCallTableDto]
    def initialize(name: OMIT, formula: OMIT, time_range: OMIT, queries: OMIT, additional_properties: nil)
    ...
    # Deserialize a JSON object to an instance of UpdateTextInsightFromCallTableDto
    #
    ...
    def self.from_json(json_object:)
      ...
      queries = parsed_json["queries"]&.map do |item|
        item = item.to_json
        Vapi::UpdateTextInsightFromCallTableDtoQueriesItem.from_json(json_object: item)
      end
      new(
        name: name,
        formula: formula,
    ...
    # Serialize an instance of UpdateTextInsightFromCallTableDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
