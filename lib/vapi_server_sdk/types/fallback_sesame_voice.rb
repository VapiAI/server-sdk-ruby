...
module Vapi
  class FallbackSesameVoice
    ...
    def initialize(provider:, voice_id:, model:, caching_enabled: OMIT, chunk_plan: OMIT, additional_properties: nil)
    ...
    # Deserialize a JSON object to an instance of FallbackSesameVoice
    #
    ...
    # Serialize an instance of FallbackSesameVoice to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
