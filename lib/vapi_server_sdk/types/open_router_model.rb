...
require_relative "open_router_model_tools_item"
...
module Vapi
  class OpenRouterModel
    ...
    # @return [Array<Vapi::OpenRouterModelToolsItem>] These are the tools that the assistant can use during the call. To use existing
    #  tools, use `toolIds`.
    ...
    # @param tools [Array<Vapi::OpenRouterModelToolsItem>] These are the tools that the assistant can use during the call. To use existing
    #  tools, use `toolIds`.
    #  Both `tools` and `toolIds` can be used together.
    ...
    # Deserialize a JSON object to an instance of OpenRouterModel
    #
    ...
    def self.from_json(json_object:)
      ...
      tools = parsed_json["tools"]&.map do |item|
        item = item.to_json
        Vapi::OpenRouterModelToolsItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of OpenRouterModel to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
