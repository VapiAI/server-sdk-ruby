...
require_relative "open_ai_transcriber_model"
require_relative "open_ai_transcriber_language"
...
module Vapi
  class OpenAiTranscriber
    # @return [Vapi::OpenAiTranscriberModel] This is the model that will be used for the transcription.
    attr_reader :model
    # @return [Vapi::OpenAiTranscriberLanguage] This is the language that will be set for the transcription.
    ...
    # @param model [Vapi::OpenAiTranscriberModel] This is the model that will be used for the transcription.
    # @param language [Vapi::OpenAiTranscriberLanguage] This is the language that will be set for the transcription.
