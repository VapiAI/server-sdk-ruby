...
module Vapi
  ...
  # @return [Object] 
    ...
    # @param results [Array<Vapi::Assistant>] 
    # @param metadata [Vapi::PaginationMeta] 
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vapi::AssistantPaginatedResponse]
...
# Deserialize a JSON object to an instance of AssistantPaginatedResponse
    #
...
# Serialize an instance of AssistantPaginatedResponse to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
