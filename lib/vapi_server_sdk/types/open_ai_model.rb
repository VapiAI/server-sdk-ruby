...
#  @default 0
    ...
    def initialize(messages: OMIT, tools: OMIT, tool_ids: OMIT, knowledge_base: OMIT, knowledge_base_id: OMIT, model:, fallback_models: OMIT, tool_strict_compatibility_mode: OMIT, temperature: OMIT, max_tokens: OMIT, emotion_recognition_enabled: OMIT, num_fast_turns: OMIT, additional_properties: nil)
      ...
      @_field_set = { "messages": messages, "tools": tools, "toolIds": tool_ids, "knowledgeBase": knowledge_base, "knowledgeBaseId": knowledge_base_id, "model": model, "fallbackModels": fallback_models, "toolStrictCompatibilityMode": tool_strict_compatibility_mode, "temperature": temperature, "maxTokens": max_tokens, "emotionRecognitionEnabled": emotion_recognition_enabled, "numFastTurns": num_fast_turns }.reject do | _k, v |
  v == OMIT
end
    end
