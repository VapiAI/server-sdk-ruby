...
#  how to transfer the call.
    ...
    def initialize(message: OMIT, sip_uri:, transfer_plan: OMIT, sip_headers: OMIT, description: OMIT, additional_properties: nil)
      ...
      @_field_set = { "message": message, "sipUri": sip_uri, "transferPlan": transfer_plan, "sipHeaders": sip_headers, "description": description }.reject do | _k, v |
  v == OMIT
end
    end
