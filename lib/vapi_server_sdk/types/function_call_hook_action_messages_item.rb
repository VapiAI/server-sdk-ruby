...
module Vapi
  class FunctionCallHookActionMessagesItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::FunctionCallHookActionMessagesItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of FunctionCallHookActionMessagesItem
    #
