...
#  The schema is identical to the JSON that GCP outputs.
    ...
    def initialize(fallback_index: OMIT, name: OMIT, gcp_key: OMIT, region: OMIT, bucket_plan: OMIT, additional_properties: nil)
      ...
      @_field_set = { "fallbackIndex": fallback_index, "name": name, "gcpKey": gcp_key, "region": region, "bucketPlan": bucket_plan }.reject do | _k, v |
  v == OMIT
end
    end
