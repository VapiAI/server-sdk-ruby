...
require_relative "provider_resource"
require_relative "pagination_meta"
require "ostruct"
require "json"

module Vapi
  class ProviderResourcePaginatedResponse
    # @return [Array<Vapi::ProviderResource>]
    attr_reader :results
    ...
    # @param results [Array<Vapi::ProviderResource>]
    ...
    # Deserialize a JSON object to an instance of ProviderResourcePaginatedResponse
    #
    ...
    def self.from_json(json_object:)
      ...
      results = parsed_json["results"]&.map do |item|
        item = item.to_json
        Vapi::ProviderResource.from_json(json_object: item)
      end
    ...
    # Serialize an instance of ProviderResourcePaginatedResponse to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
