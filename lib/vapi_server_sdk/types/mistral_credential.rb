...
require_relative "mistral_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class MistralCredential
    # @return [Vapi::MistralCredentialProvider]
    ...
    # @param provider [Vapi::MistralCredentialProvider]
    ...
    # Deserialize a JSON object to an instance of MistralCredential
    #
    ...
    # Serialize an instance of MistralCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::MistralCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
