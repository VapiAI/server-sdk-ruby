...
require_relative "assembly_ai_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class AssemblyAiCredential
    # @return [Vapi::AssemblyAiCredentialProvider]
    ...
    # @param provider [Vapi::AssemblyAiCredentialProvider]
    ...
    # Deserialize a JSON object to an instance of AssemblyAiCredential
    #
    ...
    # Serialize an instance of AssemblyAiCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::AssemblyAiCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
