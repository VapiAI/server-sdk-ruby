...
#  @default 0
    ...
    def initialize(messages: OMIT, tools: OMIT, tool_ids: OMIT, knowledge_base: OMIT, knowledge_base_id: OMIT, provider:, workflow_id: OMIT, workflow: OMIT, model:, temperature: OMIT, max_tokens: OMIT, emotion_recognition_enabled: OMIT, num_fast_turns: OMIT, additional_properties: nil)
      ...
      @_field_set = { "messages": messages, "tools": tools, "toolIds": tool_ids, "knowledgeBase": knowledge_base, "knowledgeBaseId": knowledge_base_id, "provider": provider, "workflowId": workflow_id, "workflow": workflow, "model": model, "temperature": temperature, "maxTokens": max_tokens, "emotionRecognitionEnabled": emotion_recognition_enabled, "numFastTurns": num_fast_turns }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of VapiModel
  ...
  Vapi::VapiModelToolsItem.from_json(json_object: item)
      ...
      unless parsed_json["workflow"].nil?
