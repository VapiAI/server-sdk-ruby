...
module Vapi
  class CreateGoogleSheetsOAuth2AuthorizationCredentialDto
  ...
  # @return [Object] 
    ...
    # @return [Vapi::CreateGoogleSheetsOAuth2AuthorizationCredentialDto]
...
# Serialize an instance of CreateGoogleSheetsOAuth2AuthorizationCredentialDto to a
#  JSON object
    #
    # @return [String]
    def to_json
