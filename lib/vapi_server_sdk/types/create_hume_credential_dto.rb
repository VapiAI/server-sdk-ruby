...
module Vapi
  class CreateHumeCredentialDto
    ...
    # @return [Vapi::CreateHumeCredentialDto]
    ...
    # Deserialize a JSON object to an instance of CreateHumeCredentialDto
    #
    ...
    # Serialize an instance of CreateHumeCredentialDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
