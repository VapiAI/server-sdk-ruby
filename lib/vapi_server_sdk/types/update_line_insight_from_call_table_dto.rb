...
require_relative "update_line_insight_from_call_table_dto_group_by"
require_relative "update_line_insight_from_call_table_dto_queries_item"
require "ostruct"
require "json"

module Vapi
  class UpdateLineInsightFromCallTableDto
    ...
    # @return [Vapi::UpdateLineInsightFromCallTableDtoGroupBy] This is the group by column for the insight when table is `call`.
    #  These are the columns to group the results by.
    #  All results are grouped by the time range step by default.
    attr_reader :group_by
    # @return [Array<Vapi::UpdateLineInsightFromCallTableDtoQueriesItem>] These are the queries to run to generate the insight.
    attr_reader :queries
    ...
    # @param group_by [Vapi::UpdateLineInsightFromCallTableDtoGroupBy] This is the group by column for the insight when table is `call`.
    #  These are the columns to group the results by.
    #  All results are grouped by the time range step by default.
    # @param queries [Array<Vapi::UpdateLineInsightFromCallTableDtoQueriesItem>] These are the queries to run to generate the insight.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vapi::UpdateLineInsightFromCallTableDto]
    def initialize(name: OMIT, formulas: OMIT, metadata: OMIT, time_range: OMIT, group_by: OMIT, queries: OMIT,
    ...
    # Deserialize a JSON object to an instance of UpdateLineInsightFromCallTableDto
    #
    ...
    def self.from_json(json_object:)
      ...
      queries = parsed_json["queries"]&.map do |item|
        item = item.to_json
        Vapi::UpdateLineInsightFromCallTableDtoQueriesItem.from_json(json_object: item)
      end
      new(
        name: name,
        formulas: formulas,
    ...
    # Serialize an instance of UpdateLineInsightFromCallTableDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.group_by&.is_a?(Vapi::UpdateLineInsightFromCallTableDtoGroupBy) != false || raise("Passed value for field obj.group_by is not the expected type, validation failed.")
