...
module Vapi
  class LineInsightMetadata
    ...
    # @return [Vapi::LineInsightMetadata]
    ...
    # Deserialize a JSON object to an instance of LineInsightMetadata
    #
    ...
    # Serialize an instance of LineInsightMetadata to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
