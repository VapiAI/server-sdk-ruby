...
#  https://developers.inflection.ai/keys, billing will need to be setup
    ...
    # @return [Vapi::InflectionAiCredential]
...
# Deserialize a JSON object to an instance of InflectionAiCredential
    #
...
# Serialize an instance of InflectionAiCredential to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
