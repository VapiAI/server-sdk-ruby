...
module Vapi
  ...
  # @return [Object] 
    ...
    def initialize(region:, models:, open_ai_key:, ocp_apim_subscription_key: OMIT, open_ai_endpoint:, name: OMIT, additional_properties: nil)
      @region = region
      @models = models
      ...
      @_field_set = { "region": region, "models": models, "openAIKey": open_ai_key, "ocpApimSubscriptionKey": ocp_apim_subscription_key, "openAIEndpoint": open_ai_endpoint, "name": name }.reject do | _k, v |
  v == OMIT
end
    end
