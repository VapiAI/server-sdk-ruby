...
#  `messages[].conditions` matches the "reason" argument.
    ...
    def initialize(messages: OMIT, sub_type:, server: OMIT, id:, org_id:, created_at:, updated_at:, function: OMIT, name:, additional_properties: nil)
      ...
      @_field_set = { "messages": messages, "subType": sub_type, "server": server, "id": id, "orgId": org_id, "createdAt": created_at, "updatedAt": updated_at, "function": function, "name": name }.reject do | _k, v |
  v == OMIT
end
    end
