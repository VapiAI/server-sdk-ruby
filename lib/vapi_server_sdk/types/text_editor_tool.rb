...
require_relative "text_editor_tool_messages_item"
require_relative "text_editor_tool_sub_type"
require_relative "server"
require "date"
require_relative "tool_rejection_plan"
require_relative "text_editor_tool_name"
require "ostruct"
require "json"

module Vapi
  class TextEditorTool
    # @return [Array<Vapi::TextEditorToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    attr_reader :messages
    # @return [Vapi::TextEditorToolSubType] The sub type of tool.
    ...
    # @return [Vapi::TextEditorToolName] The name of the tool, fixed to 'str_replace_editor'
    attr_reader :name
    ...
    # @param messages [Array<Vapi::TextEditorToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param sub_type [Vapi::TextEditorToolSubType] The sub type of tool.
    ...
    #  }
    #  ```
    # @param name [Vapi::TextEditorToolName] The name of the tool, fixed to 'str_replace_editor'
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vapi::TextEditorTool]
    def initialize(sub_type:, id:, org_id:, created_at:, updated_at:, name:, messages: OMIT, server: OMIT,
                   rejection_plan: OMIT, additional_properties: nil)
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::TextEditorToolMessagesItem.from_json(json_object: item)
      end
    ...
    def self.validate_raw(obj:)
      ...
      obj.sub_type.is_a?(Vapi::TextEditorToolSubType) != false || raise("Passed value for field obj.sub_type is not the expected type, validation failed.")
      ...
      obj.name.is_a?(Vapi::TextEditorToolName) != false || raise("Passed value for field obj.name is not the expected type, validation failed.")
    end
  end
end
