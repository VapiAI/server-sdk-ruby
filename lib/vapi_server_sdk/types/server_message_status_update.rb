...
require_relative "server_message_status_update_type"
...
module Vapi
  class ServerMessageStatusUpdate
    ...
    # @return [Vapi::ServerMessageStatusUpdateType] This is the type of the message. "status-update" is sent whenever the
    #  `call.status` changes.
    attr_reader :type
    ...
    # @param type [Vapi::ServerMessageStatusUpdateType] This is the type of the message. "status-update" is sent whenever the
    #  `call.status` changes.
    ...
    def initialize(type:, status:, phone_number: OMIT, ended_reason: OMIT, messages: OMIT,
                   messages_open_ai_formatted: OMIT, destination: OMIT, timestamp: OMIT, artifact: OMIT, assistant: OMIT, customer: OMIT, call: OMIT, chat: OMIT, transcript: OMIT, summary: OMIT, inbound_phone_call_debugging_artifacts: OMIT, additional_properties: nil)
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::ServerMessageStatusUpdateType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
