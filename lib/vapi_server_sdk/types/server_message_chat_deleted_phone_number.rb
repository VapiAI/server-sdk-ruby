...
module Vapi
  ...
  class ServerMessageChatDeletedPhoneNumber
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::ServerMessageChatDeletedPhoneNumber]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of ServerMessageChatDeletedPhoneNumber
    #
