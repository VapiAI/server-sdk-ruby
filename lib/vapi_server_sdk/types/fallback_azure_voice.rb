...
#  provider.
    ...
    def initialize(caching_enabled: OMIT, voice_id:, speed: OMIT, chunk_plan: OMIT, one_of: OMIT, additional_properties: nil)
      ...
      @_field_set = { "cachingEnabled": caching_enabled, "voiceId": voice_id, "speed": speed, "chunkPlan": chunk_plan, "oneOf": one_of }.reject do | _k, v |
  v == OMIT
end
    end
