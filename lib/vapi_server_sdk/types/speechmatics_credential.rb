...
require_relative "speechmatics_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class SpeechmaticsCredential
    # @return [Vapi::SpeechmaticsCredentialProvider]
    ...
    # @param provider [Vapi::SpeechmaticsCredentialProvider]
    ...
    # @return [Vapi::SpeechmaticsCredential]
    ...
    # Deserialize a JSON object to an instance of SpeechmaticsCredential
    #
    ...
    # Serialize an instance of SpeechmaticsCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::SpeechmaticsCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
