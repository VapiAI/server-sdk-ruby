...
require_relative "assembly_ai_transcriber_language"
...
module Vapi
  class AssemblyAiTranscriber
    # @return [Vapi::AssemblyAiTranscriberLanguage] This is the language that will be set for the transcription.
    ...
    # @param language [Vapi::AssemblyAiTranscriberLanguage] This is the language that will be set for the transcription.
    ...
    def initialize(language: OMIT, confidence_threshold: OMIT, format_turns: OMIT,
                   end_of_turn_confidence_threshold: OMIT, min_end_of_turn_silence_when_confident: OMIT, word_finalization_max_wait_time: OMIT, max_turn_silence: OMIT, realtime_url: OMIT, word_boost: OMIT, keyterms_prompt: OMIT, end_utterance_silence_threshold: OMIT, disable_partial_transcripts: OMIT, fallback_plan: OMIT, additional_properties: nil)
    ...
    def self.validate_raw(obj:)
      obj.language&.is_a?(Vapi::AssemblyAiTranscriberLanguage) != false || raise("Passed value for field obj.language is not the expected type, validation failed.")
