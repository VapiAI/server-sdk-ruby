...
module Vapi
  class WorkflowOpenAiModel
    # @return [Vapi::WorkflowOpenAiModelModel] This is the specific OpenAI model that will be used.
    attr_reader :model
    ...
    # @param model [Vapi::WorkflowOpenAiModelModel] This is the specific OpenAI model that will be used.
