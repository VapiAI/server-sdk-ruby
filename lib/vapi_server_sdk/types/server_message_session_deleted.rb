...
require_relative "server_message_session_deleted_phone_number"
require_relative "server_message_session_deleted_type"
...
module Vapi
  class ServerMessageSessionDeleted
    # @return [Vapi::ServerMessageSessionDeletedPhoneNumber] This is the phone number that the message is associated with.
    attr_reader :phone_number
    # @return [Vapi::ServerMessageSessionDeletedType] This is the type of the message. "session.deleted" is sent when a session is
    #  deleted.
    attr_reader :type
    ...
    # @param phone_number [Vapi::ServerMessageSessionDeletedPhoneNumber] This is the phone number that the message is associated with.
    # @param type [Vapi::ServerMessageSessionDeletedType] This is the type of the message. "session.deleted" is sent when a session is
    #  deleted.
    ...
    # @return [Vapi::ServerMessageSessionDeleted]
    ...
    # Deserialize a JSON object to an instance of ServerMessageSessionDeleted
    #
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["phoneNumber"].nil?
        ...
        phone_number = Vapi::ServerMessageSessionDeletedPhoneNumber.from_json(json_object: phone_number)
      end
    ...
    # Serialize an instance of ServerMessageSessionDeleted to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.phone_number.nil? || Vapi::ServerMessageSessionDeletedPhoneNumber.validate_raw(obj: obj.phone_number)
      obj.type.is_a?(Vapi::ServerMessageSessionDeletedType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
