...
module Vapi
  class LineInsightFromCallTableQueriesItem
    # Deserialize a JSON object to an instance of LineInsightFromCallTableQueriesItem
    #
    # @param json_object [String]
    # @return [Vapi::LineInsightFromCallTableQueriesItem]
