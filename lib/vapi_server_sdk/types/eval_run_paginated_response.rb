...
module Vapi
  class EvalRunPaginatedResponse
    # @return [Array<Vapi::EvalRun>]
    attr_reader :results
    ...
    # @param results [Array<Vapi::EvalRun>]
    ...
    # Deserialize a JSON object to an instance of EvalRunPaginatedResponse
    #
    ...
    def self.from_json(json_object:)
      ...
      results = parsed_json["results"]&.map do |item|
        item = item.to_json
        Vapi::EvalRun.from_json(json_object: item)
      end
    ...
    # Serialize an instance of EvalRunPaginatedResponse to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
