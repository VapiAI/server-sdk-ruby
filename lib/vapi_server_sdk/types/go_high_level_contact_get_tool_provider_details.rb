...
module Vapi
  class GoHighLevelContactGetToolProviderDetails
    ...
    # @return [Vapi::GoHighLevelContactGetToolProviderDetails]
    ...
    # Serialize an instance of GoHighLevelContactGetToolProviderDetails to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
