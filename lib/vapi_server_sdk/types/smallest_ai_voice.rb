...
require_relative "smallest_ai_voice_model"
...
module Vapi
  class SmallestAiVoice
    ...
    # @return [Vapi::SmallestAiVoiceModel] Smallest AI voice model to use. Defaults to 'lightning' when not specified.
    attr_reader :model
    ...
    # @param model [Vapi::SmallestAiVoiceModel] Smallest AI voice model to use. Defaults to 'lightning' when not specified.
    ...
    def initialize(voice_id:, caching_enabled: OMIT, model: OMIT, speed: OMIT, chunk_plan: OMIT, fallback_plan: OMIT,
    ...
    def self.validate_raw(obj:)
      ...
      obj.model&.is_a?(Vapi::SmallestAiVoiceModel) != false || raise("Passed value for field obj.model is not the expected type, validation failed.")
