...
module Vapi
  class ImportTwilioPhoneNumberDtoHooksItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::ImportTwilioPhoneNumberDtoHooksItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of ImportTwilioPhoneNumberDtoHooksItem
    #
