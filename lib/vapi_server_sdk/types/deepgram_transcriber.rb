...
module Vapi
  class DeepgramTranscriber
    ...
    def initialize(model: OMIT, language: OMIT, smart_format: OMIT, mip_opt_out: OMIT, numerals: OMIT,
                   confidence_threshold: OMIT, eager_eot_threshold: OMIT, eot_threshold: OMIT, eot_timeout_ms: OMIT, keywords: OMIT, keyterm: OMIT, endpointing: OMIT, fallback_plan: OMIT, additional_properties: nil)
