...
#  voice provider fails.
    ...
    def initialize(model: OMIT, language: OMIT, smart_format: OMIT, code_switching_enabled: OMIT, mip_opt_out: OMIT, numerals: OMIT, confidence_threshold: OMIT, keywords: OMIT, keyterm: OMIT, endpointing: OMIT, fallback_plan: OMIT, additional_properties: nil)
      ...
      @_field_set = { "model": model, "language": language, "smartFormat": smart_format, "codeSwitchingEnabled": code_switching_enabled, "mipOptOut": mip_opt_out, "numerals": numerals, "confidenceThreshold": confidence_threshold, "keywords": keywords, "keyterm": keyterm, "endpointing": endpointing, "fallbackPlan": fallback_plan }.reject do | _k, v |
  v == OMIT
end
    end
