...
module Vapi
  class CreateVapiPhoneNumberDtoHooksItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::CreateVapiPhoneNumberDtoHooksItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of CreateVapiPhoneNumberDtoHooksItem
    #
