...
require_relative "update_go_high_level_contact_create_tool_dto_messages_item"
require_relative "tool_rejection_plan"
require "ostruct"
require "json"

module Vapi
  class UpdateGoHighLevelContactCreateToolDto
    # @return [Array<Vapi::UpdateGoHighLevelContactCreateToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    ...
    # @param messages [Array<Vapi::UpdateGoHighLevelContactCreateToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    ...
    # @return [Vapi::UpdateGoHighLevelContactCreateToolDto]
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::UpdateGoHighLevelContactCreateToolDtoMessagesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of UpdateGoHighLevelContactCreateToolDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
