...
module Vapi
  class UpdateNeuphonicCredentialDto
    ...
    # @return [Vapi::UpdateNeuphonicCredentialDto]
    ...
    # Deserialize a JSON object to an instance of UpdateNeuphonicCredentialDto
    #
    ...
    # Serialize an instance of UpdateNeuphonicCredentialDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
