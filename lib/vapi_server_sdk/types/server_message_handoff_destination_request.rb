...
require_relative "server_message_handoff_destination_request_phone_number"
require_relative "server_message_handoff_destination_request_type"
...
module Vapi
  class ServerMessageHandoffDestinationRequest
    # @return [Vapi::ServerMessageHandoffDestinationRequestPhoneNumber] This is the phone number that the message is associated with.
    attr_reader :phone_number
    # @return [Vapi::ServerMessageHandoffDestinationRequestType] This is the type of the message. "handoff-destination-request" is sent when the
    #  model is requesting handoff but destination is unknown.
    attr_reader :type
    ...
    attr_reader :chat
    # @return [Hash{String => Object}] This is the parameters of the handoff destination request.
    ...
    # @param phone_number [Vapi::ServerMessageHandoffDestinationRequestPhoneNumber] This is the phone number that the message is associated with.
    # @param type [Vapi::ServerMessageHandoffDestinationRequestType] This is the type of the message. "handoff-destination-request" is sent when the
    #  model is requesting handoff but destination is unknown.
    ...
    # @param parameters [Hash{String => Object}] This is the parameters of the handoff destination request.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vapi::ServerMessageHandoffDestinationRequest]
    def initialize(type:, parameters:, phone_number: OMIT, timestamp: OMIT, artifact: OMIT, assistant: OMIT, customer: OMIT,
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["phoneNumber"].nil?
        ...
        phone_number = Vapi::ServerMessageHandoffDestinationRequestPhoneNumber.from_json(json_object: phone_number)
      end
    ...
    # Serialize an instance of ServerMessageHandoffDestinationRequest to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.phone_number.nil? || Vapi::ServerMessageHandoffDestinationRequestPhoneNumber.validate_raw(obj: obj.phone_number)
      obj.type.is_a?(Vapi::ServerMessageHandoffDestinationRequestType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
