...
require_relative "get_eval_paginated_dto_sort_order"
require "date"
require "ostruct"
require "json"

module Vapi
  class GetEvalPaginatedDto
    # @return [String]
    attr_reader :id
    # @return [Float] This is the page number to return. Defaults to 1.
    attr_reader :page
    # @return [Vapi::GetEvalPaginatedDtoSortOrder] This is the sort order for pagination. Defaults to 'DESC'.
    ...
    # @param sort_order [Vapi::GetEvalPaginatedDtoSortOrder] This is the sort order for pagination. Defaults to 'DESC'.
    ...
    # @return [Vapi::GetEvalPaginatedDto]
    ...
    # Deserialize a JSON object to an instance of GetEvalPaginatedDto
    #
    ...
    # Serialize an instance of GetEvalPaginatedDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.sort_order&.is_a?(Vapi::GetEvalPaginatedDtoSortOrder) != false || raise("Passed value for field obj.sort_order is not the expected type, validation failed.")
