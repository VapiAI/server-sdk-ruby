...
#  Lower numbers are tried first in increasing order.
    ...
    def initialize(provider:, account_id: OMIT, api_key: OMIT, account_email: OMIT, fallback_index: OMIT, id:, org_id:, created_at:, updated_at:, name: OMIT, bucket_plan: OMIT, additional_properties: nil)
      @provider = provider
      ...
      @_field_set = { "provider": provider, "accountId": account_id, "apiKey": api_key, "accountEmail": account_email, "fallbackIndex": fallback_index, "id": id, "orgId": org_id, "createdAt": created_at, "updatedAt": updated_at, "name": name, "bucketPlan": bucket_plan }.reject do | _k, v |
  v == OMIT
end
    end
