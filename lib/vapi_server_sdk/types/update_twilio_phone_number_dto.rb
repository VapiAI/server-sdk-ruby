...
#  3. org.server
    ...
    def initialize(fallback_destination: OMIT, hooks: OMIT, sms_enabled: OMIT, name: OMIT, assistant_id: OMIT, workflow_id: OMIT, squad_id: OMIT, server: OMIT, number: OMIT, twilio_account_sid: OMIT, twilio_auth_token: OMIT, twilio_api_key: OMIT, twilio_api_secret: OMIT, additional_properties: nil)
      ...
      @_field_set = { "fallbackDestination": fallback_destination, "hooks": hooks, "smsEnabled": sms_enabled, "name": name, "assistantId": assistant_id, "workflowId": workflow_id, "squadId": squad_id, "server": server, "number": number, "twilioAccountSid": twilio_account_sid, "twilioAuthToken": twilio_auth_token, "twilioApiKey": twilio_api_key, "twilioApiSecret": twilio_api_secret }.reject do | _k, v |
  v == OMIT
end
    end
