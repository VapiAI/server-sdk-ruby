...
require_relative "go_high_level_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class GoHighLevelCredential
    # @return [Vapi::GoHighLevelCredentialProvider]
    ...
    # @param provider [Vapi::GoHighLevelCredentialProvider]
    ...
    # @return [Vapi::GoHighLevelCredential]
    ...
    # Deserialize a JSON object to an instance of GoHighLevelCredential
    #
    ...
    # Serialize an instance of GoHighLevelCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::GoHighLevelCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
