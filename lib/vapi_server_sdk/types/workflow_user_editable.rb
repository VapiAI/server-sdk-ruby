...
require_relative "workflow_user_editable_hooks_item"
require_relative "workflow_user_editable_credentials_item"
require_relative "workflow_user_editable_voicemail_detection"
...
module Vapi
  class WorkflowUserEditable
    ...
    attr_reader :nodes
    # @return [Vapi::WorkflowUserEditableModel] This is the model for the workflow.
    ...
    # @return [Array<Vapi::WorkflowUserEditableHooksItem>] This is a set of actions that will be performed on certain events.
    attr_reader :hooks
    ...
    # @return [Vapi::WorkflowUserEditableVoicemailDetection] This is the voicemail detection plan for the workflow.
    ...
    # @param model [Vapi::WorkflowUserEditableModel] This is the model for the workflow.
    #  This can be overridden at node level using `nodes[n].model`.
    ...
    #  and default for web calls is 'off'.
    #  You can also provide a custom sound by providing a URL to an audio file.
    # @param hooks [Array<Vapi::WorkflowUserEditableHooksItem>] This is a set of actions that will be performed on certain events.
    ...
    #  supplement an additional credentials using this. Dynamic credentials override
    #  existing credentials.
    # @param voicemail_detection [Vapi::WorkflowUserEditableVoicemailDetection] This is the voicemail detection plan for the workflow.
    ...
    def self.from_json(json_object:)
      ...
      hooks = parsed_json["hooks"]&.map do |item|
        item = item.to_json
        Vapi::WorkflowUserEditableHooksItem.from_json(json_object: item)
      end
      ...
      if parsed_json["voicemailDetection"].nil?
        ...
        voicemail_detection = Vapi::WorkflowUserEditableVoicemailDetection.from_json(json_object: voicemail_detection)
      end
    ...
    def self.validate_raw(obj:)
      ...
      obj.voicemail_detection.nil? || Vapi::WorkflowUserEditableVoicemailDetection.validate_raw(obj: obj.voicemail_detection)
