...
module Vapi
  class WorkflowUserEditable
    ...
    attr_reader :nodes
    # @return [Vapi::WorkflowUserEditableModel] These are the options for the workflow's LLM.
    attr_reader :model
    # @return [String]
    attr_reader :name
    ...
    # @param model [Vapi::WorkflowUserEditableModel] These are the options for the workflow's LLM.
    # @param name [String]
