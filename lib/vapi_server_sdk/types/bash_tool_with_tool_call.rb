...
require_relative "bash_tool_with_tool_call_sub_type"
require_relative "server"
require_relative "tool_call"
require_relative "bash_tool_with_tool_call_name"
...
module Vapi
  class BashToolWithToolCall
    ...
    # @return [Vapi::BashToolWithToolCallSubType] The sub type of tool.
    ...
    # @return [Vapi::BashToolWithToolCallName] The name of the tool, fixed to 'bash'
    attr_reader :name
    ...
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param sub_type [Vapi::BashToolWithToolCallSubType] The sub type of tool.
    ...
    # @param name [Vapi::BashToolWithToolCallName] The name of the tool, fixed to 'bash'
    ...
    def self.validate_raw(obj:)
      ...
      obj.sub_type.is_a?(Vapi::BashToolWithToolCallSubType) != false || raise("Passed value for field obj.sub_type is not the expected type, validation failed.")
      obj.server.nil? || Vapi::Server.validate_raw(obj: obj.server)
      Vapi::ToolCall.validate_raw(obj: obj.tool_call)
      obj.name.is_a?(Vapi::BashToolWithToolCallName) != false || raise("Passed value for field obj.name is not the expected type, validation failed.")
