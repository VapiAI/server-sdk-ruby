...
#  `messages[].conditions` matches the "reason" argument.
    ...
    def initialize(messages: OMIT, sub_type:, server: OMIT, tool_call:, name:, function: OMIT, additional_properties: nil)
      ...
      @_field_set = { "messages": messages, "subType": sub_type, "server": server, "toolCall": tool_call, "name": name, "function": function }.reject do | _k, v |
  v == OMIT
end
    end
