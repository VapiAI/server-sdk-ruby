...
module Vapi
  ...
  # @return [Object] 
    ...
    def initialize(details: OMIT, provider_details: OMIT, metadata: OMIT, visibility: OMIT, type:, name: OMIT, provider: OMIT, id:, org_id:, created_at:, updated_at:, additional_properties: nil)
      ...
      @_field_set = { "details": details, "providerDetails": provider_details, "metadata": metadata, "visibility": visibility, "type": type, "name": name, "provider": provider, "id": id, "orgId": org_id, "createdAt": created_at, "updatedAt": updated_at }.reject do | _k, v |
  v == OMIT
end
    end
