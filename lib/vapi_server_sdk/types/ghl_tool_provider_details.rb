...
module Vapi
  ...
  # @return [Object] 
    ...
    def initialize(template_url: OMIT, setup_instructions: OMIT, workflow_id: OMIT, workflow_name: OMIT, webhook_hook_id: OMIT, webhook_hook_name: OMIT, location_id: OMIT, additional_properties: nil)
      ...
      @_field_set = { "templateUrl": template_url, "setupInstructions": setup_instructions, "workflowId": workflow_id, "workflowName": workflow_name, "webhookHookId": webhook_hook_id, "webhookHookName": webhook_hook_name, "locationId": location_id }.reject do | _k, v |
  v == OMIT
end
    end
