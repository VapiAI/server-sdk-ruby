...
module Vapi
  class StructuredOutputPaginatedResponse
    # @return [Array<Vapi::StructuredOutput>]
    attr_reader :results
    ...
    # @param results [Array<Vapi::StructuredOutput>]
    ...
    # Deserialize a JSON object to an instance of StructuredOutputPaginatedResponse
    #
    ...
    def self.from_json(json_object:)
      ...
      results = parsed_json["results"]&.map do |item|
        item = item.to_json
        Vapi::StructuredOutput.from_json(json_object: item)
      end
    ...
    # Serialize an instance of StructuredOutputPaginatedResponse to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
