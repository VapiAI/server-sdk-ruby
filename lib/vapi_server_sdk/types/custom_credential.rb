...
require_relative "custom_credential_provider"
require_relative "custom_credential_authentication_plan"
require "date"
...
module Vapi
  class CustomCredential
    # @return [Vapi::CustomCredentialProvider]
    attr_reader :provider
    # @return [Vapi::CustomCredentialAuthenticationPlan] This is the authentication plan. Supports OAuth2 RFC 6749, HMAC signing, and
    ...
    # @param provider [Vapi::CustomCredentialProvider]
    # @param authentication_plan [Vapi::CustomCredentialAuthenticationPlan] This is the authentication plan. Supports OAuth2 RFC 6749, HMAC signing, and
    #  Bearer authentication.
    ...
    # Deserialize a JSON object to an instance of CustomCredential
    #
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["authenticationPlan"].nil?
        ...
        authentication_plan = Vapi::CustomCredentialAuthenticationPlan.from_json(json_object: authentication_plan)
      end
      id = parsed_json["id"]
    ...
    # Serialize an instance of CustomCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::CustomCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
      Vapi::CustomCredentialAuthenticationPlan.validate_raw(obj: obj.authentication_plan)
