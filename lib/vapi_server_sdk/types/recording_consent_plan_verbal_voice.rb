...
module Vapi
  ...
  class RecordingConsentPlanVerbalVoice
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::RecordingConsentPlanVerbalVoice]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of RecordingConsentPlanVerbalVoice
    #
