...
module Vapi
  class UpdateTelnyxPhoneNumberDtoHooksItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::UpdateTelnyxPhoneNumberDtoHooksItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of UpdateTelnyxPhoneNumberDtoHooksItem
    #
