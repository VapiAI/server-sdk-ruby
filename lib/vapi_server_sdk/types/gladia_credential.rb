...
require_relative "gladia_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class GladiaCredential
    # @return [Vapi::GladiaCredentialProvider]
    ...
    # @param provider [Vapi::GladiaCredentialProvider]
    ...
    # Deserialize a JSON object to an instance of GladiaCredential
    #
    ...
    # Serialize an instance of GladiaCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::GladiaCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
