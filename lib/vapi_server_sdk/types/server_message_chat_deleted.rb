...
require_relative "server_message_chat_deleted_phone_number"
require_relative "server_message_chat_deleted_type"
...
module Vapi
  class ServerMessageChatDeleted
    # @return [Vapi::ServerMessageChatDeletedPhoneNumber] This is the phone number that the message is associated with.
    attr_reader :phone_number
    # @return [Vapi::ServerMessageChatDeletedType] This is the type of the message. "chat.deleted" is sent when a chat is deleted.
    attr_reader :type
    ...
    attr_reader :call
    # @return [Vapi::Chat] This is the chat that was deleted.
    attr_reader :chat
    ...
    # @param phone_number [Vapi::ServerMessageChatDeletedPhoneNumber] This is the phone number that the message is associated with.
    # @param type [Vapi::ServerMessageChatDeletedType] This is the type of the message. "chat.deleted" is sent when a chat is deleted.
    ...
    # @param chat [Vapi::Chat] This is the chat that was deleted.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vapi::ServerMessageChatDeleted]
    def initialize(type:, chat:, phone_number: OMIT, timestamp: OMIT, artifact: OMIT, assistant: OMIT, customer: OMIT,
    ...
    # Deserialize a JSON object to an instance of ServerMessageChatDeleted
    #
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["phoneNumber"].nil?
        ...
        phone_number = Vapi::ServerMessageChatDeletedPhoneNumber.from_json(json_object: phone_number)
      end
    ...
    # Serialize an instance of ServerMessageChatDeleted to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.phone_number.nil? || Vapi::ServerMessageChatDeletedPhoneNumber.validate_raw(obj: obj.phone_number)
      obj.type.is_a?(Vapi::ServerMessageChatDeletedType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      ...
      Vapi::Chat.validate_raw(obj: obj.chat)
    end
  end
end
