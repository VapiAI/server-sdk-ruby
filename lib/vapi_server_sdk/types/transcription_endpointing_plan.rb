...
#  @default 0.5
    ...
    def initialize(on_punctuation_seconds: OMIT, on_no_punctuation_seconds: OMIT, on_number_seconds: OMIT, additional_properties: nil)
      ...
      @_field_set = { "onPunctuationSeconds": on_punctuation_seconds, "onNoPunctuationSeconds": on_no_punctuation_seconds, "onNumberSeconds": on_number_seconds }.reject do | _k, v |
  v == OMIT
end
    end
