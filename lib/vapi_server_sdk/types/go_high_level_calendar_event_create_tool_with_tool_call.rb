...
module Vapi
  class GoHighLevelCalendarEventCreateToolWithToolCall
    ...
    # @return [String] The type of tool. "gohighlevel.calendar.event.create" for GoHighLevel Calendar
    #  event create tool.
    attr_reader :type
    ...
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param type [String] The type of tool. "gohighlevel.calendar.event.create" for GoHighLevel Calendar
    #  event create tool.
