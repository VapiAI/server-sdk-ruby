...
require_relative "go_high_level_calendar_event_create_tool_with_tool_call_messages_item"
require_relative "go_high_level_calendar_event_create_tool_with_tool_call_type"
...
module Vapi
  class GoHighLevelCalendarEventCreateToolWithToolCall
    # @return [Array<Vapi::GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    attr_reader :messages
    # @return [Vapi::GoHighLevelCalendarEventCreateToolWithToolCallType] The type of tool. "gohighlevel.calendar.event.create" for GoHighLevel Calendar
    #  Event Create tool.
    attr_reader :type
    ...
    # @param messages [Array<Vapi::GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param type [Vapi::GoHighLevelCalendarEventCreateToolWithToolCallType] The type of tool. "gohighlevel.calendar.event.create" for GoHighLevel Calendar
    #  Event Create tool.
    ...
    # @return [Vapi::GoHighLevelCalendarEventCreateToolWithToolCall]
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of GoHighLevelCalendarEventCreateToolWithToolCall to a
    #  JSON object
    #
    # @return [String]
    def to_json(*_args)
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::GoHighLevelCalendarEventCreateToolWithToolCallType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
