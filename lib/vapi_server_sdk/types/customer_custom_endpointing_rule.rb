...
#  @default []
    ...
    # @return [Vapi::CustomerCustomEndpointingRule]
    def initialize(regex:, regex_options: OMIT, timeout_seconds:, additional_properties: nil)
      @regex = regex
      @regex_options = regex_options if regex_options != OMIT
      @timeout_seconds = timeout_seconds
      @additional_properties = additional_properties
      @_field_set = { "regex": regex, "regexOptions": regex_options, "timeoutSeconds": timeout_seconds }.reject do | _k, v |
  v == OMIT
end
    end
