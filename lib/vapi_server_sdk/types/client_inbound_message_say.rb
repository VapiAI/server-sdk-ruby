...
#  @default false
    ...
    def initialize(interrupt_assistant_enabled: OMIT, content: OMIT, end_call_after_spoken: OMIT, interruptions_enabled: OMIT, additional_properties: nil)
      ...
      @_field_set = { "interruptAssistantEnabled": interrupt_assistant_enabled, "content": content, "endCallAfterSpoken": end_call_after_spoken, "interruptionsEnabled": interruptions_enabled }.reject do | _k, v |
  v == OMIT
end
    end
