...
#  Only applicable with the Gemini Flash 2.0 Multimodal Live API.
    ...
    def initialize(top_p: OMIT, top_k: OMIT, presence_penalty: OMIT, frequency_penalty: OMIT, speech_config: OMIT, additional_properties: nil)
      ...
      @_field_set = { "topP": top_p, "topK": top_k, "presencePenalty": presence_penalty, "frequencyPenalty": frequency_penalty, "speechConfig": speech_config }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of GoogleRealtimeConfig
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["speechConfig"].nil?
