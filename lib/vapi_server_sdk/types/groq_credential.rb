...
require_relative "groq_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class GroqCredential
    # @return [Vapi::GroqCredentialProvider]
    ...
    # @param provider [Vapi::GroqCredentialProvider]
    ...
    # Deserialize a JSON object to an instance of GroqCredential
    #
    ...
    # Serialize an instance of GroqCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::GroqCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
