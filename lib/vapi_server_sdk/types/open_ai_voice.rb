...
#  voice provider fails.
    ...
    def initialize(caching_enabled: OMIT, voice_id:, model: OMIT, instructions: OMIT, speed: OMIT, chunk_plan: OMIT, fallback_plan: OMIT, additional_properties: nil)
      ...
      @_field_set = { "cachingEnabled": caching_enabled, "voiceId": voice_id, "model": model, "instructions": instructions, "speed": speed, "chunkPlan": chunk_plan, "fallbackPlan": fallback_plan }.reject do | _k, v |
  v == OMIT
end
    end
