...
require_relative "open_router_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class OpenRouterCredential
    # @return [Vapi::OpenRouterCredentialProvider]
    ...
    # @param provider [Vapi::OpenRouterCredentialProvider]
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::OpenRouterCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
