...
module Vapi
  class InsightPaginatedResponse
    # @return [Array<Vapi::Insight>]
    attr_reader :results
    ...
    # @param results [Array<Vapi::Insight>]
    ...
    # Deserialize a JSON object to an instance of InsightPaginatedResponse
    #
    ...
    def self.from_json(json_object:)
      ...
      results = parsed_json["results"]&.map do |item|
        item = item.to_json
        Vapi::Insight.from_json(json_object: item)
      end
    ...
    # Serialize an instance of InsightPaginatedResponse to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
