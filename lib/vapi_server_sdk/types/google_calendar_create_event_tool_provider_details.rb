...
module Vapi
  class GoogleCalendarCreateEventToolProviderDetails
    ...
    # @return [Vapi::GoogleCalendarCreateEventToolProviderDetails]
    ...
    # Serialize an instance of GoogleCalendarCreateEventToolProviderDetails to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
