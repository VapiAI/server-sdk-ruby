...
require_relative "line_insight_from_call_table_type"
require_relative "insight_formula"
require_relative "line_insight_metadata"
require_relative "insight_time_range_with_step"
require_relative "line_insight_from_call_table_group_by"
require_relative "line_insight_from_call_table_queries_item"
require "ostruct"
require "json"

module Vapi
  class LineInsightFromCallTable
    # @return [String] This is the name of the Insight.
    attr_reader :name
    # @return [Vapi::LineInsightFromCallTableType] This is the type of the Insight.
    ...
    # @return [Vapi::LineInsightFromCallTableGroupBy] This is the group by column for the insight when table is `call`.
    #  These are the columns to group the results by.
    #  All results are grouped by the time range step by default.
    attr_reader :group_by
    # @return [Array<Vapi::LineInsightFromCallTableQueriesItem>] These are the queries to run to generate the insight.
    attr_reader :queries
    ...
    # @param type [Vapi::LineInsightFromCallTableType] This is the type of the Insight.
    #  It is required to be `line` to create a line insight.
    ...
    # @param group_by [Vapi::LineInsightFromCallTableGroupBy] This is the group by column for the insight when table is `call`.
    #  These are the columns to group the results by.
    #  All results are grouped by the time range step by default.
    # @param queries [Array<Vapi::LineInsightFromCallTableQueriesItem>] These are the queries to run to generate the insight.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vapi::LineInsightFromCallTable]
    ...
    # Deserialize a JSON object to an instance of LineInsightFromCallTable
    #
    ...
    def self.from_json(json_object:)
      ...
      queries = parsed_json["queries"]&.map do |item|
        item = item.to_json
        Vapi::LineInsightFromCallTableQueriesItem.from_json(json_object: item)
      end
      new(
        name: name,
        type: type,
    ...
    # Serialize an instance of LineInsightFromCallTable to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::LineInsightFromCallTableType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      ...
      obj.group_by&.is_a?(Vapi::LineInsightFromCallTableGroupBy) != false || raise("Passed value for field obj.group_by is not the expected type, validation failed.")
