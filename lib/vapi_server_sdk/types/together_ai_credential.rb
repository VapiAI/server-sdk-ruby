...
require_relative "together_ai_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class TogetherAiCredential
    # @return [Vapi::TogetherAiCredentialProvider]
    ...
    # @param provider [Vapi::TogetherAiCredentialProvider]
    ...
    # @return [Vapi::TogetherAiCredential]
    ...
    # Deserialize a JSON object to an instance of TogetherAiCredential
    #
    ...
    # Serialize an instance of TogetherAiCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::TogetherAiCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
