...
require_relative "cartesia_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class CartesiaCredential
    # @return [Vapi::CartesiaCredentialProvider]
    ...
    # @param provider [Vapi::CartesiaCredentialProvider]
    ...
    # @return [Vapi::CartesiaCredential]
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::CartesiaCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
