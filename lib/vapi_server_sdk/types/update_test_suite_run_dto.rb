...
module Vapi
  class UpdateTestSuiteRunDto
    ...
    # @return [Vapi::UpdateTestSuiteRunDto]
    ...
    # Deserialize a JSON object to an instance of UpdateTestSuiteRunDto
    #
    ...
    # Serialize an instance of UpdateTestSuiteRunDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
