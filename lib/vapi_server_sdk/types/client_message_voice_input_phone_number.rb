...
# This is the phone number that the message is associated with.
  class ClientMessageVoiceInputPhoneNumber
  # @return [Object] 
    attr_reader :member
  # @return [String] 
    ...
    # @return [Vapi::ClientMessageVoiceInputPhoneNumber]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end
# Deserialize a JSON object to an instance of ClientMessageVoiceInputPhoneNumber
    #
