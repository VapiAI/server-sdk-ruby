...
#  provider.
    ...
    def initialize(caching_enabled: OMIT, voice_id:, speed: OMIT, temperature: OMIT, emotion: OMIT, voice_guidance: OMIT, style_guidance: OMIT, text_guidance: OMIT, model: OMIT, language: OMIT, chunk_plan: OMIT, additional_properties: nil)
      ...
      @_field_set = { "cachingEnabled": caching_enabled, "voiceId": voice_id, "speed": speed, "temperature": temperature, "emotion": emotion, "voiceGuidance": voice_guidance, "styleGuidance": style_guidance, "textGuidance": text_guidance, "model": model, "language": language, "chunkPlan": chunk_plan }.reject do | _k, v |
  v == OMIT
end
    end
