...
require_relative "get_eval_run_paginated_dto_sort_order"
require "date"
require "ostruct"
require "json"

module Vapi
  class GetEvalRunPaginatedDto
    # @return [String]
    attr_reader :id
    # @return [Float] This is the page number to return. Defaults to 1.
    attr_reader :page
    # @return [Vapi::GetEvalRunPaginatedDtoSortOrder] This is the sort order for pagination. Defaults to 'DESC'.
    ...
    # @param sort_order [Vapi::GetEvalRunPaginatedDtoSortOrder] This is the sort order for pagination. Defaults to 'DESC'.
    ...
    # @return [Vapi::GetEvalRunPaginatedDto]
    def initialize(id: OMIT, page: OMIT, sort_order: OMIT, limit: OMIT, created_at_gt: OMIT, created_at_lt: OMIT,
                   created_at_ge: OMIT, created_at_le: OMIT, updated_at_gt: OMIT, updated_at_lt: OMIT, updated_at_ge: OMIT, updated_at_le: OMIT, additional_properties: nil)
      @id = id if id != OMIT
    ...
    # Deserialize a JSON object to an instance of GetEvalRunPaginatedDto
    #
    ...
    # Serialize an instance of GetEvalRunPaginatedDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.sort_order&.is_a?(Vapi::GetEvalRunPaginatedDtoSortOrder) != false || raise("Passed value for field obj.sort_order is not the expected type, validation failed.")
