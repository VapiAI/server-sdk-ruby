...
require_relative "create_end_call_tool_dto_messages_item"
...
module Vapi
  class CreateEndCallToolDto
    # @return [Array<Vapi::CreateEndCallToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    ...
    # @param messages [Array<Vapi::CreateEndCallToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    ...
    # @return [Vapi::CreateEndCallToolDto]
    ...
    # Deserialize a JSON object to an instance of CreateEndCallToolDto
    #
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::CreateEndCallToolDtoMessagesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of CreateEndCallToolDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
