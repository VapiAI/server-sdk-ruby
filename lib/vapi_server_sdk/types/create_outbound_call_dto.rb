...
#  Only relevant for `outboundPhoneCall` and `inboundPhoneCall` type.
    ...
    def initialize(customers: OMIT, name: OMIT, schedule_plan: OMIT, transport: OMIT, assistant_id: OMIT, assistant: OMIT, assistant_overrides: OMIT, squad_id: OMIT, squad: OMIT, workflow_id: OMIT, workflow: OMIT, workflow_overrides: OMIT, phone_number_id: OMIT, phone_number: OMIT, customer_id: OMIT, customer: OMIT, additional_properties: nil)
      ...
      @_field_set = { "customers": customers, "name": name, "schedulePlan": schedule_plan, "transport": transport, "assistantId": assistant_id, "assistant": assistant, "assistantOverrides": assistant_overrides, "squadId": squad_id, "squad": squad, "workflowId": workflow_id, "workflow": workflow, "workflowOverrides": workflow_overrides, "phoneNumberId": phone_number_id, "phoneNumber": phone_number, "customerId": customer_id, "customer": customer }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of CreateOutboundCallDto
  ...
  Vapi::CreateCustomerDto.from_json(json_object: item)
      ...
      unless parsed_json["workflowOverrides"].nil?
