...
require_relative "create_ghl_tool_dto_type"
...
module Vapi
  class CreateGhlToolDto
    ...
    # @return [Vapi::CreateGhlToolDtoType] The type of tool. "ghl" for GHL tool.
    attr_reader :type
    ...
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param type [Vapi::CreateGhlToolDtoType] The type of tool. "ghl" for GHL tool.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::CreateGhlToolDtoType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
