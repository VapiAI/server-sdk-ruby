...
require_relative "call_hook_filter_type"
require "ostruct"
require "json"

module Vapi
  class CallHookFilter
    # @return [Vapi::CallHookFilterType] This is the type of filter - currently only "oneOf" is supported
    attr_reader :type
    ...
    # @param type [Vapi::CallHookFilterType] This is the type of filter - currently only "oneOf" is supported
    ...
    # Deserialize a JSON object to an instance of CallHookFilter
    #
    ...
    # Serialize an instance of CallHookFilter to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.type.is_a?(Vapi::CallHookFilterType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
