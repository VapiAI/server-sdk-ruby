...
require_relative "google_calendar_create_event_tool_messages_item"
require "date"
require "date"
...
module Vapi
  class GoogleCalendarCreateEventTool
  # @return [Array<Vapi::GoogleCalendarCreateEventToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
...
#  `messages[].conditions` matches the "reason" argument.
  ...
  # @return [Object] 
    ...
    # @param messages [Array<Vapi::GoogleCalendarCreateEventToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
#  For some tools, this is auto-filled based on special fields like
#  `tool.destinations`. For others like the function tool, these can be custom
#  configured.
...
#  `messages[].conditions` matches the "reason" argument.
    ...
    # @return [Vapi::GoogleCalendarCreateEventTool]
...
# Deserialize a JSON object to an instance of GoogleCalendarCreateEventTool
  ...
  item = item.to_json
  Vapi::GoogleCalendarCreateEventToolMessagesItem.from_json(json_object: item)
end
      id = parsed_json["id"]
