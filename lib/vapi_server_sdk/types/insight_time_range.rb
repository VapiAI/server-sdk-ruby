...
module Vapi
  class InsightTimeRange
    ...
    def initialize(start: OMIT, end_: OMIT, timezone: OMIT, additional_properties: nil)
      @start = start if start != OMIT
      @end_ = end_ if end_ != OMIT
      @timezone = timezone if timezone != OMIT
      @additional_properties = additional_properties
      @_field_set = { "start": start, "end": end_, "timezone": timezone }.reject do |_k, v|
        v == OMIT
      end
    end

    # Deserialize a JSON object to an instance of InsightTimeRange
    #
    ...
    # Serialize an instance of InsightTimeRange to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
