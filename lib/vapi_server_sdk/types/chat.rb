...
#  Used to provide message history for multi-turn conversations.
    ...
    # @return [Vapi::Chat]
    def initialize(assistant_id: OMIT, assistant: OMIT, assistant_overrides: OMIT, name: OMIT, session_id: OMIT, input: OMIT, stream: OMIT, previous_chat_id: OMIT, id:, org_id:, messages: OMIT, output: OMIT, created_at:, updated_at:, costs: OMIT, cost: OMIT, additional_properties: nil)
      ...
      @_field_set = { "assistantId": assistant_id, "assistant": assistant, "assistantOverrides": assistant_overrides, "name": name, "sessionId": session_id, "input": input, "stream": stream, "previousChatId": previous_chat_id, "id": id, "orgId": org_id, "messages": messages, "output": output, "createdAt": created_at, "updatedAt": updated_at, "costs": costs, "cost": cost }.reject do | _k, v |
  v == OMIT
end
    end
