...
require_relative "groq_model_tools_item"
require_relative "create_custom_knowledge_base_dto"
require_relative "groq_model_model"
require "ostruct"
require "json"
...
module Vapi
  class GroqModel
    ...
    # @return [Array<Vapi::GroqModelToolsItem>] These are the tools that the assistant can use during the call. To use existing
    #  tools, use `toolIds`.
    ...
    # @param tools [Array<Vapi::GroqModelToolsItem>] These are the tools that the assistant can use during the call. To use existing
    #  tools, use `toolIds`.
    #  Both `tools` and `toolIds` can be used together.
    ...
    # Deserialize a JSON object to an instance of GroqModel
    #
    ...
    def self.from_json(json_object:)
      ...
      tools = parsed_json["tools"]&.map do |item|
        item = item.to_json
        Vapi::GroqModelToolsItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of GroqModel to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
