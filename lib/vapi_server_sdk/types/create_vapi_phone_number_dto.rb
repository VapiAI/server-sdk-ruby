...
module Vapi
  class CreateVapiPhoneNumberDto
    ...
    def initialize(fallback_destination: OMIT, hooks: OMIT, number_desired_area_code: OMIT, sip_uri: OMIT,
                   authentication: OMIT, name: OMIT, assistant_id: OMIT, workflow_id: OMIT, squad_id: OMIT, server: OMIT, additional_properties: nil)
