...
#  provider.
    ...
    def initialize(enabled: OMIT, min_characters: OMIT, punctuation_boundaries: OMIT, format_plan: OMIT, additional_properties: nil)
      ...
      @_field_set = { "enabled": enabled, "minCharacters": min_characters, "punctuationBoundaries": punctuation_boundaries, "formatPlan": format_plan }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of ChunkPlan
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["formatPlan"].nil?
