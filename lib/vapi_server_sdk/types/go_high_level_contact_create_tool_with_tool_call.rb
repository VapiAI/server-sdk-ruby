...
require_relative "go_high_level_contact_create_tool_with_tool_call_type"
...
module Vapi
  class GoHighLevelContactCreateToolWithToolCall
    ...
    # @return [Vapi::GoHighLevelContactCreateToolWithToolCallType] The type of tool. "gohighlevel.contact.create" for GoHighLevel Contact Create
    #  tool.
    attr_reader :type
    ...
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param type [Vapi::GoHighLevelContactCreateToolWithToolCallType] The type of tool. "gohighlevel.contact.create" for GoHighLevel Contact Create
    #  tool.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::GoHighLevelContactCreateToolWithToolCallType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
