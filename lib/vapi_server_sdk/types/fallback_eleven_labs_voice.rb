...
#  provider.
    ...
    def initialize(caching_enabled: OMIT, voice_id:, stability: OMIT, similarity_boost: OMIT, style: OMIT, use_speaker_boost: OMIT, speed: OMIT, optimize_streaming_latency: OMIT, enable_ssml_parsing: OMIT, auto_mode: OMIT, model: OMIT, language: OMIT, chunk_plan: OMIT, additional_properties: nil)
      ...
      @_field_set = { "cachingEnabled": caching_enabled, "voiceId": voice_id, "stability": stability, "similarityBoost": similarity_boost, "style": style, "useSpeakerBoost": use_speaker_boost, "speed": speed, "optimizeStreamingLatency": optimize_streaming_latency, "enableSsmlParsing": enable_ssml_parsing, "autoMode": auto_mode, "model": model, "language": language, "chunkPlan": chunk_plan }.reject do | _k, v |
  v == OMIT
end
    end
