...
module Vapi
  ...
  # @return [String] This is the type of the message. "call.endpointing.request" is sent when using
...
#  This matches what is stored on `call.artifact` after the call.
  ...
  # @return [Object] 
    ...
    # @param type [String] This is the type of the message. "call.endpointing.request" is sent when using
#  `assistant.startSpeakingPlan.smartEndpointingPlan={ "provider":
#  "custom-endpointing-model" }`.
#  Here is what the request will look like:
#  POST https://{assistant.startSpeakingPlan.smartEndpointingPlan.server.url}
...
#  This matches what is stored on `call.artifact` after the call.
    ...
    def initialize(phone_number: OMIT, type:, messages: OMIT, messages_open_ai_formatted:, timestamp: OMIT, artifact: OMIT, assistant: OMIT, customer: OMIT, call: OMIT, chat: OMIT, additional_properties: nil)
      ...
      @_field_set = { "phoneNumber": phone_number, "type": type, "messages": messages, "messagesOpenAIFormatted": messages_open_ai_formatted, "timestamp": timestamp, "artifact": artifact, "assistant": assistant, "customer": customer, "call": call, "chat": chat }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of ServerMessageCallEndpointingRequest
    #
...
# Serialize an instance of ServerMessageCallEndpointingRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
