...
module Vapi
  class SlackSendMessageToolMessagesItem
  # @return [Object] 
    attr_reader :member
  # @return [String] 
    ...
    # @return [Vapi::SlackSendMessageToolMessagesItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end
# Deserialize a JSON object to an instance of SlackSendMessageToolMessagesItem
    #
