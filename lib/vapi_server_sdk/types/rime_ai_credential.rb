...
require_relative "rime_ai_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class RimeAiCredential
    # @return [Vapi::RimeAiCredentialProvider]
    ...
    # @param provider [Vapi::RimeAiCredentialProvider]
    ...
    # Serialize an instance of RimeAiCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::RimeAiCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
