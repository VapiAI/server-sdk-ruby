...
module Vapi
  class ToolRejectionPlanConditionsItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::ToolRejectionPlanConditionsItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of ToolRejectionPlanConditionsItem
    #
