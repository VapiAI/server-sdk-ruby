...
#  provider.
    ...
    def initialize(caching_enabled: OMIT, model: OMIT, voice_id:, is_custom_hume_voice: OMIT, description: OMIT, chunk_plan: OMIT, additional_properties: nil)
      ...
      @_field_set = { "cachingEnabled": caching_enabled, "model": model, "voiceId": voice_id, "isCustomHumeVoice": is_custom_hume_voice, "description": description, "chunkPlan": chunk_plan }.reject do | _k, v |
  v == OMIT
end
    end
