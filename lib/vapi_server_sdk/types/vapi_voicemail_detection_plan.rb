...
require_relative "vapi_voicemail_detection_plan_provider"
require_relative "voicemail_detection_backoff_plan"
require_relative "vapi_voicemail_detection_plan_type"
require "ostruct"
require "json"

module Vapi
  class VapiVoicemailDetectionPlan
    ...
    # @return [Vapi::VapiVoicemailDetectionPlanProvider] This is the provider to use for voicemail detection.
    ...
    # @return [Vapi::VapiVoicemailDetectionPlanType] This is the detection type to use for voicemail detection.
    ...
    #  @min 0
    #  @max 60
    # @param provider [Vapi::VapiVoicemailDetectionPlanProvider] This is the provider to use for voicemail detection.
    # @param backoff_plan [Vapi::VoicemailDetectionBackoffPlan] This is the backoff plan for the voicemail detection.
    # @param type [Vapi::VapiVoicemailDetectionPlanType] This is the detection type to use for voicemail detection.
    #  - 'audio': Uses native audio models (default)
    #  - 'transcript': Uses ASR/transcript-based detection
    #  @default 'audio' (audio detection)
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vapi::VapiVoicemailDetectionPlan]
    ...
    def self.validate_raw(obj:)
      ...
      obj.provider.is_a?(Vapi::VapiVoicemailDetectionPlanProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
      obj.backoff_plan.nil? || Vapi::VoicemailDetectionBackoffPlan.validate_raw(obj: obj.backoff_plan)
      obj.type&.is_a?(Vapi::VapiVoicemailDetectionPlanType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
    end
  end
end
