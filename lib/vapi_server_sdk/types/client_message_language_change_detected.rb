...
require_relative "client_message_language_change_detected_type"
...
module Vapi
  class ClientMessageLanguageChangeDetected
    ...
    # @return [Vapi::ClientMessageLanguageChangeDetectedType] This is the type of the message. "language-change-detected" is sent when the
    ...
    # @param type [Vapi::ClientMessageLanguageChangeDetectedType] This is the type of the message. "language-change-detected" is sent when the
    #  transcriber is automatically switched based on the detected language.
    ...
    def initialize(type:, language:, phone_number: OMIT, timestamp: OMIT, call: OMIT, customer: OMIT, assistant: OMIT,
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::ClientMessageLanguageChangeDetectedType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
