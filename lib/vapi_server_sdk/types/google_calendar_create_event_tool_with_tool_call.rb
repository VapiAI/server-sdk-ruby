...
require_relative "google_calendar_create_event_tool_with_tool_call_messages_item"
...
module Vapi
  class GoogleCalendarCreateEventToolWithToolCall
    # @return [Array<Vapi::GoogleCalendarCreateEventToolWithToolCallMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    ...
    # @param messages [Array<Vapi::GoogleCalendarCreateEventToolWithToolCallMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    ...
    # @return [Vapi::GoogleCalendarCreateEventToolWithToolCall]
    def initialize(tool_call:, messages: OMIT, rejection_plan: OMIT, additional_properties: nil)
      @messages = messages if messages != OMIT
      @tool_call = tool_call
      @rejection_plan = rejection_plan if rejection_plan != OMIT
      @additional_properties = additional_properties
      @_field_set = { "messages": messages, "toolCall": tool_call, "rejectionPlan": rejection_plan }.reject do |_k, v|
        v == OMIT
      end
    end
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::GoogleCalendarCreateEventToolWithToolCallMessagesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of GoogleCalendarCreateEventToolWithToolCall to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
