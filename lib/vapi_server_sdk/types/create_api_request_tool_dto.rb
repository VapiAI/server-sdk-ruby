...
module Vapi
  class CreateApiRequestToolDto
    ...
    def initialize(method:, url:, body:, async: OMIT, messages: OMIT, timeout_seconds: OMIT, name: OMIT,
                   description: OMIT, headers: OMIT, backoff_plan: OMIT, function: OMIT, server: OMIT, additional_properties: nil)
    ...
    def self.validate_raw(obj:)
      ...
      Vapi::JsonSchema.validate_raw(obj: obj.body)
