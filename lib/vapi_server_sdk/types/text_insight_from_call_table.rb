...
require_relative "text_insight_from_call_table_type"
require_relative "insight_time_range"
require_relative "text_insight_from_call_table_queries_item"
require "ostruct"
require "json"

module Vapi
  class TextInsightFromCallTable
    # @return [String] This is the name of the Insight.
    attr_reader :name
    # @return [Vapi::TextInsightFromCallTableType] This is the type of the Insight.
    ...
    # @return [Array<Vapi::TextInsightFromCallTableQueriesItem>] These are the queries to run to generate the insight.
    ...
    # @param type [Vapi::TextInsightFromCallTableType] This is the type of the Insight.
    #  It is required to be `text` to create a text insight.
    ...
    # @param queries [Array<Vapi::TextInsightFromCallTableQueriesItem>] These are the queries to run to generate the insight.
    #  For Text Insights, we only allow a single query, or require a formula if
    #  multiple queries are provided
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vapi::TextInsightFromCallTable]
    def initialize(type:, queries:, name: OMIT, formula: OMIT, time_range: OMIT, additional_properties: nil)
    ...
    # Deserialize a JSON object to an instance of TextInsightFromCallTable
    #
    ...
    def self.from_json(json_object:)
      ...
      queries = parsed_json["queries"]&.map do |item|
        item = item.to_json
        Vapi::TextInsightFromCallTableQueriesItem.from_json(json_object: item)
      end
      new(
        name: name,
        type: type,
    ...
    # Serialize an instance of TextInsightFromCallTable to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::TextInsightFromCallTableType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
