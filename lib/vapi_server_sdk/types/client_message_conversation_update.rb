...
#  sent, formatted for OpenAI.
    ...
    def initialize(phone_number: OMIT, type:, messages: OMIT, messages_open_ai_formatted:, timestamp: OMIT, call: OMIT, customer: OMIT, assistant: OMIT, additional_properties: nil)
      ...
      @_field_set = { "phoneNumber": phone_number, "type": type, "messages": messages, "messagesOpenAIFormatted": messages_open_ai_formatted, "timestamp": timestamp, "call": call, "customer": customer, "assistant": assistant }.reject do | _k, v |
  v == OMIT
end
    end
