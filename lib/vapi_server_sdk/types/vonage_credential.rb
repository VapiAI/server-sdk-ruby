...
#  Only relevant for Vonage credentials.
    ...
    def initialize(vonage_application_private_key:, provider:, api_secret:, id:, org_id:, created_at:, updated_at:, vonage_application_id:, name: OMIT, api_key:, additional_properties: nil)
      ...
      @_field_set = { "vonageApplicationPrivateKey": vonage_application_private_key, "provider": provider, "apiSecret": api_secret, "id": id, "orgId": org_id, "createdAt": created_at, "updatedAt": updated_at, "vonageApplicationId": vonage_application_id, "name": name, "apiKey": api_key }.reject do | _k, v |
  v == OMIT
end
    end
