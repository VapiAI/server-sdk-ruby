...
module Vapi
  class UpdateGhlToolDto
    ...
    def initialize(messages: OMIT, rejection_plan: OMIT, metadata: OMIT, additional_properties: nil)
      @messages = messages if messages != OMIT
      @rejection_plan = rejection_plan if rejection_plan != OMIT
      @metadata = metadata if metadata != OMIT
      @additional_properties = additional_properties
      @_field_set = { "messages": messages, "rejectionPlan": rejection_plan, "metadata": metadata }.reject do |_k, v|
        v == OMIT
      end
    end
