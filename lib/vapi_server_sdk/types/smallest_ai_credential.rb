...
require_relative "smallest_ai_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class SmallestAiCredential
    # @return [Vapi::SmallestAiCredentialProvider]
    ...
    # @param provider [Vapi::SmallestAiCredentialProvider]
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::SmallestAiCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
