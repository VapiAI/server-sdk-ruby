...
module Vapi
  ...
  class CreateStructuredOutputDtoModel
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::CreateStructuredOutputDtoModel]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of CreateStructuredOutputDtoModel
    #
