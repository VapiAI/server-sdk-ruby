...
#  to the subscription's email.
    ...
    def initialize(company_name: OMIT, company_address: OMIT, company_tax_id: OMIT, company_email: OMIT, additional_properties: nil)
      ...
      @_field_set = { "companyName": company_name, "companyAddress": company_address, "companyTaxId": company_tax_id, "companyEmail": company_email }.reject do | _k, v |
  v == OMIT
end
    end
