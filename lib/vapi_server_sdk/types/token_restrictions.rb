...
#  Only relevant for `public` tokens.
    ...
    def initialize(enabled: OMIT, allowed_origins: OMIT, allowed_assistant_ids: OMIT, allow_transient_assistant: OMIT, additional_properties: nil)
      ...
      @_field_set = { "enabled": enabled, "allowedOrigins": allowed_origins, "allowedAssistantIds": allowed_assistant_ids, "allowTransientAssistant": allow_transient_assistant }.reject do | _k, v |
  v == OMIT
end
    end
