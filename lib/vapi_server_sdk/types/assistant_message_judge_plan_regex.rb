...
module Vapi
  class AssistantMessageJudgePlanRegex
    # @return [String] This is what that will be used to evaluate the model's message content.
    #  The content will be evaluated against the regex pattern provided in the Judge
    #  Plan content field.
    #  Evaluation is considered successful if the regex pattern matches any part of the
    ...
    #  Evaluation is considered successful if the regex pattern matches any part of
    #  each tool call argument.
    ...
    # @return [Vapi::AssistantMessageJudgePlanRegex]
    ...
    # Deserialize a JSON object to an instance of AssistantMessageJudgePlanRegex
    #
    ...
    # Serialize an instance of AssistantMessageJudgePlanRegex to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
