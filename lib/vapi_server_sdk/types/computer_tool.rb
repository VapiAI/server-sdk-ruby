...
require_relative "computer_tool_sub_type"
require_relative "server"
require "date"
require_relative "tool_rejection_plan"
require_relative "computer_tool_name"
require "ostruct"
require "json"
...
module Vapi
  class ComputerTool
    ...
    # @return [Vapi::ComputerToolSubType] The sub type of tool.
    ...
    # @return [Vapi::ComputerToolName] The name of the tool, fixed to 'computer'
    attr_reader :name
    ...
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param sub_type [Vapi::ComputerToolSubType] The sub type of tool.
    ...
    #  }
    #  ```
    # @param name [Vapi::ComputerToolName] The name of the tool, fixed to 'computer'
    ...
    def initialize(sub_type:, id:, org_id:, created_at:, updated_at:, name:, display_width_px:, display_height_px:, messages: OMIT, server: OMIT,
                   rejection_plan: OMIT, display_number: OMIT, additional_properties: nil)
    ...
    def self.validate_raw(obj:)
      ...
      obj.sub_type.is_a?(Vapi::ComputerToolSubType) != false || raise("Passed value for field obj.sub_type is not the expected type, validation failed.")
      ...
      obj.name.is_a?(Vapi::ComputerToolName) != false || raise("Passed value for field obj.name is not the expected type, validation failed.")
