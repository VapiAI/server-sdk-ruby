...
module Vapi
  class ComputerTool
    ...
    def initialize(sub_type:, id:, org_id:, created_at:, updated_at:, name:, display_width_px:, display_height_px:, async: OMIT, messages: OMIT, function: OMIT,
                   server: OMIT, display_number: OMIT, additional_properties: nil)
