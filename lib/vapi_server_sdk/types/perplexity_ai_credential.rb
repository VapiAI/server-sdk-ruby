...
require_relative "perplexity_ai_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class PerplexityAiCredential
    # @return [Vapi::PerplexityAiCredentialProvider]
    ...
    # @param provider [Vapi::PerplexityAiCredentialProvider]
    ...
    # @return [Vapi::PerplexityAiCredential]
    ...
    # Deserialize a JSON object to an instance of PerplexityAiCredential
    #
    ...
    # Serialize an instance of PerplexityAiCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::PerplexityAiCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
