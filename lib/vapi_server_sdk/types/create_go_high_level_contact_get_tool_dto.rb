...
require_relative "create_go_high_level_contact_get_tool_dto_messages_item"
require_relative "tool_rejection_plan"
require "ostruct"
require "json"

module Vapi
  class CreateGoHighLevelContactGetToolDto
    # @return [Array<Vapi::CreateGoHighLevelContactGetToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    ...
    # @param messages [Array<Vapi::CreateGoHighLevelContactGetToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    ...
    # @return [Vapi::CreateGoHighLevelContactGetToolDto]
    def initialize(messages: OMIT, rejection_plan: OMIT, additional_properties: nil)
      @messages = messages if messages != OMIT
      @rejection_plan = rejection_plan if rejection_plan != OMIT
      @additional_properties = additional_properties
      @_field_set = { "messages": messages, "rejectionPlan": rejection_plan }.reject do |_k, v|
        v == OMIT
      end
    end

    # Deserialize a JSON object to an instance of CreateGoHighLevelContactGetToolDto
    #
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::CreateGoHighLevelContactGetToolDtoMessagesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of CreateGoHighLevelContactGetToolDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
