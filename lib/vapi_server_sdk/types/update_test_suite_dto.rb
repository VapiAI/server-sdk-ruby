...
module Vapi
  class UpdateTestSuiteDto
    ...
    # @return [Vapi::UpdateTestSuiteDto]
    ...
    # Deserialize a JSON object to an instance of UpdateTestSuiteDto
    #
    ...
    # Serialize an instance of UpdateTestSuiteDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
