...
module Vapi
  class CreateQueryToolDtoMessagesItem
  # @return [Object] 
    attr_reader :member
  # @return [String] 
    ...
    # @return [Vapi::CreateQueryToolDtoMessagesItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end
# Deserialize a JSON object to an instance of CreateQueryToolDtoMessagesItem
    #
