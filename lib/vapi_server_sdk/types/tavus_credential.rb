...
require_relative "tavus_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class TavusCredential
    # @return [Vapi::TavusCredentialProvider]
    ...
    # @param provider [Vapi::TavusCredentialProvider]
    ...
    # Deserialize a JSON object to an instance of TavusCredential
    #
    ...
    # Serialize an instance of TavusCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::TavusCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
