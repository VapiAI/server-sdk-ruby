...
require_relative "update_google_sheets_row_append_tool_dto_messages_item"
require_relative "tool_rejection_plan"
require "ostruct"
require "json"

module Vapi
  class UpdateGoogleSheetsRowAppendToolDto
    # @return [Array<Vapi::UpdateGoogleSheetsRowAppendToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    ...
    # @param messages [Array<Vapi::UpdateGoogleSheetsRowAppendToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    ...
    # @return [Vapi::UpdateGoogleSheetsRowAppendToolDto]
    ...
    # Deserialize a JSON object to an instance of UpdateGoogleSheetsRowAppendToolDto
    #
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::UpdateGoogleSheetsRowAppendToolDtoMessagesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of UpdateGoogleSheetsRowAppendToolDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
