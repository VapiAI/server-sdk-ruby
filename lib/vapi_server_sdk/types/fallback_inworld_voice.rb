...
#  provider.
    ...
    def initialize(caching_enabled: OMIT, voice_id:, model: OMIT, language_code: OMIT, chunk_plan: OMIT, additional_properties: nil)
      ...
      @_field_set = { "cachingEnabled": caching_enabled, "voiceId": voice_id, "model": model, "languageCode": language_code, "chunkPlan": chunk_plan }.reject do | _k, v |
  v == OMIT
end
    end
