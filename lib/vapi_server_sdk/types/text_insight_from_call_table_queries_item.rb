...
module Vapi
  class TextInsightFromCallTableQueriesItem
    # Deserialize a JSON object to an instance of TextInsightFromCallTableQueriesItem
    #
    # @param json_object [String]
    # @return [Vapi::TextInsightFromCallTableQueriesItem]
