...
module Vapi
  ...
  # @return [Object] 
    ...
    # @return [Vapi::File]
    def initialize(object: OMIT, status: OMIT, name: OMIT, original_name: OMIT, bytes: OMIT, purpose: OMIT, mimetype: OMIT, key: OMIT, path: OMIT, bucket: OMIT, url: OMIT, parsed_text_url: OMIT, parsed_text_bytes: OMIT, metadata: OMIT, id:, org_id:, created_at:, updated_at:, additional_properties: nil)
      ...
      @_field_set = { "object": object, "status": status, "name": name, "originalName": original_name, "bytes": bytes, "purpose": purpose, "mimetype": mimetype, "key": key, "path": path, "bucket": bucket, "url": url, "parsedTextUrl": parsed_text_url, "parsedTextBytes": parsed_text_bytes, "metadata": metadata, "id": id, "orgId": org_id, "createdAt": created_at, "updatedAt": updated_at }.reject do | _k, v |
  v == OMIT
end
    end
