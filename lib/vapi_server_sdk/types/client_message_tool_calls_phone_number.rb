...
# This is the phone number that the message is associated with.
  class ClientMessageToolCallsPhoneNumber
  # @return [Object] 
    attr_reader :member
  # @return [String] 
    ...
    # @return [Vapi::ClientMessageToolCallsPhoneNumber]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end
# Deserialize a JSON object to an instance of ClientMessageToolCallsPhoneNumber
    #
