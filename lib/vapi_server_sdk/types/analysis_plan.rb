...
#  to `call.analysis.successEvaluation`.
    ...
    def initialize(min_messages_threshold: OMIT, summary_plan: OMIT, structured_data_plan: OMIT, structured_data_multi_plan: OMIT, success_evaluation_plan: OMIT, additional_properties: nil)
      ...
      @_field_set = { "minMessagesThreshold": min_messages_threshold, "summaryPlan": summary_plan, "structuredDataPlan": structured_data_plan, "structuredDataMultiPlan": structured_data_multi_plan, "successEvaluationPlan": success_evaluation_plan }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of AnalysisPlan
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["structuredDataPlan"].nil?
  ...
  Vapi::StructuredDataMultiPlan.from_json(json_object: item)
      ...
      unless parsed_json["successEvaluationPlan"].nil?
