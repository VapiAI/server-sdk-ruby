...
require_relative "update_workflow_dto_model"
require_relative "update_workflow_dto_transcriber"
require_relative "update_workflow_dto_voice"
require_relative "langfuse_observability_plan"
require_relative "update_workflow_dto_background_sound"
require_relative "update_workflow_dto_hooks_item"
require_relative "update_workflow_dto_credentials_item"
require_relative "update_workflow_dto_voicemail_detection"
...
module Vapi
  class UpdateWorkflowDto
    ...
    attr_reader :nodes
    # @return [Vapi::UpdateWorkflowDtoModel] This is the model for the workflow.
    #  This can be overridden at node level using `nodes[n].model`.
    attr_reader :model
    # @return [Vapi::UpdateWorkflowDtoTranscriber] This is the transcriber for the workflow.
    #  This can be overridden at node level using `nodes[n].transcriber`.
    attr_reader :transcriber
    # @return [Vapi::UpdateWorkflowDtoVoice] This is the voice for the workflow.
    ...
    # @return [Vapi::UpdateWorkflowDtoBackgroundSound] This is the background sound in the call. Default for phone calls is 'office'
    #  and default for web calls is 'off'.
    #  You can also provide a custom sound by providing a URL to an audio file.
    attr_reader :background_sound
    # @return [Array<Vapi::UpdateWorkflowDtoHooksItem>] This is a set of actions that will be performed on certain events.
    attr_reader :hooks
    # @return [Array<Vapi::UpdateWorkflowDtoCredentialsItem>] These are dynamic credentials that will be used for the workflow calls. By
    ...
    # @return [Vapi::UpdateWorkflowDtoVoicemailDetection] This is the voicemail detection plan for the workflow.
    ...
    # @param model [Vapi::UpdateWorkflowDtoModel] This is the model for the workflow.
    #  This can be overridden at node level using `nodes[n].model`.
    # @param transcriber [Vapi::UpdateWorkflowDtoTranscriber] This is the transcriber for the workflow.
    #  This can be overridden at node level using `nodes[n].transcriber`.
    # @param voice [Vapi::UpdateWorkflowDtoVoice] This is the voice for the workflow.
    #  This can be overridden at node level using `nodes[n].voice`.
    # @param observability_plan [Vapi::LangfuseObservabilityPlan] This is the plan for observability of workflow's calls.
    #  Currently, only Langfuse is supported.
    # @param background_sound [Vapi::UpdateWorkflowDtoBackgroundSound] This is the background sound in the call. Default for phone calls is 'office'
    #  and default for web calls is 'off'.
    #  You can also provide a custom sound by providing a URL to an audio file.
    # @param hooks [Array<Vapi::UpdateWorkflowDtoHooksItem>] This is a set of actions that will be performed on certain events.
    # @param credentials [Array<Vapi::UpdateWorkflowDtoCredentialsItem>] These are dynamic credentials that will be used for the workflow calls. By
    #  default, all the credentials are available for use in the call but you can
    #  supplement an additional credentials using this. Dynamic credentials override
    #  existing credentials.
    # @param voicemail_detection [Vapi::UpdateWorkflowDtoVoicemailDetection] This is the voicemail detection plan for the workflow.
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["model"].nil?
        ...
        model = Vapi::UpdateWorkflowDtoModel.from_json(json_object: model)
      end
      if parsed_json["transcriber"].nil?
        transcriber = nil
      else
        transcriber = parsed_json["transcriber"].to_json
        transcriber = Vapi::UpdateWorkflowDtoTranscriber.from_json(json_object: transcriber)
      end
      if parsed_json["voice"].nil?
        voice = nil
      else
        voice = parsed_json["voice"].to_json
        voice = Vapi::UpdateWorkflowDtoVoice.from_json(json_object: voice)
      end
      ...
      if parsed_json["backgroundSound"].nil?
        ...
        background_sound = Vapi::UpdateWorkflowDtoBackgroundSound.from_json(json_object: background_sound)
      end
      hooks = parsed_json["hooks"]&.map do |item|
        item = item.to_json
        Vapi::UpdateWorkflowDtoHooksItem.from_json(json_object: item)
      end
      credentials = parsed_json["credentials"]&.map do |item|
        item = item.to_json
        Vapi::UpdateWorkflowDtoCredentialsItem.from_json(json_object: item)
      end
      if parsed_json["voicemailDetection"].nil?
        voicemail_detection = nil
      else
        voicemail_detection = parsed_json["voicemailDetection"].to_json
        voicemail_detection = Vapi::UpdateWorkflowDtoVoicemailDetection.from_json(json_object: voicemail_detection)
      end
    ...
    def self.validate_raw(obj:)
      ...
      obj.model.nil? || Vapi::UpdateWorkflowDtoModel.validate_raw(obj: obj.model)
      obj.transcriber.nil? || Vapi::UpdateWorkflowDtoTranscriber.validate_raw(obj: obj.transcriber)
      obj.voice.nil? || Vapi::UpdateWorkflowDtoVoice.validate_raw(obj: obj.voice)
      obj.observability_plan.nil? || Vapi::LangfuseObservabilityPlan.validate_raw(obj: obj.observability_plan)
      obj.background_sound.nil? || Vapi::UpdateWorkflowDtoBackgroundSound.validate_raw(obj: obj.background_sound)
      ...
      obj.voicemail_detection.nil? || Vapi::UpdateWorkflowDtoVoicemailDetection.validate_raw(obj: obj.voicemail_detection)
