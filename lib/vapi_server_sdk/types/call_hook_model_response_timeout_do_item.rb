...
module Vapi
  class CallHookModelResponseTimeoutDoItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::CallHookModelResponseTimeoutDoItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of CallHookModelResponseTimeoutDoItem
    #
