...
require_relative "go_high_level_calendar_event_create_tool_messages_item"
require "date"
require "date"
...
module Vapi
  class GoHighLevelCalendarEventCreateTool
  # @return [Array<Vapi::GoHighLevelCalendarEventCreateToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
...
#  `messages[].conditions` matches the "reason" argument.
  ...
  # @return [Object] 
    ...
    # @param messages [Array<Vapi::GoHighLevelCalendarEventCreateToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
#  For some tools, this is auto-filled based on special fields like
#  `tool.destinations`. For others like the function tool, these can be custom
#  configured.
...
#  `messages[].conditions` matches the "reason" argument.
    ...
    # @return [Vapi::GoHighLevelCalendarEventCreateTool]
...
# Deserialize a JSON object to an instance of GoHighLevelCalendarEventCreateTool
    #
  ...
  item = item.to_json
  Vapi::GoHighLevelCalendarEventCreateToolMessagesItem.from_json(json_object: item)
end
      id = parsed_json["id"]
...
# Serialize an instance of GoHighLevelCalendarEventCreateTool to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
