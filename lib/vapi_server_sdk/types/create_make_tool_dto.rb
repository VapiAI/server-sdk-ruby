...
require_relative "create_make_tool_dto_messages_item"
require_relative "create_make_tool_dto_type"
...
module Vapi
  class CreateMakeToolDto
    # @return [Array<Vapi::CreateMakeToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    attr_reader :messages
    # @return [Vapi::CreateMakeToolDtoType] The type of tool. "make" for Make tool.
    attr_reader :type
    ...
    # @param messages [Array<Vapi::CreateMakeToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param type [Vapi::CreateMakeToolDtoType] The type of tool. "make" for Make tool.
    ...
    # @return [Vapi::CreateMakeToolDto]
    def initialize(type:, metadata:, messages: OMIT, rejection_plan: OMIT, additional_properties: nil)
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::CreateMakeToolDtoMessagesItem.from_json(json_object: item)
      end
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::CreateMakeToolDtoType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
