...
module Vapi
  class CreateTelnyxPhoneNumberDtoHooksItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::CreateTelnyxPhoneNumberDtoHooksItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of CreateTelnyxPhoneNumberDtoHooksItem
    #
