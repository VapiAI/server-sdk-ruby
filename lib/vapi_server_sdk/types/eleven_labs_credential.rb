...
module Vapi
  ...
  # @return [Object] 
    ...
    # @return [Vapi::ElevenLabsCredential]
...
# Deserialize a JSON object to an instance of ElevenLabsCredential
    #
...
# Serialize an instance of ElevenLabsCredential to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
