...
#  with an error message.
  class ByoPhoneNumberFallbackDestination
  # @return [Object] 
    attr_reader :member
  # @return [String] 
    ...
    # @return [Vapi::ByoPhoneNumberFallbackDestination]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end
# Deserialize a JSON object to an instance of ByoPhoneNumberFallbackDestination
    #
