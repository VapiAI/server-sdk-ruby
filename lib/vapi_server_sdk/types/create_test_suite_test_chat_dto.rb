...
require_relative "create_test_suite_test_chat_dto_type"
require "ostruct"
require "json"
...
module Vapi
  class CreateTestSuiteTestChatDto
    ...
    attr_reader :scorers
    # @return [Vapi::CreateTestSuiteTestChatDtoType] This is the type of the test, which must be chat.
    attr_reader :type
    ...
    # @param type [Vapi::CreateTestSuiteTestChatDtoType] This is the type of the test, which must be chat.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::CreateTestSuiteTestChatDtoType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
