...
module Vapi
  class GoHighLevelContactCreateToolProviderDetails
  ...
  # @return [Object] 
    ...
    # @return [Vapi::GoHighLevelContactCreateToolProviderDetails]
...
# Serialize an instance of GoHighLevelContactCreateToolProviderDetails to a JSON
#  object
    #
    # @return [String]
    def to_json
