...
module Vapi
  ...
  # @return [Object] 
    ...
    # @return [Vapi::PlayHtCredential]
    def initialize(provider:, api_key:, id:, org_id:, created_at:, updated_at:, name: OMIT, user_id:, additional_properties: nil)
      @provider = provider
      @api_key = api_key
      @id = id
      @org_id = org_id
      ...
      @_field_set = { "provider": provider, "apiKey": api_key, "id": id, "orgId": org_id, "createdAt": created_at, "updatedAt": updated_at, "name": name, "userId": user_id }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of PlayHtCredential
    #
...
# Serialize an instance of PlayHtCredential to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
