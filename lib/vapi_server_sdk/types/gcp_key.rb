...
module Vapi
  class GcpKey
    ...
    # @return [Vapi::GcpKey]
    def initialize(type:, project_id:, private_key_id:, private_key:, client_email:, client_id:, auth_uri:, token_uri:,
                   auth_provider_x_509_cert_url:, client_x_509_cert_url:, universe_domain:, additional_properties: nil)
      @type = type
      ...
      @_field_set = {
        ...
        "authUri": auth_uri,
        "tokenUri": token_uri,
        "authProviderX509CertUrl": auth_provider_x_509_cert_url,
        "clientX509CertUrl": client_x_509_cert_url,
