...
require_relative "speechmatics_transcriber_model"
require_relative "speechmatics_transcriber_language"
require_relative "speechmatics_transcriber_operating_point"
require_relative "speechmatics_transcriber_region"
require_relative "speechmatics_custom_vocabulary_item"
require_relative "speechmatics_transcriber_numeral_style"
...
module Vapi
  class SpeechmaticsTranscriber
    # @return [Vapi::SpeechmaticsTranscriberModel] This is the model that will be used for the transcription.
    attr_reader :model
    # @return [Vapi::SpeechmaticsTranscriberLanguage]
    attr_reader :language
    # @return [Vapi::SpeechmaticsTranscriberOperatingPoint] This is the operating point for the transcription. Choose between `standard` for
    #  faster turnaround with strong accuracy or `enhanced` for highest accuracy when
    #  precision is critical.
    #  @default 'enhanced'
    attr_reader :operating_point
    # @return [Vapi::SpeechmaticsTranscriberRegion] This is the region for the Speechmatics API. Choose between EU (Europe) and US
    ...
    # @return [Vapi::SpeechmaticsTranscriberNumeralStyle] This controls how numbers are formatted in the transcription output.
    #  @default 'written'
    ...
    # @param model [Vapi::SpeechmaticsTranscriberModel] This is the model that will be used for the transcription.
    # @param language [Vapi::SpeechmaticsTranscriberLanguage]
    # @param operating_point [Vapi::SpeechmaticsTranscriberOperatingPoint] This is the operating point for the transcription. Choose between `standard` for
    #  faster turnaround with strong accuracy or `enhanced` for highest accuracy when
    #  precision is critical.
    #  @default 'enhanced'
    # @param region [Vapi::SpeechmaticsTranscriberRegion] This is the region for the Speechmatics API. Choose between EU (Europe) and US
    #  (United States) regions for lower latency and data sovereignty compliance.
    #  @default 'eu'
    ...
    # @param numeral_style [Vapi::SpeechmaticsTranscriberNumeralStyle] This controls how numbers are formatted in the transcription output.
    #  @default 'written'
    ...
    # @return [Vapi::SpeechmaticsTranscriber]
    def initialize(custom_vocabulary:, model: OMIT, language: OMIT, operating_point: OMIT, region: OMIT, enable_diarization: OMIT,
                   max_speakers: OMIT, speaker_labels: OMIT, enable_partials: OMIT, max_delay: OMIT, numeral_style: OMIT, enable_entities: OMIT, enable_punctuation: OMIT, enable_capitalization: OMIT, end_of_turn_sensitivity: OMIT, remove_disfluencies: OMIT, minimum_speech_duration: OMIT, fallback_plan: OMIT, additional_properties: nil)
    ...
    # Deserialize a JSON object to an instance of SpeechmaticsTranscriber
    #
    ...
    # Serialize an instance of SpeechmaticsTranscriber to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.model&.is_a?(Vapi::SpeechmaticsTranscriberModel) != false || raise("Passed value for field obj.model is not the expected type, validation failed.")
      obj.language&.is_a?(Vapi::SpeechmaticsTranscriberLanguage) != false || raise("Passed value for field obj.language is not the expected type, validation failed.")
      obj.operating_point&.is_a?(Vapi::SpeechmaticsTranscriberOperatingPoint) != false || raise("Passed value for field obj.operating_point is not the expected type, validation failed.")
      obj.region&.is_a?(Vapi::SpeechmaticsTranscriberRegion) != false || raise("Passed value for field obj.region is not the expected type, validation failed.")
      ...
      obj.numeral_style&.is_a?(Vapi::SpeechmaticsTranscriberNumeralStyle) != false || raise("Passed value for field obj.numeral_style is not the expected type, validation failed.")
