...
require_relative "hume_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class HumeCredential
    # @return [Vapi::HumeCredentialProvider]
    ...
    # @param provider [Vapi::HumeCredentialProvider]
    ...
    # Deserialize a JSON object to an instance of HumeCredential
    #
    ...
    # Serialize an instance of HumeCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::HumeCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
