...
module Vapi
  # This is the voice to use for the consent message. If not specified, inherits
  #  from the assistant's voice.
  #  Use a different voice for the consent message for a better user experience.
  class RecordingConsentPlanStayOnLineVoice
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::RecordingConsentPlanStayOnLineVoice]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of RecordingConsentPlanStayOnLineVoice
    #
