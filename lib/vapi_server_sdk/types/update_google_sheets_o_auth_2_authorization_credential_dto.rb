...
module Vapi
  class UpdateGoogleSheetsOAuth2AuthorizationCredentialDto
  ...
  # @return [Object] 
    ...
    # @return [Vapi::UpdateGoogleSheetsOAuth2AuthorizationCredentialDto]
    def initialize(authorization_id: OMIT, name: OMIT, additional_properties: nil)
      @authorization_id = authorization_id if authorization_id != OMIT
...
# Serialize an instance of UpdateGoogleSheetsOAuth2AuthorizationCredentialDto to a
#  JSON object
    #
    # @return [String]
    def to_json
