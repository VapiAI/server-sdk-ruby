...
module Vapi
  class BuyPhoneNumberDto
    # @return [Vapi::BuyPhoneNumberDtoFallbackDestination] This is the fallback destination an inbound call will be transferred to if:
    ...
    # @param fallback_destination [Vapi::BuyPhoneNumberDtoFallbackDestination] This is the fallback destination an inbound call will be transferred to if:
    #  1. `assistantId` is not set
    #  2. `squadId` is not set
    #  3. and, `assistant-request` message to the `serverUrl` fails
    #  If this is not set and above conditions are met, the inbound call is hung up
    #  with an error message.
    # @param area_code [String] This is the area code of the phone number to purchase.
    ...
    # Deserialize a JSON object to an instance of BuyPhoneNumberDto
    #
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["fallbackDestination"].nil?
        ...
        fallback_destination = Vapi::BuyPhoneNumberDtoFallbackDestination.from_json(json_object: fallback_destination)
      end
      area_code = parsed_json["areaCode"]
    ...
    # Serialize an instance of BuyPhoneNumberDto to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.fallback_destination.nil? || Vapi::BuyPhoneNumberDtoFallbackDestination.validate_raw(obj: obj.fallback_destination)
      obj.area_code.is_a?(String) != false || raise("Passed value for field obj.area_code is not the expected type, validation failed.")
