...
require_relative "client_message_metadata_type"
...
module Vapi
  class ClientMessageMetadata
    ...
    # @return [Vapi::ClientMessageMetadataType] This is the type of the message. "metadata" is sent to forward metadata to the
    #  client.
    attr_reader :type
    ...
    # @param type [Vapi::ClientMessageMetadataType] This is the type of the message. "metadata" is sent to forward metadata to the
    #  client.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::ClientMessageMetadataType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
