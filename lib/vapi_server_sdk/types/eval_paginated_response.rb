...
module Vapi
  class EvalPaginatedResponse
    # @return [Array<Vapi::Eval>]
    attr_reader :results
    ...
    # Deserialize a JSON object to an instance of EvalPaginatedResponse
    #
    ...
    def self.from_json(json_object:)
      ...
      results = parsed_json["results"]&.map do |item|
        item = item.to_json
        Vapi::Eval.from_json(json_object: item)
      end
    ...
    # Serialize an instance of EvalPaginatedResponse to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
