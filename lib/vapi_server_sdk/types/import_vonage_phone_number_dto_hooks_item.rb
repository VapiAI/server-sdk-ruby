...
module Vapi
  class ImportVonagePhoneNumberDtoHooksItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::ImportVonagePhoneNumberDtoHooksItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of ImportVonagePhoneNumberDtoHooksItem
    #
