...
require_relative "vapi_phone_number_hooks_item"
require "date"
...
module Vapi
  class VapiPhoneNumber
    ...
    # @return [Array<Vapi::VapiPhoneNumberHooksItem>] This is the hooks that will be used for incoming calls to this phone number.
    attr_reader :hooks
    ...
    #  If this is not set and above conditions are met, the inbound call is hung up
    #  with an error message.
    # @param hooks [Array<Vapi::VapiPhoneNumberHooksItem>] This is the hooks that will be used for incoming calls to this phone number.
    ...
    def self.from_json(json_object:)
      ...
      hooks = parsed_json["hooks"]&.map do |item|
        item = item.to_json
        Vapi::VapiPhoneNumberHooksItem.from_json(json_object: item)
      end
      id = parsed_json["id"]
