...
#  accepted.
    ...
    def initialize(fallback_destination: OMIT, hooks: OMIT, id:, org_id:, created_at:, updated_at:, status: OMIT, number: OMIT, name: OMIT, assistant_id: OMIT, workflow_id: OMIT, squad_id: OMIT, server: OMIT, number_desired_area_code: OMIT, sip_uri: OMIT, authentication: OMIT, additional_properties: nil)
      ...
      @_field_set = { "fallbackDestination": fallback_destination, "hooks": hooks, "id": id, "orgId": org_id, "createdAt": created_at, "updatedAt": updated_at, "status": status, "number": number, "name": name, "assistantId": assistant_id, "workflowId": workflow_id, "squadId": squad_id, "server": server, "numberDesiredAreaCode": number_desired_area_code, "sipUri": sip_uri, "authentication": authentication }.reject do | _k, v |
  v == OMIT
end
    end
