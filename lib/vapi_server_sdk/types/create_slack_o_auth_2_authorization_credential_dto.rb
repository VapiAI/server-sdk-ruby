...
module Vapi
  class CreateSlackOAuth2AuthorizationCredentialDto
    ...
    # @return [Vapi::CreateSlackOAuth2AuthorizationCredentialDto]
    ...
    # Serialize an instance of CreateSlackOAuth2AuthorizationCredentialDto to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
