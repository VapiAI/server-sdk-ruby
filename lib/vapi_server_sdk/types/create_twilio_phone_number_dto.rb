...
#  3. org.server
    ...
    def initialize(fallback_destination: OMIT, hooks: OMIT, sms_enabled: OMIT, number:, twilio_account_sid:, twilio_auth_token: OMIT, twilio_api_key: OMIT, twilio_api_secret: OMIT, name: OMIT, assistant_id: OMIT, workflow_id: OMIT, squad_id: OMIT, server: OMIT, additional_properties: nil)
      ...
      @_field_set = { "fallbackDestination": fallback_destination, "hooks": hooks, "smsEnabled": sms_enabled, "number": number, "twilioAccountSid": twilio_account_sid, "twilioAuthToken": twilio_auth_token, "twilioApiKey": twilio_api_key, "twilioApiSecret": twilio_api_secret, "name": name, "assistantId": assistant_id, "workflowId": workflow_id, "squadId": squad_id, "server": server }.reject do | _k, v |
  v == OMIT
end
    end
