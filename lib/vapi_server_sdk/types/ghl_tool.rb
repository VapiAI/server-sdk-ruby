...
#  `messages[].conditions` matches the "reason" argument.
    ...
    # @return [Vapi::GhlTool]
    def initialize(messages: OMIT, id:, org_id:, created_at:, updated_at:, function: OMIT, metadata:, additional_properties: nil)
      ...
      @_field_set = { "messages": messages, "id": id, "orgId": org_id, "createdAt": created_at, "updatedAt": updated_at, "function": function, "metadata": metadata }.reject do | _k, v |
  v == OMIT
end
    end
