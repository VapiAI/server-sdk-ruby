...
require_relative "ghl_tool_messages_item"
require_relative "ghl_tool_type"
require "date"
...
module Vapi
  class GhlTool
    # @return [Array<Vapi::GhlToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    attr_reader :messages
    # @return [Vapi::GhlToolType] The type of tool. "ghl" for GHL tool.
    attr_reader :type
    ...
    # @param messages [Array<Vapi::GhlToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param type [Vapi::GhlToolType] The type of tool. "ghl" for GHL tool.
    ...
    # @return [Vapi::GhlTool]
    def initialize(type:, id:, org_id:, created_at:, updated_at:, metadata:, messages: OMIT, rejection_plan: OMIT,
    ...
    # Deserialize a JSON object to an instance of GhlTool
    #
    ...
    # Serialize an instance of GhlTool to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::GhlToolType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
