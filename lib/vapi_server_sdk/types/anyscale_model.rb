...
require_relative "anyscale_model_tools_item"
...
module Vapi
  ...
  # @return [Array<Vapi::AnyscaleModelToolsItem>] These are the tools that the assistant can use during the call. To use existing
#  tools, use `toolIds`.
...
#  @default 0
  ...
  # @return [Object] 
    ...
    # @param tools [Array<Vapi::AnyscaleModelToolsItem>] These are the tools that the assistant can use during the call. To use existing
#  tools, use `toolIds`.
#  Both `tools` and `toolIds` can be used together.
