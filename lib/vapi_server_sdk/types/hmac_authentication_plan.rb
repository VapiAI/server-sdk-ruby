...
#  Defaults to false.
    ...
    def initialize(secret_key:, algorithm:, signature_header: OMIT, timestamp_header: OMIT, signature_prefix: OMIT, include_timestamp: OMIT, payload_format: OMIT, message_id_header: OMIT, signature_encoding: OMIT, secret_is_base_64: OMIT, additional_properties: nil)
      ...
      @_field_set = { "secretKey": secret_key, "algorithm": algorithm, "signatureHeader": signature_header, "timestampHeader": timestamp_header, "signaturePrefix": signature_prefix, "includeTimestamp": include_timestamp, "payloadFormat": payload_format, "messageIdHeader": message_id_header, "signatureEncoding": signature_encoding, "secretIsBase64": secret_is_base_64 }.reject do | _k, v |
  v == OMIT
end
    end
