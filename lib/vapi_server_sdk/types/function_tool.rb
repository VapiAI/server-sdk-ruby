...
#  `messages[].conditions` matches the "reason" argument.
    ...
    def initialize(messages: OMIT, async: OMIT, server: OMIT, id:, org_id:, created_at:, updated_at:, function: OMIT, additional_properties: nil)
      ...
      @_field_set = { "messages": messages, "async": async, "server": server, "id": id, "orgId": org_id, "createdAt": created_at, "updatedAt": updated_at, "function": function }.reject do | _k, v |
  v == OMIT
end
    end
