...
module Vapi
  ...
  class WorkflowUserEditableTranscriber
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::WorkflowUserEditableTranscriber]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of WorkflowUserEditableTranscriber
    #
