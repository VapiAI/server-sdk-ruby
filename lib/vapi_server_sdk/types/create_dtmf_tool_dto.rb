...
require_relative "create_dtmf_tool_dto_messages_item"
...
module Vapi
  class CreateDtmfToolDto
    # @return [Array<Vapi::CreateDtmfToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    ...
    # @param messages [Array<Vapi::CreateDtmfToolDtoMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::CreateDtmfToolDtoMessagesItem.from_json(json_object: item)
      end
