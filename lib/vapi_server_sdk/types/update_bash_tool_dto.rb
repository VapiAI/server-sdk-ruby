...
require_relative "update_bash_tool_dto_sub_type"
require_relative "server"
require_relative "tool_rejection_plan"
require_relative "update_bash_tool_dto_name"
require "ostruct"
require "json"
...
module Vapi
  class UpdateBashToolDto
    ...
    # @return [Vapi::UpdateBashToolDtoSubType] The sub type of tool.
    ...
    # @return [Vapi::UpdateBashToolDtoName] The name of the tool, fixed to 'bash'
    attr_reader :name
    ...
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param sub_type [Vapi::UpdateBashToolDtoSubType] The sub type of tool.
    ...
    #  }
    #  ```
    # @param name [Vapi::UpdateBashToolDtoName] The name of the tool, fixed to 'bash'
    ...
    def self.validate_raw(obj:)
      ...
      obj.sub_type&.is_a?(Vapi::UpdateBashToolDtoSubType) != false || raise("Passed value for field obj.sub_type is not the expected type, validation failed.")
      obj.server.nil? || Vapi::Server.validate_raw(obj: obj.server)
      obj.rejection_plan.nil? || Vapi::ToolRejectionPlan.validate_raw(obj: obj.rejection_plan)
      obj.name&.is_a?(Vapi::UpdateBashToolDtoName) != false || raise("Passed value for field obj.name is not the expected type, validation failed.")
    end
  end
end
