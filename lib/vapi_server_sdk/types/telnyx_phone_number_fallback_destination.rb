...
module Vapi
  ...
  class TelnyxPhoneNumberFallbackDestination
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::TelnyxPhoneNumberFallbackDestination]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of TelnyxPhoneNumberFallbackDestination
    #
