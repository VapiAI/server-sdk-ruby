...
#  @default undefined
    ...
    def initialize(enabled: OMIT, number_to_digits_cutoff: OMIT, replacements: OMIT, formatters_enabled: OMIT, additional_properties: nil)
      ...
      @_field_set = { "enabled": enabled, "numberToDigitsCutoff": number_to_digits_cutoff, "replacements": replacements, "formattersEnabled": formatters_enabled }.reject do | _k, v |
  v == OMIT
end
    end
