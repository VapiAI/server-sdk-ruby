...
require_relative "deep_infra_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class DeepInfraCredential
    # @return [Vapi::DeepInfraCredentialProvider]
    ...
    # @param provider [Vapi::DeepInfraCredentialProvider]
    ...
    # @return [Vapi::DeepInfraCredential]
    ...
    # Deserialize a JSON object to an instance of DeepInfraCredential
    #
    ...
    # Serialize an instance of DeepInfraCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::DeepInfraCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
