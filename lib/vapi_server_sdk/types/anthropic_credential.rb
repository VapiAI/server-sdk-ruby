...
require_relative "anthropic_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class AnthropicCredential
    # @return [Vapi::AnthropicCredentialProvider]
    ...
    # @param provider [Vapi::AnthropicCredentialProvider]
    ...
    # @return [Vapi::AnthropicCredential]
    ...
    # Deserialize a JSON object to an instance of AnthropicCredential
    #
    ...
    # Serialize an instance of AnthropicCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::AnthropicCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
