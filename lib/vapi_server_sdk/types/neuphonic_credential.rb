...
require_relative "neuphonic_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class NeuphonicCredential
    # @return [Vapi::NeuphonicCredentialProvider]
    ...
    # @param provider [Vapi::NeuphonicCredentialProvider]
    ...
    # @return [Vapi::NeuphonicCredential]
    ...
    # Deserialize a JSON object to an instance of NeuphonicCredential
    #
    ...
    # Serialize an instance of NeuphonicCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::NeuphonicCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
