...
module Vapi
  class TransferPlan
    ...
    def initialize(mode:, message: OMIT, sip_verb: OMIT, hold_audio_url: OMIT, twiml: OMIT, summary_plan: OMIT,
                   sip_headers_in_refer_to_enabled: OMIT, fallback_plan: OMIT, additional_properties: nil)
      @mode = mode
