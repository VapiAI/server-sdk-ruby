...
module Vapi
  class AssistantOverridesToolsAppendItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::AssistantOverridesToolsAppendItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of AssistantOverridesToolsAppendItem
    #
