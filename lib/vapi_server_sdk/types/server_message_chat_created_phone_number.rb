...
module Vapi
  ...
  class ServerMessageChatCreatedPhoneNumber
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::ServerMessageChatCreatedPhoneNumber]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of ServerMessageChatCreatedPhoneNumber
    #
