...
require_relative "anyscale_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class AnyscaleCredential
    # @return [Vapi::AnyscaleCredentialProvider]
    ...
    # @param provider [Vapi::AnyscaleCredentialProvider]
    ...
    # @return [Vapi::AnyscaleCredential]
    ...
    # Deserialize a JSON object to an instance of AnyscaleCredential
    #
    ...
    # Serialize an instance of AnyscaleCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::AnyscaleCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
