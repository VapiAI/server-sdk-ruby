...
require_relative "server_message_user_interrupted_type"
...
module Vapi
  class ServerMessageUserInterrupted
    # @return [Vapi::ServerMessageUserInterruptedPhoneNumber] This is the phone number that the message is associated with.
    attr_reader :phone_number
    # @return [Vapi::ServerMessageUserInterruptedType] This is the type of the message. "user-interrupted" is sent when the user
    ...
    # @param phone_number [Vapi::ServerMessageUserInterruptedPhoneNumber] This is the phone number that the message is associated with.
    # @param type [Vapi::ServerMessageUserInterruptedType] This is the type of the message. "user-interrupted" is sent when the user
    #  interrupts the assistant.
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::ServerMessageUserInterruptedType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
