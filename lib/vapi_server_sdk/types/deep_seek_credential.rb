...
require_relative "deep_seek_credential_provider"
require "date"
require "ostruct"
require "json"
...
module Vapi
  class DeepSeekCredential
    # @return [Vapi::DeepSeekCredentialProvider]
    ...
    # @param provider [Vapi::DeepSeekCredentialProvider]
    ...
    # Deserialize a JSON object to an instance of DeepSeekCredential
    #
    ...
    # Serialize an instance of DeepSeekCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::DeepSeekCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
