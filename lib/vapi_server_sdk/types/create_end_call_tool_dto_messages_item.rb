...
module Vapi
  class CreateEndCallToolDtoMessagesItem
    # @return [Object]
    attr_reader :member
    # @return [String]
    ...
    # @return [Vapi::CreateEndCallToolDtoMessagesItem]
    def initialize(member:, discriminant:)
      @member = member
      @discriminant = discriminant
    end

    # Deserialize a JSON object to an instance of CreateEndCallToolDtoMessagesItem
    #
