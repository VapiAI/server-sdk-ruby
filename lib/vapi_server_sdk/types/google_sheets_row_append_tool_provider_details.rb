...
module Vapi
  class GoogleSheetsRowAppendToolProviderDetails
    ...
    # @return [Vapi::GoogleSheetsRowAppendToolProviderDetails]
    ...
    # Serialize an instance of GoogleSheetsRowAppendToolProviderDetails to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
