...
#  @default '/'
    ...
    def initialize(recording_enabled: OMIT, recording_format: OMIT, video_recording_enabled: OMIT, pcap_enabled: OMIT, pcap_s_3_path_prefix: OMIT, transcript_plan: OMIT, recording_path: OMIT, additional_properties: nil)
      ...
      @_field_set = { "recordingEnabled": recording_enabled, "recordingFormat": recording_format, "videoRecordingEnabled": video_recording_enabled, "pcapEnabled": pcap_enabled, "pcapS3PathPrefix": pcap_s_3_path_prefix, "transcriptPlan": transcript_plan, "recordingPath": recording_path }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of ArtifactPlan
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["transcriptPlan"].nil?
