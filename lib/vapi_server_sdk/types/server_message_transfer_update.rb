...
#  if `destination.type` is "assistant".
    ...
    def initialize(phone_number: OMIT, type:, destination: OMIT, timestamp: OMIT, artifact: OMIT, assistant: OMIT, customer: OMIT, call: OMIT, to_assistant: OMIT, from_assistant: OMIT, to_step_record: OMIT, from_step_record: OMIT, additional_properties: nil)
      ...
      @_field_set = { "phoneNumber": phone_number, "type": type, "destination": destination, "timestamp": timestamp, "artifact": artifact, "assistant": assistant, "customer": customer, "call": call, "toAssistant": to_assistant, "fromAssistant": from_assistant, "toStepRecord": to_step_record, "fromStepRecord": from_step_record }.reject do | _k, v |
  v == OMIT
end
    end
