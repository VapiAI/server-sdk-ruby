...
#  Set to `true` to not receive partial transcripts. Defaults to `false`.
    ...
    def initialize(language: OMIT, confidence_threshold: OMIT, enable_universal_streaming_api: OMIT, realtime_url: OMIT, word_boost: OMIT, end_utterance_silence_threshold: OMIT, disable_partial_transcripts: OMIT, additional_properties: nil)
