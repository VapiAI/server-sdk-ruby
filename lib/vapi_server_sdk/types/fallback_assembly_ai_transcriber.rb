...
#  Set to `true` to not receive partial transcripts. Defaults to `false`.
    ...
    def initialize(language: OMIT, confidence_threshold: OMIT, enable_universal_streaming_api: OMIT, format_turns: OMIT, end_of_turn_confidence_threshold: OMIT, min_end_of_turn_silence_when_confident: OMIT, word_finalization_max_wait_time: OMIT, max_turn_silence: OMIT, realtime_url: OMIT, word_boost: OMIT, end_utterance_silence_threshold: OMIT, disable_partial_transcripts: OMIT, additional_properties: nil)
      ...
      @min_end_of_turn_silence_when_confident = min_end_of_turn_silence_when_confident if min_end_of_turn_silence_when_confident != OMIT
