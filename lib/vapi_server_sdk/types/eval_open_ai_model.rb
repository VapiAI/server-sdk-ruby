...
require_relative "eval_open_ai_model_model"
require "ostruct"
require "json"

module Vapi
  class EvalOpenAiModel
    # @return [Vapi::EvalOpenAiModelModel] This is the OpenAI model that will be used.
    ...
    # @param model [Vapi::EvalOpenAiModelModel] This is the OpenAI model that will be used.
    #  When using Vapi OpenAI or your own Azure Credentials, you have the option to
    #  specify the region for the selected model. This shouldn't be specified unless
    #  you have a specific reason to do so. Vapi will automatically find the fastest
    #  region that make sense.
    ...
    # Deserialize a JSON object to an instance of EvalOpenAiModel
    #
    ...
    # Serialize an instance of EvalOpenAiModel to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.model.is_a?(Vapi::EvalOpenAiModelModel) != false || raise("Passed value for field obj.model is not the expected type, validation failed.")
