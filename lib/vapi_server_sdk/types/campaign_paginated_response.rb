...
module Vapi
  class CampaignPaginatedResponse
    # @return [Array<Vapi::Campaign>]
    attr_reader :results
    ...
    # @param results [Array<Vapi::Campaign>]
    ...
    # Deserialize a JSON object to an instance of CampaignPaginatedResponse
    #
    ...
    def self.from_json(json_object:)
      ...
      results = parsed_json["results"]&.map do |item|
        item = item.to_json
        Vapi::Campaign.from_json(json_object: item)
      end
    ...
    # Serialize an instance of CampaignPaginatedResponse to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
