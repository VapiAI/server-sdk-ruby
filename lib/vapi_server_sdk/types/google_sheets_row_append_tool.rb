...
require_relative "google_sheets_row_append_tool_messages_item"
require "date"
require "date"
...
module Vapi
  class GoogleSheetsRowAppendTool
  # @return [Array<Vapi::GoogleSheetsRowAppendToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
...
#  `messages[].conditions` matches the "reason" argument.
  ...
  # @return [Object] 
    ...
    # @param messages [Array<Vapi::GoogleSheetsRowAppendToolMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
#  For some tools, this is auto-filled based on special fields like
#  `tool.destinations`. For others like the function tool, these can be custom
#  configured.
...
#  `messages[].conditions` matches the "reason" argument.
    ...
    # @return [Vapi::GoogleSheetsRowAppendTool]
...
# Deserialize a JSON object to an instance of GoogleSheetsRowAppendTool
    #
  ...
  item = item.to_json
  Vapi::GoogleSheetsRowAppendToolMessagesItem.from_json(json_object: item)
end
      id = parsed_json["id"]
...
# Serialize an instance of GoogleSheetsRowAppendTool to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
