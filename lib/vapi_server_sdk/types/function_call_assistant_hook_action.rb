...
require_relative "function_call_assistant_hook_action_messages_item"
...
module Vapi
  class FunctionCallAssistantHookAction
    ...
    attr_reader :async
    # @return [Array<Vapi::FunctionCallAssistantHookActionMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    ...
    #  want assistant to respond with the result from your server.
    #  Defaults to synchronous (`false`).
    # @param messages [Array<Vapi::FunctionCallAssistantHookActionMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    ...
    # @return [Vapi::FunctionCallAssistantHookAction]
    ...
    # Deserialize a JSON object to an instance of FunctionCallAssistantHookAction
    #
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::FunctionCallAssistantHookActionMessagesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of FunctionCallAssistantHookAction to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
