...
module Vapi
  ...
  class OpenAiWebChatRequestInput
    # Deserialize a JSON object to an instance of OpenAiWebChatRequestInput
    #
    # @param json_object [String]
    # @return [Vapi::OpenAiWebChatRequestInput]
    def self.from_json(json_object:)
      ...
      begin
        ...
        return struct&.map do |item|
          item = item.to_json
          Vapi::OpenAiWebChatRequestInputOneItem.from_json(json_object: item)
        end
      rescue StandardError
        # noop
      end
