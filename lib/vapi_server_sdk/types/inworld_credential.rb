...
require_relative "inworld_credential_provider"
require "date"
require "ostruct"
require "json"

module Vapi
  class InworldCredential
    # @return [Vapi::InworldCredentialProvider]
    attr_reader :provider
    # @return [String] This is the Inworld Basic (Base64) authentication token. This is not returned in
    #  the API.
    attr_reader :api_key
    ...
    # @param provider [Vapi::InworldCredentialProvider]
    # @param api_key [String] This is the Inworld Basic (Base64) authentication token. This is not returned in
    #  the API.
    ...
    # Deserialize a JSON object to an instance of InworldCredential
    #
    ...
    # Serialize an instance of InworldCredential to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      obj.provider.is_a?(Vapi::InworldCredentialProvider) != false || raise("Passed value for field obj.provider is not the expected type, validation failed.")
