...
module Vapi
  ...
  class WorkflowVoicemailDetection
    # Deserialize a JSON object to an instance of WorkflowVoicemailDetection
    #
    # @param json_object [String]
    # @return [Vapi::WorkflowVoicemailDetection]
    def self.from_json(json_object:)
      struct = JSON.parse(json_object, object_class: OpenStruct)
      begin
        struct.is_a?(Vapi::WorkflowVoicemailDetectionZero) != false || raise("Passed value for field struct is not the expected type, validation failed.")
    ...
    def self.validate_raw(obj:)
      begin
        return obj.is_a?(Vapi::WorkflowVoicemailDetectionZero) != false || raise("Passed value for field obj is not the expected type, validation failed.")
      rescue StandardError
        # noop
      end
      begin
