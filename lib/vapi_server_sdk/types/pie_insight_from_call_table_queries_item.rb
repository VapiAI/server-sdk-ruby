...
module Vapi
  class PieInsightFromCallTableQueriesItem
    # Deserialize a JSON object to an instance of PieInsightFromCallTableQueriesItem
    #
    # @param json_object [String]
    # @return [Vapi::PieInsightFromCallTableQueriesItem]
