...
require_relative "go_high_level_contact_get_tool_with_tool_call_messages_item"
require_relative "go_high_level_contact_get_tool_with_tool_call_type"
...
module Vapi
  class GoHighLevelContactGetToolWithToolCall
    # @return [Array<Vapi::GoHighLevelContactGetToolWithToolCallMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    attr_reader :messages
    # @return [Vapi::GoHighLevelContactGetToolWithToolCallType] The type of tool. "gohighlevel.contact.get" for GoHighLevel Contact Get tool.
    attr_reader :type
    ...
    # @param messages [Array<Vapi::GoHighLevelContactGetToolWithToolCallMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param type [Vapi::GoHighLevelContactGetToolWithToolCallType] The type of tool. "gohighlevel.contact.get" for GoHighLevel Contact Get tool.
    ...
    # @return [Vapi::GoHighLevelContactGetToolWithToolCall]
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::GoHighLevelContactGetToolWithToolCallMessagesItem.from_json(json_object: item)
      end
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::GoHighLevelContactGetToolWithToolCallType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
