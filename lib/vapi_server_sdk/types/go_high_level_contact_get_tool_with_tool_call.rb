...
module Vapi
  class GoHighLevelContactGetToolWithToolCall
    ...
    # @return [String] The type of tool. "gohighlevel.contact.get" for GoHighLevel contact get tool.
    attr_reader :type
    ...
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param type [String] The type of tool. "gohighlevel.contact.get" for GoHighLevel contact get tool.
