...
module Vapi
  class MonitorPlan
    ...
    def initialize(listen_enabled: OMIT, listen_authentication_enabled: OMIT, control_enabled: OMIT,
                   control_authentication_enabled: OMIT, additional_properties: nil)
      ...
      @_field_set = {
        ...
        "listenAuthenticationEnabled": listen_authentication_enabled,
        "controlEnabled": control_enabled,
        "controlAuthenticationEnabled": control_authentication_enabled
      }.reject do |_k, v|
        v == OMIT
      end
    end
