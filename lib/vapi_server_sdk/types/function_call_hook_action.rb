...
require_relative "function_call_hook_action_messages_item"
require_relative "function_call_hook_action_type"
...
module Vapi
  class FunctionCallHookAction
    # @return [Array<Vapi::FunctionCallHookActionMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    attr_reader :messages
    # @return [Vapi::FunctionCallHookActionType] The type of tool. "function" for Function tool.
    attr_reader :type
    ...
    # @param messages [Array<Vapi::FunctionCallHookActionMessagesItem>] These are the messages that will be spoken to the user as the tool is running.
    #  For some tools, this is auto-filled based on special fields like
    #  `tool.destinations`. For others like the function tool, these can be custom
    #  configured.
    # @param type [Vapi::FunctionCallHookActionType] The type of tool. "function" for Function tool.
    ...
    # @return [Vapi::FunctionCallHookAction]
    def initialize(type:, messages: OMIT, async: OMIT, server: OMIT, rejection_plan: OMIT, function: OMIT,
    ...
    # Deserialize a JSON object to an instance of FunctionCallHookAction
    #
    ...
    def self.from_json(json_object:)
      ...
      messages = parsed_json["messages"]&.map do |item|
        item = item.to_json
        Vapi::FunctionCallHookActionMessagesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of FunctionCallHookAction to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::FunctionCallHookActionType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
