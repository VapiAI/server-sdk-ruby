...
require_relative "server_message_model_output_type"
...
module Vapi
  class ServerMessageModelOutput
    ...
    # @return [Vapi::ServerMessageModelOutputType] This is the type of the message. "model-output" is sent as the model outputs
    #  tokens.
    attr_reader :type
    ...
    # @param type [Vapi::ServerMessageModelOutputType] This is the type of the message. "model-output" is sent as the model outputs
    #  tokens.
    ...
    def initialize(type:, output:, phone_number: OMIT, timestamp: OMIT, artifact: OMIT, assistant: OMIT, customer: OMIT,
    ...
    def self.validate_raw(obj:)
      ...
      obj.type.is_a?(Vapi::ServerMessageModelOutputType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
