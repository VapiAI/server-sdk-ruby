...
require "json"
require_relative "../../types/call_hook_call_ending"
require_relative "../../types/call_hook_assistant_speech_interrupted"
require_relative "../../types/call_hook_customer_speech_interrupted"
require_relative "../../types/call_hook_customer_speech_timeout"

module Vapi
  class Assistants
    class UpdateAssistantDtoHooksItem
      # Deserialize a JSON object to an instance of UpdateAssistantDtoHooksItem
      #
      # @param json_object [String]
      # @return [Vapi::Assistants::UpdateAssistantDtoHooksItem]
