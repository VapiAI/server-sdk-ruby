...
require "date"
require_relative "types/list_phone_numbers_response_item"
require "json"
require_relative "types/create_phone_numbers_request"
require_relative "types/create_phone_numbers_response"
require_relative "types/phone_number_controller_find_all_paginated_request_sort_order"
require_relative "../types/phone_number_paginated_response"
require_relative "types/get_phone_numbers_response"
require_relative "types/delete_phone_numbers_response"
require_relative "types/update_phone_numbers_request_body"
require_relative "types/update_phone_numbers_response"
require "async"
...
module Vapi
  class PhoneNumbersClient
    ...
    # @return [Array<Vapi::PhoneNumbers::ListPhoneNumbersResponseItem>]
    def list(limit: nil, created_at_gt: nil, created_at_lt: nil, created_at_ge: nil, created_at_le: nil,
      ...
      **(request_options&.additional_headers || {})
      ...
      parsed_json&.map do |item|
        item = item.to_json
        Vapi::PhoneNumbers::ListPhoneNumbersResponseItem.from_json(json_object: item)
      end
    end

    # @param request [Vapi::PhoneNumbers::CreatePhoneNumbersRequest]
    # @param request_options [Vapi::RequestOptions]
    # @return [Vapi::PhoneNumbers::CreatePhoneNumbersResponse]
    def create(request:, request_options: nil)
      ...
      **(request_options&.additional_headers || {})
      ...
      Vapi::PhoneNumbers::CreatePhoneNumbersResponse.from_json(json_object: response.body)
    end

    # @param search [String] This will search phone numbers by name, number, or SIP URI (partial match,
    #  case-insensitive).
    # @param page [Float] This is the page number to return. Defaults to 1.
    # @param sort_order [Vapi::PhoneNumbers::PhoneNumberControllerFindAllPaginatedRequestSortOrder] This is the sort order for pagination. Defaults to 'DESC'.
    # @param limit [Float] This is the maximum number of items to return. Defaults to 100.
    # @param created_at_gt [DateTime] This will return items where the createdAt is greater than the specified value.
    # @param created_at_lt [DateTime] This will return items where the createdAt is less than the specified value.
    # @param created_at_ge [DateTime] This will return items where the createdAt is greater than or equal to the
    ...
    def phone_number_controller_find_all_paginated(search: nil, page: nil, sort_order: nil, limit: nil,
      ...
      **(request_options&.additional_headers || {})
        ...
        req.url "#{@request_client.get_url(request_options: request_options)}/v2/phone-number"
      end
      Vapi::PhoneNumberPaginatedResponse.from_json(json_object: response.body)
    end
    ...
    def get(id:, request_options: nil)
      ...
      **(request_options&.additional_headers || {})
      ...
      Vapi::PhoneNumbers::GetPhoneNumbersResponse.from_json(json_object: response.body)
    end

    # @param id [String]
    # @param request_options [Vapi::RequestOptions]
    # @return [Vapi::PhoneNumbers::DeletePhoneNumbersResponse]
    def delete(id:, request_options: nil)
      ...
      **(request_options&.additional_headers || {})
      ...
      Vapi::PhoneNumbers::DeletePhoneNumbersResponse.from_json(json_object: response.body)
    end

    # @param id [String]
    # @param request [Vapi::PhoneNumbers::UpdatePhoneNumbersRequestBody]
    # @param request_options [Vapi::RequestOptions]
    # @return [Vapi::PhoneNumbers::UpdatePhoneNumbersResponse]
    def update(id:, request:, request_options: nil)
      ...
      **(request_options&.additional_headers || {})
      ...
      Vapi::PhoneNumbers::UpdatePhoneNumbersResponse.from_json(json_object: response.body)
    end
  end
