...
module Vapi
  class PhoneNumbers
    class CreatePhoneNumbersRequest
      # @return [Object]
      attr_reader :member
      # @return [String]
      ...
      # @return [Vapi::PhoneNumbers::CreatePhoneNumbersRequest]
      def initialize(member:, discriminant:)
        @member = member
        @discriminant = discriminant
      end

      # Deserialize a JSON object to an instance of CreatePhoneNumbersRequest
      #
