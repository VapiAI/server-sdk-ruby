...
# Deserialize a JSON object to an instance of PhoneNumbersUpdateRequest
      ...
      def self.from_json(json_object:)
        ...
        when "byo-phone-number"
          member = Vapi::UpdateByoPhoneNumberDto.from_json(json_object: json_object)
        when "twilio"
          member = Vapi::UpdateTwilioPhoneNumberDto.from_json(json_object: json_object)
        when "vonage"
          member = Vapi::UpdateVonagePhoneNumberDto.from_json(json_object: json_object)
        when "vapi"
          member = Vapi::UpdateVapiPhoneNumberDto.from_json(json_object: json_object)
        when "telnyx"
          member = Vapi::UpdateTelnyxPhoneNumberDto.from_json(json_object: json_object)
        else
          member = Vapi::UpdateByoPhoneNumberDto.from_json(json_object: json_object)
        end
