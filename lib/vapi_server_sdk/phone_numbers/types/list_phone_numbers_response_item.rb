...
module Vapi
  class PhoneNumbers
    class ListPhoneNumbersResponseItem
      # @return [Object]
      attr_reader :member
      # @return [String]
      ...
      # @return [Vapi::PhoneNumbers::ListPhoneNumbersResponseItem]
      def initialize(member:, discriminant:)
        @member = member
        @discriminant = discriminant
      end

      # Deserialize a JSON object to an instance of ListPhoneNumbersResponseItem
      #
