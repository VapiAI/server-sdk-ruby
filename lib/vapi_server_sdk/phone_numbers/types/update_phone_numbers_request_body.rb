...
module Vapi
  class PhoneNumbers
    class UpdatePhoneNumbersRequestBody
      # @return [Object]
      attr_reader :member
      # @return [String]
      ...
      # @return [Vapi::PhoneNumbers::UpdatePhoneNumbersRequestBody]
      def initialize(member:, discriminant:)
        @member = member
        @discriminant = discriminant
      end

      # Deserialize a JSON object to an instance of UpdatePhoneNumbersRequestBody
      #
