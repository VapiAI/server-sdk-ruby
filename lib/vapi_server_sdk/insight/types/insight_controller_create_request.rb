...
module Vapi
  class Insight
    class InsightControllerCreateRequest
      # @return [Object]
      attr_reader :member
      # @return [String]
      ...
      # @return [Vapi::Insight::InsightControllerCreateRequest]
      def initialize(member:, discriminant:)
        @member = member
        @discriminant = discriminant
      end

      # Deserialize a JSON object to an instance of InsightControllerCreateRequest
      #
