...
#  specified value.
    ...
    def campaign_controller_find_all(id: nil, status: nil, page: nil, sort_order: nil, limit: nil, created_at_gt: nil, created_at_lt: nil, created_at_ge: nil, created_at_le: nil, updated_at_gt: nil, updated_at_lt: nil, updated_at_ge: nil, updated_at_le: nil, request_options: nil)
  ...
  req.params = { **(request_options&.additional_query_parameters || {}), "id": id, "status": status, "page": page, "sortOrder": sort_order, "limit": limit, "createdAtGt": created_at_gt, "createdAtLt": created_at_lt, "createdAtGe": created_at_ge, "createdAtLe": created_at_le, "updatedAtGt": updated_at_gt, "updatedAtLt": updated_at_lt, "updatedAtGe": updated_at_ge, "updatedAtLe": updated_at_le }.compact
...
#  assistantId or workflowId can be used, but not both.
    ...
    def campaign_controller_create(name:, assistant_id: nil, workflow_id: nil, phone_number_id:, schedule_plan: nil, customers:, request_options: nil)
  ...
  req.body = { **(request_options&.additional_body_parameters || {}), name: name, assistantId: assistant_id, workflowId: workflow_id, phoneNumberId: phone_number_id, schedulePlan: schedule_plan, customers: customers }.compact
  req.url "#{@request_client.get_url(request_options: request_options)}/campaign"
end
...
#  Can only be updated if campaign is not in progress or has ended.Request of type Vapi::SchedulePlan, as a Hash
    ...
    # @param request_options [Vapi::RequestOptions] 
    # @return [Vapi::Campaign]
    def campaign_controller_update(id:, name: nil, assistant_id: nil, workflow_id: nil, phone_number_id: nil, schedule_plan: nil, request_options: nil)
  ...
  req.body = { **(request_options&.additional_body_parameters || {}), "status": "ended", name: name, assistantId: assistant_id, workflowId: workflow_id, phoneNumberId: phone_number_id, schedulePlan: schedule_plan }.compact
  req.url "#{@request_client.get_url(request_options: request_options)}/campaign/#{id}"
end
      Vapi::Campaign.from_json(json_object: response.body)
    end
