...
module Vapi
  class Sessions
    class CreateSessionDtoMessagesItem
      # Deserialize a JSON object to an instance of CreateSessionDtoMessagesItem
      #
      # @param json_object [String]
      # @return [Vapi::Sessions::CreateSessionDtoMessagesItem]
