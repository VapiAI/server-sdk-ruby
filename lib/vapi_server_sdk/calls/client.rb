...
module Vapi
  class CallsClient
    ...
    #  - Squad, use `squad` or `squadId`
    #  - Workflow, use `workflow` or `workflowId`
    # @param workflow [Hash] [BETA] This feature is in active development. The API and behavior are subject
    #  to change as we refine it based on user feedback.
    ...
    def create(customers: nil, name: nil, schedule_plan: nil, transport: nil, assistant_id: nil, assistant: nil,
               assistant_overrides: nil, squad_id: nil, squad: nil, workflow_id: nil, workflow: nil, phone_number_id: nil, phone_number: nil, customer_id: nil, customer: nil, request_options: nil)
