...
#  specified value.
    ...
    def list(id: nil, assistant_id: nil, phone_number_id: nil, limit: nil, created_at_gt: nil, created_at_lt: nil, created_at_ge: nil, created_at_le: nil, updated_at_gt: nil, updated_at_lt: nil, updated_at_ge: nil, updated_at_le: nil, request_options: nil)
...
#  Only relevant for `outboundPhoneCall` and `inboundPhoneCall` type.Request of type Vapi::CreateCustomerDto, as a Hash
    ...
    def create(customers: nil, name: nil, schedule_plan: nil, transport: nil, assistant_id: nil, assistant: nil, assistant_overrides: nil, squad_id: nil, squad: nil, workflow_id: nil, workflow: nil, workflow_overrides: nil, phone_number_id: nil, phone_number: nil, customer_id: nil, customer: nil, request_options: nil)
  ...
  req.body = { **(request_options&.additional_body_parameters || {}), customers: customers, name: name, schedulePlan: schedule_plan, transport: transport, assistantId: assistant_id, assistant: assistant, assistantOverrides: assistant_overrides, squadId: squad_id, squad: squad, workflowId: workflow_id, workflow: workflow, workflowOverrides: workflow_overrides, phoneNumberId: phone_number_id, phoneNumber: phone_number, customerId: customer_id, customer: customer }.compact
  req.url "#{@request_client.get_url(request_options: request_options)}/call"
end
