...
#  specified value.
    ...
    def test_suite_controller_find_all_paginated(page: nil, sort_order: nil, limit: nil, created_at_gt: nil, created_at_lt: nil, created_at_ge: nil, created_at_le: nil, updated_at_gt: nil, updated_at_lt: nil, updated_at_ge: nil, updated_at_le: nil, request_options: nil)
...
#  tested.Request of type Vapi::TargetPlan, as a Hash
    ...
    def test_suite_controller_create(name: nil, phone_number_id: nil, tester_plan: nil, target_plan: nil, request_options: nil)
  ...
  req.body = { **(request_options&.additional_body_parameters || {}), name: name, phoneNumberId: phone_number_id, testerPlan: tester_plan, targetPlan: target_plan }.compact
  req.url "#{@request_client.get_url(request_options: request_options)}/test-suite"
end
...
#  tested.Request of type Vapi::TargetPlan, as a Hash
    ...
    # @param request_options [Vapi::RequestOptions] 
    # @return [Vapi::TestSuite]
    def test_suite_controller_update(id:, name: nil, phone_number_id: nil, tester_plan: nil, target_plan: nil, request_options: nil)
