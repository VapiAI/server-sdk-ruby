...
module Vapi
  module KnowledgeBases
    class KnowledgeBasesListResponseItem
    # @return [Object] 
      attr_reader :member
    # @return [String] 
      ...
      # @return [Vapi::KnowledgeBases::KnowledgeBasesListResponseItem]
      def initialize(member:, discriminant:)
        @member = member
        @discriminant = discriminant
      end
# Deserialize a JSON object to an instance of KnowledgeBasesListResponseItem
      #
      ...
      def self.from_json(json_object:)
        ...
        when "trieve"
          member = Vapi::TrieveKnowledgeBase.from_json(json_object: json_object)
        when "custom-knowledge-base"
          member = Vapi::CustomKnowledgeBase.from_json(json_object: json_object)
        else
          member = Vapi::TrieveKnowledgeBase.from_json(json_object: json_object)
        end
