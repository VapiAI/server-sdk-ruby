...
module Vapi
  class WorkflowClient
    ...
    # @param model [Vapi::Workflow::UpdateWorkflowDtoModel] These are the options for the workflow's LLM.
    # @param name [String]
    ...
    # @param request_options [Vapi::RequestOptions]
    # @return [Vapi::Workflow]
    def workflow_controller_update(id:, nodes: nil, model: nil, name: nil, edges: nil, request_options: nil)
