...
module Vapi
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/file"
end
      parsed_json = JSON.parse(response.body)
      parsed_json&.map do | item |
        item = item.to_json
        Vapi::File.from_json(json_object: item)
      end
    end
  ...
  req.body = { **(request_options&.additional_body_parameters || {}), file: Vapi::FileUtilities.as_faraday_multipart(file_like: file) }.compact
  req.url "#{@request_client.get_url(request_options: request_options)}/file"
end
      Vapi::File.from_json(json_object: response.body)
    end
    # @param id [String] 
    # @param request_options [Vapi::RequestOptions] 
    # @return [Vapi::File]
  ...
  req.url "#{@request_client.get_url(request_options: request_options)}/file/#{id}"
end
      Vapi::File.from_json(json_object: response.body)
    end
    # @param id [String] 
