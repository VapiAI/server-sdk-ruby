...
require_relative "../../types/create_handoff_tool_dto"
...
module Vapi
  class Tools
    class CreateToolsRequest
      ...
      # @return [Vapi::Tools::CreateToolsRequest]
      def initialize(member:, discriminant:)
        @member = member
        @discriminant = discriminant
      end

      # Deserialize a JSON object to an instance of CreateToolsRequest
      #
