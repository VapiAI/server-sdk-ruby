...
require_relative "../../types/update_handoff_tool_dto"
...
module Vapi
  class Tools
    class UpdateToolsRequestBody
      ...
      # @return [Vapi::Tools::UpdateToolsRequestBody]
      def initialize(member:, discriminant:)
        @member = member
        @discriminant = discriminant
      end

      # Deserialize a JSON object to an instance of UpdateToolsRequestBody
      #
      ...
      def self.from_json(json_object:)
        ...
        member = case struct.type
                 ...
                 when "handoff"
                   Vapi::UpdateHandoffToolDto.from_json(json_object: json_object)
                 when "bash"
      ...
      def self.validate_raw(obj:)
        ...
        when "handoff"
          Vapi::UpdateHandoffToolDto.validate_raw(obj: obj)
        when "bash"
      ...
      # @param member [Vapi::UpdateHandoffToolDto]
      # @return [Vapi::Tools::UpdateToolsRequestBody]
