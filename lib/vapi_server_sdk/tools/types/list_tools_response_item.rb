...
require_relative "../../types/handoff_tool"
...
module Vapi
  class Tools
    class ListToolsResponseItem
      ...
      # @return [Vapi::Tools::ListToolsResponseItem]
      def initialize(member:, discriminant:)
        @member = member
        @discriminant = discriminant
      end

      # Deserialize a JSON object to an instance of ListToolsResponseItem
      #
      ...
      def self.from_json(json_object:)
        ...
        member = case struct.type
                 when "apiRequest"
                   Vapi::ApiRequestTool.from_json(json_object: json_object)
                 when "dtmf"
                 ...
                 when "handoff"
                   Vapi::HandoffTool.from_json(json_object: json_object)
                 when "bash"
      ...
      def self.validate_raw(obj:)
        ...
        when "handoff"
          Vapi::HandoffTool.validate_raw(obj: obj)
        when "bash"
