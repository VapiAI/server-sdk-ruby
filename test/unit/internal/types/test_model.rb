...
describe Vapi::Internal::Types::Model do
  ...
  class ExampleModel < Vapi::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Vapi::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Vapi::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Vapi::Internal::Types::Model
