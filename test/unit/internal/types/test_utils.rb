...
describe Vapi::Internal::Types::Utils do
  Utils = Vapi::Internal::Types::Utils

  module TestUtils
    class M < Vapi::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Vapi::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Vapi::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Vapi::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Vapi::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Vapi::Internal::Types::Array[String]
      ModelArray = -> { Vapi::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Vapi::Internal::Types::Array[TestUtils::U] }
