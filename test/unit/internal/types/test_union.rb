...
describe Vapi::Internal::Types::Union do
  class Rectangle < Vapi::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Vapi::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Vapi::Internal::Types::Model
